...
class LoginForm extends Component {
  constructor () {
    ...
    // TODO should everything be in a keychain?
    this.state = {
      username: "marcot5",
      passphrase: 'snitches get stiches',
      storeSecret: false
    }
  }
  ...
  showDevicePrompt (response) {
    ToastAndroid.show('Show device prompt', ToastAndroid.SHORT)
  ...
  showDeviceSetup (param, response) {
    ToastAndroid.show('showDeviceSetup', ToastAndroid.SHORT)
    // this.props.kbNavigator.push({
    //   title: 'Device Setup',
    //   leftButtonTitle: 'Cancel',
    //   leftButtonPopN: 3,
  ...
  showSecretWords (param, response) {
    ToastAndroid.show('show secret words', ToastAndroid.SHORT)
    // this.props.kbNavigator.push({
