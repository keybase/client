...
- (void)loadUserWithUid:(KBRUID *)uid username:(NSString *)username self:(BOOL)self completion:(void (^)(NSError *error, KBRUser *user))completion {
  NSArray *params = @[@{@"uid": KBRValue(uid), @"username": KBRValue(username), @"self": @(self)}];
