...
export type IncomingType = {|  'keybase.1.chatUi.chatAttachmentUploadOutboxID': {params: {|sessionID: Int,outboxID: OutboxID|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentUploadStart': {params: {|sessionID: Int,metadata: AssetMetadata,placeholderMsgID: MessageID|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentUploadProgress': {params: {|sessionID: Int,bytesComplete: Long,bytesTotal: Long|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentUploadDone': {params: {|sessionID: Int|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentPreviewUploadStart': {params: {|sessionID: Int,metadata: AssetMetadata|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentPreviewUploadDone': {params: {|sessionID: Int|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentDownloadStart': {params: {|sessionID: Int|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentDownloadProgress': {params: {|sessionID: Int,bytesComplete: Long,bytesTotal: Long|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatAttachmentDownloadDone': {params: {|sessionID: Int|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatInboxUnverified': {params: {|sessionID: Int,inbox: String|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatInboxConversation': {params: {|sessionID: Int,conv: String|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatInboxFailed': {params: {|sessionID: Int,convID: ConversationID,error: ConversationErrorLocal|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatThreadCached': {params: {|sessionID: Int,thread?: ?String|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatThreadFull': {params: {|sessionID: Int,thread: String|},responseError: RPCError, responseResult: void},
  'keybase.1.chatUi.chatConfirmChannelDelete': {params: {|sessionID: Int,channel: String|},responseError: RPCError, responseResult: ChatUiChatConfirmChannelDeleteResult},
  'keybase.1.NotifyChat.NewChatActivity': {params: {|uid: Keybase1.UID,activity: ChatActivity|}},
  'keybase.1.NotifyChat.ChatIdentifyUpdate': {params: {|update: Keybase1.CanonicalTLFNameAndIDWithBreaks|}},
  'keybase.1.NotifyChat.ChatTLFFinalize': {params: {|uid: Keybase1.UID,convID: ConversationID,finalizeInfo: ConversationFinalizeInfo,conv?: ?InboxUIItem|}},
  'keybase.1.NotifyChat.ChatTLFResolve': {params: {|uid: Keybase1.UID,convID: ConversationID,resolveInfo: ConversationResolveInfo|}},
  'keybase.1.NotifyChat.ChatInboxStale': {params: {|uid: Keybase1.UID|}},
  'keybase.1.NotifyChat.ChatThreadsStale': {params: {|uid: Keybase1.UID,updates?: ?Array<ConversationStaleUpdate>|}},
  'keybase.1.NotifyChat.ChatTypingUpdate': {params: {|typingUpdates?: ?Array<ConvTypingUpdate>|}},
  'keybase.1.NotifyChat.ChatJoinedConversation': {params: {|uid: Keybase1.UID,conv: InboxUIItem|}},
  'keybase.1.NotifyChat.ChatLeftConversation': {params: {|uid: Keybase1.UID,convID: ConversationID|}},
  'keybase.1.NotifyChat.ChatResetConversation': {params: {|uid: Keybase1.UID,convID: ConversationID|}},
  'keybase.1.NotifyChat.ChatInboxSyncStarted': {params: {|uid: Keybase1.UID|}},
  'keybase.1.NotifyChat.ChatInboxSynced': {params: {|uid: Keybase1.UID,syncRes: ChatSyncResult|}}|}
