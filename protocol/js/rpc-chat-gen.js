...
export const localAddTeamMemberAfterResetRpcPromise = (request: LocalAddTeamMemberAfterResetRpcParam, loading?: (loading: boolean) => Action): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.addTeamMemberAfterReset', request, (error: RPCError, result: void) => (error ? reject(error) : resolve())))
export const localCancelPostRpcPromise = (request: LocalCancelPostRpcParam, loading?: (loading: boolean) => Action): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.CancelPost', request, (error: RPCError, result: void) => (error ? reject(error) : resolve())))
export const localDeleteConversationLocalRpcPromise = (request: LocalDeleteConversationLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalDeleteConversationLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.deleteConversationLocal', request, (error: RPCError, result: LocalDeleteConversationLocalResult) => (error ? reject(error) : resolve(result))))
...
export const localJoinConversationByIDLocalRpcPromise = (request: LocalJoinConversationByIDLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalJoinConversationByIDLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.joinConversationByIDLocal', request, (error: RPCError, result: LocalJoinConversationByIDLocalResult) => (error ? reject(error) : resolve(result))))
export const localLeaveConversationLocalRpcPromise = (request: LocalLeaveConversationLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalLeaveConversationLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.leaveConversationLocal', request, (error: RPCError, result: LocalLeaveConversationLocalResult) => (error ? reject(error) : resolve(result))))
export const localMakePreviewRpcPromise = (request: LocalMakePreviewRpcParam, loading?: (loading: boolean) => Action): Promise<LocalMakePreviewResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.makePreview', request, (error: RPCError, result: LocalMakePreviewResult) => (error ? reject(error) : resolve(result))))
export const localMarkAsReadLocalRpcPromise = (request: LocalMarkAsReadLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalMarkAsReadLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.markAsReadLocal', request, (error: RPCError, result: LocalMarkAsReadLocalResult) => (error ? reject(error) : resolve(result))))
export const localNewConversationLocalRpcPromise = (request: LocalNewConversationLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalNewConversationLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.newConversationLocal', request, (error: RPCError, result: LocalNewConversationLocalResult) => (error ? reject(error) : resolve(result))))
export const localPostDeleteHistoryThroughRpcPromise = (request: LocalPostDeleteHistoryThroughRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPostDeleteHistoryThroughResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.postDeleteHistoryThrough', request, (error: RPCError, result: LocalPostDeleteHistoryThroughResult) => (error ? reject(error) : resolve(result))))
export const localPostDeleteNonblockRpcPromise = (request: LocalPostDeleteNonblockRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPostDeleteNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.postDeleteNonblock', request, (error: RPCError, result: LocalPostDeleteNonblockResult) => (error ? reject(error) : resolve(result))))
export const localPostEditNonblockRpcPromise = (request: LocalPostEditNonblockRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPostEditNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.postEditNonblock', request, (error: RPCError, result: LocalPostEditNonblockResult) => (error ? reject(error) : resolve(result))))
...
export const localPostHeadlineNonblockRpcPromise = (request: LocalPostHeadlineNonblockRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPostHeadlineNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.postHeadlineNonblock', request, (error: RPCError, result: LocalPostHeadlineNonblockResult) => (error ? reject(error) : resolve(result))))
export const localPostHeadlineRpcPromise = (request: LocalPostHeadlineRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPostHeadlineResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.postHeadline', request, (error: RPCError, result: LocalPostHeadlineResult) => (error ? reject(error) : resolve(result))))
export const localPostMetadataRpcPromise = (request: LocalPostMetadataRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPostMetadataResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.postMetadata', request, (error: RPCError, result: LocalPostMetadataResult) => (error ? reject(error) : resolve(result))))
export const localPostTextNonblockRpcPromise = (request: LocalPostTextNonblockRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPostTextNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.postTextNonblock', request, (error: RPCError, result: LocalPostTextNonblockResult) => (error ? reject(error) : resolve(result))))
export const localPreviewConversationByIDLocalRpcPromise = (request: LocalPreviewConversationByIDLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalPreviewConversationByIDLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.previewConversationByIDLocal', request, (error: RPCError, result: LocalPreviewConversationByIDLocalResult) => (error ? reject(error) : resolve(result))))
export const localRetryPostRpcPromise = (request: LocalRetryPostRpcParam, loading?: (loading: boolean) => Action): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.RetryPost', request, (error: RPCError, result: void) => (error ? reject(error) : resolve())))
export const localSetAppNotificationSettingsLocalRpcPromise = (request: LocalSetAppNotificationSettingsLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalSetAppNotificationSettingsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.setAppNotificationSettingsLocal', request, (error: RPCError, result: LocalSetAppNotificationSettingsLocalResult) => (error ? reject(error) : resolve(result))))
export const localSetConvRetentionLocalRpcPromise = (request: LocalSetConvRetentionLocalRpcParam, loading?: (loading: boolean) => Action): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.setConvRetentionLocal', request, (error: RPCError, result: void) => (error ? reject(error) : resolve())))
export const localSetConversationStatusLocalRpcPromise = (request: LocalSetConversationStatusLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalSetConversationStatusLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.SetConversationStatusLocal', request, (error: RPCError, result: LocalSetConversationStatusLocalResult) => (error ? reject(error) : resolve(result))))
export const localSetGlobalAppNotificationSettingsLocalRpcPromise = (request: LocalSetGlobalAppNotificationSettingsLocalRpcParam, loading?: (loading: boolean) => Action): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.setGlobalAppNotificationSettingsLocal', request, (error: RPCError, result: void) => (error ? reject(error) : resolve())))
export const localSetTeamRetentionLocalRpcPromise = (request: LocalSetTeamRetentionLocalRpcParam, loading?: (loading: boolean) => Action): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.setTeamRetentionLocal', request, (error: RPCError, result: void) => (error ? reject(error) : resolve())))
export const localUnboxMobilePushNotificationRpcPromise = (request: LocalUnboxMobilePushNotificationRpcParam, loading?: (loading: boolean) => Action): Promise<LocalUnboxMobilePushNotificationResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.unboxMobilePushNotification', request, (error: RPCError, result: LocalUnboxMobilePushNotificationResult) => (error ? reject(error) : resolve(result))))
export const localUpdateTypingRpcPromise = (request: LocalUpdateTypingRpcParam, loading?: (loading: boolean) => Action): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.updateTyping', request, (error: RPCError, result: void) => (error ? reject(error) : resolve())))
