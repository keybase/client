...
export const localDownloadFileAttachmentLocalRpcSaga = (params: LocalDownloadFileAttachmentLocalRpcParam, incomingCallMap: IncomingCallMapType, waitingKey?: string) => Saga.call(engineSaga, {method: 'chat.1.local.DownloadFileAttachmentLocal', params, incomingCallMap, waitingKey})
...
export const localGetInboxNonblockLocalRpcSaga = (params: LocalGetInboxNonblockLocalRpcParam, incomingCallMap: IncomingCallMapType, waitingKey?: string) => Saga.call(engineSaga, {method: 'chat.1.local.getInboxNonblockLocal', params, incomingCallMap, waitingKey})
...
export const localGetThreadNonblockRpcSaga = (params: LocalGetThreadNonblockRpcParam, incomingCallMap: IncomingCallMapType, waitingKey?: string) => Saga.call(engineSaga, {method: 'chat.1.local.getThreadNonblock', params, incomingCallMap, waitingKey})
...
export const localPostFileAttachmentLocalRpcSaga = (params: LocalPostFileAttachmentLocalRpcParam, incomingCallMap: IncomingCallMapType, waitingKey?: string) => Saga.call(engineSaga, {method: 'chat.1.local.postFileAttachmentLocal', params, incomingCallMap, waitingKey})
