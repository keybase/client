...
export type LocalPostReactionRpcParam = $ReadOnly<{conversationID: ConversationID, tlfName: String, tlfPublic: Boolean, supersedes: MessageID, body: String, identifyBehavior: Keybase1.TLFIdentifyBehavior}>
...
type LocalPostReactionResult = PostLocalRes
