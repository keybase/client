...
export const localGetSearchResultsRpcChannelMap = (configKeys: Array<string>, request: LocalGetSearchResultsRpcParam): EngineChannel => engine()._channelMapRpcHelper(configKeys, 'chat.1.local.getSearchResults', request)

export const localGetSearchResultsRpcPromise = (request: LocalGetSearchResultsRpcParam): Promise<LocalGetSearchResultsResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.getSearchResults', request, (error: RPCError, result: LocalGetSearchResultsResult) => (error ? reject(error) : resolve(result))))
...
export type ChatUiChatSearchHitRpcParam = $ReadOnly<{prevMessage: UIMessage, hitMessage: UIMessage, nextMessage: UIMessage, hits?: ?Array<String>, incomingCallMap?: IncomingCallMapType, waitingHandler?: WaitingHandlerType}>
...
export type GetSearchResultsRes = $ReadOnly<{rateLimits?: ?Array<RateLimit>, identifyFailures?: ?Array<Keybase1.TLFIdentifyFailure>}>
...
export type LocalGetSearchResultsRpcParam = $ReadOnly<{conversationID: ConversationID, query: String, maxHits: Int, maxMessages: Int, identifyBehavior: Keybase1.TLFIdentifyBehavior, incomingCallMap?: IncomingCallMapType, waitingHandler?: WaitingHandlerType}>
...
type LocalGetSearchResultsResult = GetSearchResultsRes
