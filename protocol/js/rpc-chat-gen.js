...
export const localGetStaticConfigRpcPromise = (request: LocalGetStaticConfigRpcParam): Promise<LocalGetStaticConfigResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('chat.1.local.getStaticConfig', request, (error: RPCError, result: LocalGetStaticConfigResult) => (error ? reject(error) : resolve(result))))
