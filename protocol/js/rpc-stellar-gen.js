...
export const localGetAccountAssetsLocalRpcPromise = (request: LocalGetAccountAssetsLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalGetAccountAssetsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('stellar.1.local.getAccountAssetsLocal', request, (error: RPCError, result: LocalGetAccountAssetsLocalResult) => (error ? reject(error) : resolve(result))))
export const localGetPaymentsLocalRpcPromise = (request: LocalGetPaymentsLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalGetPaymentsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('stellar.1.local.getPaymentsLocal', request, (error: RPCError, result: LocalGetPaymentsLocalResult) => (error ? reject(error) : resolve(result))))
export const localGetWalletAccountsLocalRpcPromise = (request: LocalGetWalletAccountsLocalRpcParam, loading?: (loading: boolean) => Action): Promise<LocalGetWalletAccountsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing('stellar.1.local.getWalletAccountsLocal', request, (error: RPCError, result: LocalGetWalletAccountsLocalResult) => (error ? reject(error) : resolve(result))))
