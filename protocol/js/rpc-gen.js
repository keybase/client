...
export type IncomingCallMapType = {|
  'keybase.1.gpgUi.wantToAddGPGKey'?: (params: $ReadOnly<{sessionID: Int}>, response: {error: RPCErrorHandler, result: (result: GpgUiWantToAddGPGKeyResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gpgUi.confirmDuplicateKeyChosen'?: (params: $ReadOnly<{sessionID: Int}>, response: {error: RPCErrorHandler, result: (result: GpgUiConfirmDuplicateKeyChosenResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gpgUi.confirmImportSecretToExistingKey'?: (params: $ReadOnly<{sessionID: Int}>, response: {error: RPCErrorHandler, result: (result: GpgUiConfirmImportSecretToExistingKeyResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gpgUi.selectKeyAndPushOption'?: (params: $ReadOnly<{sessionID: Int, keys?: ?Array<GPGKey>}>, response: {error: RPCErrorHandler, result: (result: GpgUiSelectKeyAndPushOptionResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gpgUi.selectKey'?: (params: $ReadOnly<{sessionID: Int, keys?: ?Array<GPGKey>}>, response: {error: RPCErrorHandler, result: (result: GpgUiSelectKeyResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gpgUi.sign'?: (params: $ReadOnly<{msg: Bytes, fingerprint: Bytes}>, response: {error: RPCErrorHandler, result: (result: GpgUiSignResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gpgUi.getTTY'?: (params: $ReadOnly<{}>, response: {error: RPCErrorHandler, result: (result: GpgUiGetTTYResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gregorUI.pushState'?: (params: $ReadOnly<{state: Gregor1.State, reason: PushReason}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.gregorUI.pushOutOfBandMessages'?: (params: $ReadOnly<{oobm?: ?Array<Gregor1.OutOfBandMessage>}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.homeUI.homeUIRefresh'?: (params: $ReadOnly<{}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.displayTLFCreateWithInvite'?: (params: $ReadOnly<{sessionID: Int, folderName: String, isPrivate: Boolean, assertion: String, socialAssertion: SocialAssertion, inviteLink: String, throttled: Boolean}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.delegateIdentifyUI'?: (params: $ReadOnly<{}>, response: {error: RPCErrorHandler, result: (result: IdentifyUiDelegateIdentifyUIResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.start'?: (params: $ReadOnly<{sessionID: Int, username: String, reason: IdentifyReason, forceDisplay?: Boolean}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.displayKey'?: (params: $ReadOnly<{sessionID: Int, key: IdentifyKey}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.reportLastTrack'?: (params: $ReadOnly<{sessionID: Int, track?: ?TrackSummary}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.launchNetworkChecks'?: (params: $ReadOnly<{sessionID: Int, identity: Identity, user: User}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.displayTrackStatement'?: (params: $ReadOnly<{sessionID: Int, stmt: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.finishWebProofCheck'?: (params: $ReadOnly<{sessionID: Int, rp: RemoteProof, lcr: LinkCheckResult}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.finishSocialProofCheck'?: (params: $ReadOnly<{sessionID: Int, rp: RemoteProof, lcr: LinkCheckResult}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.displayCryptocurrency'?: (params: $ReadOnly<{sessionID: Int, c: Cryptocurrency}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.reportTrackToken'?: (params: $ReadOnly<{sessionID: Int, trackToken: TrackToken}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.displayUserCard'?: (params: $ReadOnly<{sessionID: Int, card: UserCard}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.confirm'?: (params: $ReadOnly<{sessionID: Int, outcome: IdentifyOutcome}>, response: {error: RPCErrorHandler, result: (result: IdentifyUiConfirmResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.cancel'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.finish'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.identifyUi.dismiss'?: (params: $ReadOnly<{sessionID: Int, username: String, reason: DismissReason}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.logUi.log'?: (params: $ReadOnly<{sessionID: Int, level: LogLevel, text: Text}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.loginUi.getEmailOrUsername'?: (params: $ReadOnly<{sessionID: Int}>, response: {error: RPCErrorHandler, result: (result: LoginUiGetEmailOrUsernameResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.loginUi.promptRevokePaperKeys'?: (params: $ReadOnly<{sessionID: Int, device: Device, index: Int}>, response: {error: RPCErrorHandler, result: (result: LoginUiPromptRevokePaperKeysResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.loginUi.displayPaperKeyPhrase'?: (params: $ReadOnly<{sessionID: Int, phrase: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.loginUi.displayPrimaryPaperKey'?: (params: $ReadOnly<{sessionID: Int, phrase: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.logsend.prepareLogsend'?: (params: $ReadOnly<{}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyApp.exit'?: (params: $ReadOnly<{}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyBadges.badgeState'?: (params: $ReadOnly<{badgeState: BadgeState}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyEphemeral.newTeamEk'?: (params: $ReadOnly<{id: TeamID, generation: EkGeneration}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyFavorites.favoritesChanged'?: (params: $ReadOnly<{uid: UID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyFS.FSActivity'?: (params: $ReadOnly<{notification: FSNotification}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyFS.FSSyncActivity'?: (params: $ReadOnly<{status: FSPathSyncStatus}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyFS.FSEditListResponse'?: (params: $ReadOnly<{edits?: ?Array<FSNotification>, requestID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyFS.FSSyncStatusResponse'?: (params: $ReadOnly<{status: FSSyncStatus, requestID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyKeyfamily.keyfamilyChanged'?: (params: $ReadOnly<{uid: UID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyPaperKey.paperKeyCached'?: (params: $ReadOnly<{uid: UID, encKID: KID, sigKID: KID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyPGP.pgpKeyInSecretStoreFile'?: (params: $ReadOnly<{}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyService.shutdown'?: (params: $ReadOnly<{code: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifySession.loggedOut'?: (params: $ReadOnly<{}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifySession.loggedIn'?: (params: $ReadOnly<{username: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifySession.clientOutOfDate'?: (params: $ReadOnly<{upgradeTo: String, upgradeURI: String, upgradeMsg: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyTeam.teamChangedByID'?: (params: $ReadOnly<{teamID: TeamID, latestSeqno: Seqno, implicitTeam: Boolean, changes: TeamChangeSet}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyTeam.teamChangedByName'?: (params: $ReadOnly<{teamName: String, latestSeqno: Seqno, implicitTeam: Boolean, changes: TeamChangeSet}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyTeam.teamDeleted'?: (params: $ReadOnly<{teamID: TeamID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyTeam.teamAbandoned'?: (params: $ReadOnly<{teamID: TeamID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyTeam.teamExit'?: (params: $ReadOnly<{teamID: TeamID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyTracking.trackingChanged'?: (params: $ReadOnly<{uid: UID, username: String, isTracking: Boolean}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.NotifyUsers.userChanged'?: (params: $ReadOnly<{uid: UID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.pgpUi.outputSignatureSuccess'?: (params: $ReadOnly<{sessionID: Int, fingerprint: String, username: String, signedAt: Time}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.pgpUi.outputSignatureSuccessNonKeybase'?: (params: $ReadOnly<{sessionID: Int, keyID: String, signedAt: Time}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.pgpUi.keyGenerated'?: (params: $ReadOnly<{sessionID: Int, kid: KID, key: KeyInfo}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.pgpUi.shouldPushPrivate'?: (params: $ReadOnly<{sessionID: Int}>, response: {error: RPCErrorHandler, result: (result: PgpUiShouldPushPrivateResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.pgpUi.finished'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.proveUi.promptOverwrite'?: (params: $ReadOnly<{sessionID: Int, account: String, typ: PromptOverwriteType}>, response: {error: RPCErrorHandler, result: (result: ProveUiPromptOverwriteResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.proveUi.promptUsername'?: (params: $ReadOnly<{sessionID: Int, prompt: String, prevError?: ?Status}>, response: {error: RPCErrorHandler, result: (result: ProveUiPromptUsernameResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.proveUi.outputPrechecks'?: (params: $ReadOnly<{sessionID: Int, text: Text}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.proveUi.preProofWarning'?: (params: $ReadOnly<{sessionID: Int, text: Text}>, response: {error: RPCErrorHandler, result: (result: ProveUiPreProofWarningResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.proveUi.outputInstructions'?: (params: $ReadOnly<{sessionID: Int, instructions: Text, proof: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.proveUi.okToCheck'?: (params: $ReadOnly<{sessionID: Int, name: String, attempt: Int}>, response: {error: RPCErrorHandler, result: (result: ProveUiOkToCheckResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.proveUi.displayRecheckWarning'?: (params: $ReadOnly<{sessionID: Int, text: Text}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.chooseProvisioningMethod'?: (params: $ReadOnly<{sessionID: Int, gpgOption: Boolean}>, response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseProvisioningMethodResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.chooseGPGMethod'?: (params: $ReadOnly<{sessionID: Int, keys?: ?Array<GPGKey>}>, response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseGPGMethodResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.switchToGPGSignOK'?: (params: $ReadOnly<{sessionID: Int, key: GPGKey, importError: String}>, response: {error: RPCErrorHandler, result: (result: ProvisionUiSwitchToGPGSignOKResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.chooseDevice'?: (params: $ReadOnly<{sessionID: Int, devices?: ?Array<Device>, canSelectNoDevice: Boolean}>, response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseDeviceResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.chooseDeviceType'?: (params: $ReadOnly<{sessionID: Int, kind: ChooseType}>, response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseDeviceTypeResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.DisplayAndPromptSecret'?: (params: $ReadOnly<{sessionID: Int, secret: Bytes, phrase: String, otherDeviceType: DeviceType, previousErr: String}>, response: {error: RPCErrorHandler, result: (result: ProvisionUiDisplayAndPromptSecretResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.DisplaySecretExchanged'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.PromptNewDeviceName'?: (params: $ReadOnly<{sessionID: Int, existingDevices?: ?Array<String>, errorMessage: String}>, response: {error: RPCErrorHandler, result: (result: ProvisionUiPromptNewDeviceNameResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.ProvisioneeSuccess'?: (params: $ReadOnly<{sessionID: Int, username: String, deviceName: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.provisionUi.ProvisionerSuccess'?: (params: $ReadOnly<{sessionID: Int, deviceName: String, deviceType: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.rekeyUI.delegateRekeyUI'?: (params: $ReadOnly<{}>, response: {error: RPCErrorHandler, result: (result: RekeyUIDelegateRekeyUIResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.rekeyUI.refresh'?: (params: $ReadOnly<{sessionID: Int, problemSetDevices: ProblemSetDevices}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.rekeyUI.rekeySendEvent'?: (params: $ReadOnly<{sessionID: Int, event: RekeyEvent}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.saltpackUi.saltpackPromptForDecrypt'?: (params: $ReadOnly<{sessionID: Int, sender: SaltpackSender, usedDelegateUI: Boolean}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.saltpackUi.saltpackVerifySuccess'?: (params: $ReadOnly<{sessionID: Int, signingKID: KID, sender: SaltpackSender}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.saltpackUi.saltpackVerifyBadSender'?: (params: $ReadOnly<{sessionID: Int, signingKID: KID, sender: SaltpackSender}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.secretUi.getPassphrase'?: (params: $ReadOnly<{sessionID: Int, pinentry: GUIEntryArg, terminal?: ?SecretEntryArg}>, response: {error: RPCErrorHandler, result: (result: SecretUiGetPassphraseResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.streamUi.close'?: (params: $ReadOnly<{sessionID: Int, s: Stream}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.streamUi.read'?: (params: $ReadOnly<{sessionID: Int, s: Stream, sz: Int}>, response: {error: RPCErrorHandler, result: (result: StreamUiReadResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.streamUi.reset'?: (params: $ReadOnly<{sessionID: Int, s: Stream}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.streamUi.write'?: (params: $ReadOnly<{sessionID: Int, s: Stream, buf: Bytes}>, response: {error: RPCErrorHandler, result: (result: StreamUiWriteResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.teamsUi.confirmRootTeamDelete'?: (params: $ReadOnly<{sessionID: Int, teamName: String}>, response: {error: RPCErrorHandler, result: (result: TeamsUiConfirmRootTeamDeleteResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.teamsUi.confirmSubteamDelete'?: (params: $ReadOnly<{sessionID: Int, teamName: String}>, response: {error: RPCErrorHandler, result: (result: TeamsUiConfirmSubteamDeleteResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
  'keybase.1.ui.promptYesNo'?: (params: $ReadOnly<{sessionID: Int, text: Text, promptDefault: PromptDefault}>, response: {error: RPCErrorHandler, result: (result: UiPromptYesNoResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>,
|}

// Not enabled calls. To enable add to enabled-calls.json: 'keybase.1.account.passphrasePrompt' 'keybase.1.account.resetAccount' 'keybase.1.appState.updateAppState' 'keybase.1.badger.getBadgeState' 'keybase.1.block.getSessionChallenge' 'keybase.1.block.authenticateSession' 'keybase.1.block.putBlock' 'keybase.1.block.putBlockAgain' 'keybase.1.block.getBlock' 'keybase.1.block.addReference' 'keybase.1.block.delReference' 'keybase.1.block.archiveReference' 'keybase.1.block.delReferenceWithCount' 'keybase.1.block.archiveReferenceWithCount' 'keybase.1.block.getUserQuotaInfo' 'keybase.1.block.getTeamQuotaInfo' 'keybase.1.block.blockPing' 'keybase.1.BTC.registerBTC' 'keybase.1.config.getCurrentStatus' 'keybase.1.config.setUserConfig' 'keybase.1.config.setPath' 'keybase.1.config.setValue' 'keybase.1.config.clearValue' 'keybase.1.config.getValue' 'keybase.1.config.checkAPIServerOutOfDateWarning' 'keybase.1.crypto.signED25519' 'keybase.1.crypto.signED25519ForKBFS' 'keybase.1.crypto.signToString' 'keybase.1.crypto.unboxBytes32' 'keybase.1.crypto.unboxBytes32Any' 'keybase.1.ctl.stop' 'keybase.1.ctl.logRotate' 'keybase.1.ctl.reload' 'keybase.1.ctl.appExit' 'keybase.1.ctl.dbDelete' 'keybase.1.ctl.dbPut' 'keybase.1.ctl.dbGet' 'keybase.1.debugging.firstStep' 'keybase.1.debugging.secondStep' 'keybase.1.debugging.increment' 'keybase.1.debugging.script' 'keybase.1.delegateUiCtl.registerUpdateUI' 'keybase.1.delegateUiCtl.registerGregorFirehose' 'keybase.1.device.deviceList' 'keybase.1.device.checkDeviceNameForUser' 'keybase.1.favorite.getFavorites' 'keybase.1.fs.List' 'keybase.1.git.putGitMetadata' 'keybase.1.git.deleteGitMetadata' 'keybase.1.git.gcPersonalRepo' 'keybase.1.git.gcTeamRepo' 'keybase.1.git.getTeamRepoSettings' 'keybase.1.gpgUi.wantToAddGPGKey' 'keybase.1.gpgUi.confirmDuplicateKeyChosen' 'keybase.1.gpgUi.confirmImportSecretToExistingKey' 'keybase.1.gpgUi.selectKeyAndPushOption' 'keybase.1.gpgUi.selectKey' 'keybase.1.gpgUi.sign' 'keybase.1.gpgUi.getTTY' 'keybase.1.gregorUI.pushState' 'keybase.1.gregorUI.pushOutOfBandMessages' 'keybase.1.home.homeActionTaken' 'keybase.1.homeUI.homeUIRefresh' 'keybase.1.identify.Resolve3' 'keybase.1.identify.identifyLite' 'keybase.1.identify.resolveIdentifyImplicitTeam' 'keybase.1.identify.resolveImplicitTeam' 'keybase.1.identifyUi.displayTLFCreateWithInvite' 'keybase.1.identifyUi.delegateIdentifyUI' 'keybase.1.identifyUi.start' 'keybase.1.identifyUi.displayKey' 'keybase.1.identifyUi.reportLastTrack' 'keybase.1.identifyUi.launchNetworkChecks' 'keybase.1.identifyUi.displayTrackStatement' 'keybase.1.identifyUi.finishWebProofCheck' 'keybase.1.identifyUi.finishSocialProofCheck' 'keybase.1.identifyUi.displayCryptocurrency' 'keybase.1.identifyUi.reportTrackToken' 'keybase.1.identifyUi.displayUserCard' 'keybase.1.identifyUi.confirm' 'keybase.1.identifyUi.cancel' 'keybase.1.identifyUi.finish' 'keybase.1.identifyUi.dismiss' 'keybase.1.implicitTeamMigration.startMigration' 'keybase.1.implicitTeamMigration.finalizeMigration' 'keybase.1.install.installCommandLinePrivileged' 'keybase.1.kbfs.FSEvent' 'keybase.1.kbfs.FSEditList' 'keybase.1.kbfs.FSSyncStatus' 'keybase.1.kbfs.FSSyncEvent' 'keybase.1.kbfs.createTLF' 'keybase.1.kbfs.getKBFSTeamSettings' 'keybase.1.KBFSGit.createRepo' 'keybase.1.KBFSGit.deleteRepo' 'keybase.1.KBFSGit.gc' 'keybase.1.kbfsMount.GetAllAvailableMountDirs' 'keybase.1.kbfsMount.SetCurrentMountDir' 'keybase.1.Kex2Provisionee.hello' 'keybase.1.Kex2Provisionee.didCounterSign' 'keybase.1.Kex2Provisionee2.hello2' 'keybase.1.Kex2Provisionee2.didCounterSign2' 'keybase.1.Kex2Provisioner.kexStart' 'keybase.1.log.registerLogger' 'keybase.1.logUi.log' 'keybase.1.login.loginProvisionedDevice' 'keybase.1.login.loginWithPaperKey' 'keybase.1.login.clearStoredSecret' 'keybase.1.login.recoverAccountFromEmailAddress' 'keybase.1.login.unlock' 'keybase.1.login.unlockWithPassphrase' 'keybase.1.login.loginOneshot' 'keybase.1.loginUi.getEmailOrUsername' 'keybase.1.loginUi.promptRevokePaperKeys' 'keybase.1.loginUi.displayPaperKeyPhrase' 'keybase.1.loginUi.displayPrimaryPaperKey' 'keybase.1.logsend.prepareLogsend' 'keybase.1.merkle.getCurrentMerkleRoot' 'keybase.1.merkle.verifyMerkleRootAndKBFS' 'keybase.1.metadata.getChallenge' 'keybase.1.metadata.authenticate' 'keybase.1.metadata.putMetadata' 'keybase.1.metadata.getMetadata' 'keybase.1.metadata.registerForUpdates' 'keybase.1.metadata.pruneBranch' 'keybase.1.metadata.putKeys' 'keybase.1.metadata.getKey' 'keybase.1.metadata.deleteKey' 'keybase.1.metadata.truncateLock' 'keybase.1.metadata.truncateUnlock' 'keybase.1.metadata.getFolderHandle' 'keybase.1.metadata.getFoldersForRekey' 'keybase.1.metadata.ping' 'keybase.1.metadata.ping2' 'keybase.1.metadata.getLatestFolderHandle' 'keybase.1.metadata.getKeyBundles' 'keybase.1.metadata.lock' 'keybase.1.metadata.releaseLock' 'keybase.1.metadata.startImplicitTeamMigration' 'keybase.1.metadata.getMerkleRoot' 'keybase.1.metadata.getMerkleRootLatest' 'keybase.1.metadata.getMerkleRootSince' 'keybase.1.metadata.getMerkleNode' 'keybase.1.metadata.findNextMD' 'keybase.1.metadata.setImplicitTeamModeForTest' 'keybase.1.metadata.forceMerkleBuildForTest' 'keybase.1.metadataUpdate.metadataUpdate' 'keybase.1.metadataUpdate.folderNeedsRekey' 'keybase.1.metadataUpdate.foldersNeedRekey' 'keybase.1.NotifyApp.exit' 'keybase.1.NotifyBadges.badgeState' 'keybase.1.NotifyEphemeral.newTeamEk' 'keybase.1.NotifyFavorites.favoritesChanged' 'keybase.1.NotifyFS.FSActivity' 'keybase.1.NotifyFS.FSSyncActivity' 'keybase.1.NotifyFS.FSEditListResponse' 'keybase.1.NotifyFS.FSSyncStatusResponse' 'keybase.1.NotifyFSRequest.FSEditListRequest' 'keybase.1.NotifyFSRequest.FSSyncStatusRequest' 'keybase.1.NotifyKeyfamily.keyfamilyChanged' 'keybase.1.NotifyPaperKey.paperKeyCached' 'keybase.1.NotifyPGP.pgpKeyInSecretStoreFile' 'keybase.1.NotifyService.shutdown' 'keybase.1.NotifySession.loggedOut' 'keybase.1.NotifySession.loggedIn' 'keybase.1.NotifySession.clientOutOfDate' 'keybase.1.NotifyTeam.teamChangedByID' 'keybase.1.NotifyTeam.teamChangedByName' 'keybase.1.NotifyTeam.teamDeleted' 'keybase.1.NotifyTeam.teamAbandoned' 'keybase.1.NotifyTeam.teamExit' 'keybase.1.NotifyTracking.trackingChanged' 'keybase.1.NotifyUsers.userChanged' 'keybase.1.paperprovision.paperProvision' 'keybase.1.pgp.pgpSign' 'keybase.1.pgp.pgpPull' 'keybase.1.pgp.pgpEncrypt' 'keybase.1.pgp.pgpDecrypt' 'keybase.1.pgp.pgpVerify' 'keybase.1.pgp.pgpImport' 'keybase.1.pgp.pgpExport' 'keybase.1.pgp.pgpExportByFingerprint' 'keybase.1.pgp.pgpExportByKID' 'keybase.1.pgp.pgpKeyGen' 'keybase.1.pgp.pgpDeletePrimary' 'keybase.1.pgp.pgpSelect' 'keybase.1.pgp.pgpUpdate' 'keybase.1.pgp.pgpPurge' 'keybase.1.pgpUi.outputSignatureSuccess' 'keybase.1.pgpUi.outputSignatureSuccessNonKeybase' 'keybase.1.pgpUi.keyGenerated' 'keybase.1.pgpUi.shouldPushPrivate' 'keybase.1.pgpUi.finished' 'keybase.1.pprof.processorProfile' 'keybase.1.pprof.trace' 'keybase.1.proveUi.promptOverwrite' 'keybase.1.proveUi.promptUsername' 'keybase.1.proveUi.outputPrechecks' 'keybase.1.proveUi.preProofWarning' 'keybase.1.proveUi.outputInstructions' 'keybase.1.proveUi.okToCheck' 'keybase.1.proveUi.displayRecheckWarning' 'keybase.1.provisionUi.chooseProvisioningMethod' 'keybase.1.provisionUi.chooseGPGMethod' 'keybase.1.provisionUi.switchToGPGSignOK' 'keybase.1.provisionUi.chooseDevice' 'keybase.1.provisionUi.chooseDeviceType' 'keybase.1.provisionUi.DisplayAndPromptSecret' 'keybase.1.provisionUi.DisplaySecretExchanged' 'keybase.1.provisionUi.PromptNewDeviceName' 'keybase.1.provisionUi.ProvisioneeSuccess' 'keybase.1.provisionUi.ProvisionerSuccess' 'keybase.1.quota.verifySession' 'keybase.1.reachability.reachabilityChanged' 'keybase.1.rekey.getPendingRekeyStatus' 'keybase.1.rekey.debugShowRekeyStatus' 'keybase.1.rekey.rekeySync' 'keybase.1.rekeyUI.delegateRekeyUI' 'keybase.1.rekeyUI.refresh' 'keybase.1.rekeyUI.rekeySendEvent' 'keybase.1.saltpack.saltpackEncrypt' 'keybase.1.saltpack.saltpackDecrypt' 'keybase.1.saltpack.saltpackSign' 'keybase.1.saltpack.saltpackVerify' 'keybase.1.saltpackUi.saltpackPromptForDecrypt' 'keybase.1.saltpackUi.saltpackVerifySuccess' 'keybase.1.saltpackUi.saltpackVerifyBadSender' 'keybase.1.ScanProofs.scanProofs' 'keybase.1.secretUi.getPassphrase' 'keybase.1.SecretKeys.getSecretKeys' 'keybase.1.session.currentSession' 'keybase.1.session.sessionPing' 'keybase.1.sigs.sigList' 'keybase.1.sigs.sigListJSON' 'keybase.1.SimpleFS.simpleFSListRecursive' 'keybase.1.SimpleFS.simpleFSCopy' 'keybase.1.SimpleFS.simpleFSMove' 'keybase.1.SimpleFS.simpleFSRename' 'keybase.1.SimpleFS.simpleFSOpen' 'keybase.1.SimpleFS.simpleFSSetStat' 'keybase.1.SimpleFS.simpleFSRead' 'keybase.1.SimpleFS.simpleFSWrite' 'keybase.1.SimpleFS.simpleFSRemove' 'keybase.1.SimpleFS.simpleFSMakeOpid' 'keybase.1.SimpleFS.simpleFSClose' 'keybase.1.SimpleFS.simpleFSGetOps' 'keybase.1.SimpleFS.simpleFSDumpDebuggingInfo' 'keybase.1.streamUi.close' 'keybase.1.streamUi.read' 'keybase.1.streamUi.reset' 'keybase.1.streamUi.write' 'keybase.1.teams.teamCreateWithSettings' 'keybase.1.teams.teamImplicitAdmins' 'keybase.1.teams.teamListTeammates' 'keybase.1.teams.teamListVerified' 'keybase.1.teams.teamListSubteamsRecursive' 'keybase.1.teams.teamChangeMembership' 'keybase.1.teams.teamRename' 'keybase.1.teams.teamAcceptInvite' 'keybase.1.teams.teamRequestAccess' 'keybase.1.teams.teamDelete' 'keybase.1.teams.teamCreateSeitanToken' 'keybase.1.teams.lookupImplicitTeam' 'keybase.1.teams.lookupOrCreateImplicitTeam' 'keybase.1.teams.teamReAddMemberAfterReset' 'keybase.1.teams.loadTeamPlusApplicationKeys' 'keybase.1.teams.getTeamRootID' 'keybase.1.teams.getTeamShowcase' 'keybase.1.teams.teamRotateKey' 'keybase.1.teams.teamDebug' 'keybase.1.teams.uploadTeamAvatar' 'keybase.1.teams.tryDecryptWithTeamKey' 'keybase.1.teamsUi.confirmRootTeamDelete' 'keybase.1.teamsUi.confirmSubteamDelete' 'keybase.1.test.test' 'keybase.1.test.testCallback' 'keybase.1.test.panic' 'keybase.1.tlf.CryptKeys' 'keybase.1.tlf.publicCanonicalTLFNameAndID' 'keybase.1.tlf.completeAndCanonicalizePrivateTlfName' 'keybase.1.tlfKeys.getTLFCryptKeys' 'keybase.1.tlfKeys.getPublicCanonicalTLFNameAndID' 'keybase.1.track.track' 'keybase.1.track.fakeTrackingChanged' 'keybase.1.ui.promptYesNo' 'keybase.1.user.listTrackers' 'keybase.1.user.listTrackersByName' 'keybase.1.user.listTrackersSelf' 'keybase.1.user.loadUncheckedUserSummaries' 'keybase.1.user.loadUser' 'keybase.1.user.loadUserByName' 'keybase.1.user.loadUserPlusKeys' 'keybase.1.user.loadUserPlusKeysV2' 'keybase.1.user.loadPublicKeys' 'keybase.1.user.loadMyPublicKeys' 'keybase.1.user.listTracking' 'keybase.1.user.listTrackingJSON' 'keybase.1.user.search' 'keybase.1.user.loadAllPublicKeysUnverified' 'keybase.1.user.meUserVersion' 'keybase.1.user.getUPAK' 'keybase.1.user.uploadUserAvatar' 'keybase.1.user.findNextMerkleRootAfterRevoke'
