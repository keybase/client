...
export const loginLogoutRpcPromise = (params: LoginLogoutRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.login.logout', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
