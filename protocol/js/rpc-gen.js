...
export const signupSignupRpcPromise = (params: SignupSignupRpcParam, waitingKey?: string): Promise<SignupSignupResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.signup.signup', params, callback: (error: RPCError, result: SignupSignupResult) => (error ? reject(error) : resolve(result))}))
