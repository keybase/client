...
export type NotifyStellarPaymentProcessedRpcParam = $ReadOnly<{uid: UID, username: String, isTracking: Boolean}>
...
export type IncomingCallMapType = {|
  ...
  'keybase.1.NotifyStellar.paymentProcessed'?: (params: $ReadOnly<{uid: UID, username: String, isTracking: Boolean}>, state: TypedState) => Saga.Effect | Array<Saga.Effect> | null | void,
