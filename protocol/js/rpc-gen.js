...
export const deviceDeviceAddRpcSaga = (p, incomingCallMap, waitingKey) => Saga.call(engineSaga, {method: 'keybase.1.device.deviceAdd', params: p.params, incomingCallMap: p.incomingCallMap, waitingKey: p.waitingKey})
...
export const loginLoginRpcSaga = (p, incomingCallMap, waitingKey) => Saga.call(engineSaga, {method: 'keybase.1.login.login', params: p.params, incomingCallMap: p.incomingCallMap, waitingKey: p.waitingKey})
...
export const loginPaperKeyRpcSaga = (p, incomingCallMap, waitingKey) => Saga.call(engineSaga, {method: 'keybase.1.login.paperKey', params: p.params, incomingCallMap: p.incomingCallMap, waitingKey: p.waitingKey})
...
export const signupSignupRpcSaga = (p, incomingCallMap, waitingKey) => Saga.call(engineSaga, {method: 'keybase.1.signup.signup', params: p.params, incomingCallMap: p.incomingCallMap, waitingKey: p.waitingKey})
