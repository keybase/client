...
export const saltpackSaltpackOperationType = {
  decrypt: 0,
  verify: 1,
}
...
export const accountGetLockdownModeRpcPromise = (params: AccountGetLockdownModeRpcParam, waitingKey?: string): Promise<AccountGetLockdownModeResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.account.getLockdownMode', params, callback: (error: RPCError, result: AccountGetLockdownModeResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export const accountSetLockdownModeRpcPromise = (params: AccountSetLockdownModeRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.account.setLockdownMode', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
...
export const configGetAllProvisionedUsernamesRpcPromise = (params: ConfigGetAllProvisionedUsernamesRpcParam, waitingKey?: string): Promise<ConfigGetAllProvisionedUsernamesResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.config.getAllProvisionedUsernames', params, callback: (error: RPCError, result: ConfigGetAllProvisionedUsernamesResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export const loginPaperKeyRpcSaga = (p: {params: LoginPaperKeyRpcParam, incomingCallMap: IncomingCallMapType, waitingKey?: string}) => Saga.call(engineSaga, {method: 'keybase.1.login.paperKey', params: p.params, incomingCallMap: p.incomingCallMap, waitingKey: p.waitingKey})
...
export const teamsTeamAddMembersRpcPromise = (params: TeamsTeamAddMembersRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamAddMembers', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
...
export const teamsUploadTeamAvatarRpcPromise = (params: TeamsUploadTeamAvatarRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.uploadTeamAvatar', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
...
export const userUploadUserAvatarRpcPromise = (params: UserUploadUserAvatarRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.user.uploadUserAvatar', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
...
export type AccountGetLockdownModeRpcParam = void
...
export type AccountSetLockdownModeRpcParam = $ReadOnly<{enabled: Boolean}>
export type AllProvisionedUsernames = $ReadOnly<{defaultUsername: String, provisionedUsernames?: ?Array<String>}>
...
export type ConfigGetAllProvisionedUsernamesRpcParam = void
...
export type MetadataGetMetadataByTimestampRpcParam = $ReadOnly<{folderID: String, serverTime: Time}>
...
export type NotifyCanUserPerformCanUserPerformChangedRpcParam = $ReadOnly<{teamName: String}>
...
export type NotifySaltpackSaltpackSuccessRpcParam = $ReadOnly<{arg: NotifySaltpackSuccessArg}>
...
export type NotifyTeamNewlyAddedToTeamRpcParam = $ReadOnly<{teamID: TeamID}>
...
export type NotifyUnverifiedTeamListTeamListUnverifiedChangedRpcParam = $ReadOnly<{teamName: String}>
...
export type SaltpackNotifySaltpackSuccessRpcParam = $ReadOnly<{typ: SaltpackOperationType, message: String}>
export type SaltpackOperationType =
  | 0 // DECRYPT_0
  | 1 // VERIFY_1
...
export type SelfprovisionSelfProvisionRpcParam = $ReadOnly<{deviceName: String}>
export type SeqType =
  | 1 // PUBLIC_1
  | 2 // PRIVATE_2
  | 3 // SEMIPRIVATE_3
...
export type SimpleFSSimpleFSGetRevisionsRpcParam = $ReadOnly<{opID: OpID, path: Path, spanType: RevisionSpanType}>
...
export type SimpleFSSimpleFSReadRevisionsRpcParam = $ReadOnly<{opID: OpID}>
...
export type SimpleFSSimpleFSSyncStatusRpcParam = $ReadOnly<{filter: ListFilter}>
...
export type TeamsGetTeamIDRpcParam = $ReadOnly<{teamName: String}>
...
export type TeamsTeamAddMembersRpcParam = $ReadOnly<{name: String, assertions?: ?Array<String>, role: TeamRole, sendChatNotification: Boolean}>
...
type AccountGetLockdownModeResult = GetLockdownResponse
...
type ConfigGetAllProvisionedUsernamesResult = AllProvisionedUsernames
...
type MetadataGetMetadataByTimestampResult = MDBlock
...
type SaltpackSaltpackVerifyResult = SaltpackSender
...
type SimpleFSSimpleFSReadRevisionsResult = GetRevisionsResult
...
type TeamsGetTeamIDResult = TeamID
...
export type IncomingCallMapType = {|
  ...
  'keybase.1.NotifyCanUserPerform.canUserPerformChanged'?: (params: $ReadOnly<{teamName: String}>, state: TypedState) => Saga.Effect | Array<Saga.Effect> | null | void,
  ...
  'keybase.1.NotifySaltpack.saltpackSuccess'?: (params: $ReadOnly<{arg: NotifySaltpackSuccessArg}>, state: TypedState) => Saga.Effect | Array<Saga.Effect> | null | void,
  ...
  'keybase.1.NotifyTeam.newlyAddedToTeam'?: (params: $ReadOnly<{teamID: TeamID}>, state: TypedState) => Saga.Effect | Array<Saga.Effect> | null | void,
  ...
  'keybase.1.NotifyUnverifiedTeamList.teamListUnverifiedChanged'?: (params: $ReadOnly<{teamName: String}>, state: TypedState) => Saga.Effect | Array<Saga.Effect> | null | void,
