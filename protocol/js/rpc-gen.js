...
export const SimpleFSSimpleFSCancelRpcPromise = (params: SimpleFSSimpleFSCancelRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.SimpleFS.simpleFSCancel', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const SimpleFSSimpleFSCopyRecursiveRpcPromise = (params: SimpleFSSimpleFSCopyRecursiveRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.SimpleFS.simpleFSCopyRecursive', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const SimpleFSSimpleFSGetHTTPAddressAndTokenRpcPromise = (params: SimpleFSSimpleFSGetHTTPAddressAndTokenRpcParam, waitingKey?: string): Promise<SimpleFSSimpleFSGetHTTPAddressAndTokenResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.SimpleFS.SimpleFSGetHTTPAddressAndToken', params, callback: (error: RPCError, result: SimpleFSSimpleFSGetHTTPAddressAndTokenResult) => (error ? reject(error) : resolve(result))}))
export const SimpleFSSimpleFSListRpcPromise = (params: SimpleFSSimpleFSListRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.SimpleFS.simpleFSList', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const accountHasServerKeysRpcPromise = (params: AccountHasServerKeysRpcParam, waitingKey?: string): Promise<AccountHasServerKeysResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.account.hasServerKeys', params, callback: (error: RPCError, result: AccountHasServerKeysResult) => (error ? reject(error) : resolve(result))}))
export const accountPassphraseChangeRpcPromise = (params: AccountPassphraseChangeRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.account.passphraseChange', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const apiserverDeleteRpcPromise = (params: ApiserverDeleteRpcParam, waitingKey?: string): Promise<ApiserverDeleteResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.apiserver.Delete', params, callback: (error: RPCError, result: ApiserverDeleteResult) => (error ? reject(error) : resolve(result))}))
export const apiserverGetRpcPromise = (params: ApiserverGetRpcParam, waitingKey?: string): Promise<ApiserverGetResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.apiserver.Get', params, callback: (error: RPCError, result: ApiserverGetResult) => (error ? reject(error) : resolve(result))}))
export const apiserverGetWithSessionRpcPromise = (params: ApiserverGetWithSessionRpcParam, waitingKey?: string): Promise<ApiserverGetWithSessionResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.apiserver.GetWithSession', params, callback: (error: RPCError, result: ApiserverGetWithSessionResult) => (error ? reject(error) : resolve(result))}))
export const apiserverPostJSONRpcPromise = (params: ApiserverPostJSONRpcParam, waitingKey?: string): Promise<ApiserverPostJSONResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.apiserver.PostJSON', params, callback: (error: RPCError, result: ApiserverPostJSONResult) => (error ? reject(error) : resolve(result))}))
export const apiserverPostRpcPromise = (params: ApiserverPostRpcParam, waitingKey?: string): Promise<ApiserverPostResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.apiserver.Post', params, callback: (error: RPCError, result: ApiserverPostResult) => (error ? reject(error) : resolve(result))}))
export const avatarsLoadTeamAvatarsRpcPromise = (params: AvatarsLoadTeamAvatarsRpcParam, waitingKey?: string): Promise<AvatarsLoadTeamAvatarsResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.avatars.loadTeamAvatars', params, callback: (error: RPCError, result: AvatarsLoadTeamAvatarsResult) => (error ? reject(error) : resolve(result))}))
...
export const configGetConfigRpcPromise = (params: ConfigGetConfigRpcParam, waitingKey?: string): Promise<ConfigGetConfigResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.config.getConfig', params, callback: (error: RPCError, result: ConfigGetConfigResult) => (error ? reject(error) : resolve(result))}))
export const configGetExtendedStatusRpcPromise = (params: ConfigGetExtendedStatusRpcParam, waitingKey?: string): Promise<ConfigGetExtendedStatusResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.config.getExtendedStatus', params, callback: (error: RPCError, result: ConfigGetExtendedStatusResult) => (error ? reject(error) : resolve(result))}))
...
export const configHelloIAmRpcPromise = (params: ConfigHelloIAmRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.config.helloIAm', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const configSetRememberPassphraseRpcPromise = (params: ConfigSetRememberPassphraseRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.config.setRememberPassphrase', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const configWaitForClientRpcPromise = (params: ConfigWaitForClientRpcParam, waitingKey?: string): Promise<ConfigWaitForClientResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.config.waitForClient', params, callback: (error: RPCError, result: ConfigWaitForClientResult) => (error ? reject(error) : resolve(result))}))
...
export const ctlDbNukeRpcPromise = (params: CtlDbNukeRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.ctl.dbNuke', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const delegateUiCtlRegisterGregorFirehoseFilteredRpcPromise = (params: DelegateUiCtlRegisterGregorFirehoseFilteredRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.delegateUiCtl.registerGregorFirehoseFiltered', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const delegateUiCtlRegisterHomeUIRpcPromise = (params: DelegateUiCtlRegisterHomeUIRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.delegateUiCtl.registerHomeUI', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const delegateUiCtlRegisterIdentifyUIRpcPromise = (params: DelegateUiCtlRegisterIdentifyUIRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.delegateUiCtl.registerIdentifyUI', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const delegateUiCtlRegisterRekeyUIRpcPromise = (params: DelegateUiCtlRegisterRekeyUIRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.delegateUiCtl.registerRekeyUI', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const delegateUiCtlRegisterSecretUIRpcPromise = (params: DelegateUiCtlRegisterSecretUIRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.delegateUiCtl.registerSecretUI', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const deviceCheckDeviceNameFormatRpcPromise = (params: DeviceCheckDeviceNameFormatRpcParam, waitingKey?: string): Promise<DeviceCheckDeviceNameFormatResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.device.checkDeviceNameFormat', params, callback: (error: RPCError, result: DeviceCheckDeviceNameFormatResult) => (error ? reject(error) : resolve(result))}))
...
export const deviceDeviceHistoryListRpcPromise = (params: DeviceDeviceHistoryListRpcParam, waitingKey?: string): Promise<DeviceDeviceHistoryListResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.device.deviceHistoryList', params, callback: (error: RPCError, result: DeviceDeviceHistoryListResult) => (error ? reject(error) : resolve(result))}))
export const favoriteFavoriteAddRpcPromise = (params: FavoriteFavoriteAddRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.favorite.favoriteAdd', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const favoriteFavoriteIgnoreRpcPromise = (params: FavoriteFavoriteIgnoreRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.favorite.favoriteIgnore', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const gitCreatePersonalRepoRpcPromise = (params: GitCreatePersonalRepoRpcParam, waitingKey?: string): Promise<GitCreatePersonalRepoResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.git.createPersonalRepo', params, callback: (error: RPCError, result: GitCreatePersonalRepoResult) => (error ? reject(error) : resolve(result))}))
export const gitCreateTeamRepoRpcPromise = (params: GitCreateTeamRepoRpcParam, waitingKey?: string): Promise<GitCreateTeamRepoResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.git.createTeamRepo', params, callback: (error: RPCError, result: GitCreateTeamRepoResult) => (error ? reject(error) : resolve(result))}))
export const gitDeletePersonalRepoRpcPromise = (params: GitDeletePersonalRepoRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.git.deletePersonalRepo', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const gitDeleteTeamRepoRpcPromise = (params: GitDeleteTeamRepoRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.git.deleteTeamRepo', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const gitGetAllGitMetadataRpcPromise = (params: GitGetAllGitMetadataRpcParam, waitingKey?: string): Promise<GitGetAllGitMetadataResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.git.getAllGitMetadata', params, callback: (error: RPCError, result: GitGetAllGitMetadataResult) => (error ? reject(error) : resolve(result))}))
export const gitGetGitMetadataRpcPromise = (params: GitGetGitMetadataRpcParam, waitingKey?: string): Promise<GitGetGitMetadataResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.git.getGitMetadata', params, callback: (error: RPCError, result: GitGetGitMetadataResult) => (error ? reject(error) : resolve(result))}))
export const gitSetTeamRepoSettingsRpcPromise = (params: GitSetTeamRepoSettingsRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.git.setTeamRepoSettings', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const gregorDismissCategoryRpcPromise = (params: GregorDismissCategoryRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.gregor.dismissCategory', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const gregorDismissItemRpcPromise = (params: GregorDismissItemRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.gregor.dismissItem', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const gregorGetStateRpcPromise = (params: GregorGetStateRpcParam, waitingKey?: string): Promise<GregorGetStateResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.gregor.getState', params, callback: (error: RPCError, result: GregorGetStateResult) => (error ? reject(error) : resolve(result))}))
export const gregorInjectItemRpcPromise = (params: GregorInjectItemRpcParam, waitingKey?: string): Promise<GregorInjectItemResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.gregor.injectItem', params, callback: (error: RPCError, result: GregorInjectItemResult) => (error ? reject(error) : resolve(result))}))
export const gregorUpdateCategoryRpcPromise = (params: GregorUpdateCategoryRpcParam, waitingKey?: string): Promise<GregorUpdateCategoryResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.gregor.updateCategory', params, callback: (error: RPCError, result: GregorUpdateCategoryResult) => (error ? reject(error) : resolve(result))}))
export const gregorUpdateItemRpcPromise = (params: GregorUpdateItemRpcParam, waitingKey?: string): Promise<GregorUpdateItemResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.gregor.updateItem', params, callback: (error: RPCError, result: GregorUpdateItemResult) => (error ? reject(error) : resolve(result))}))
export const homeHomeGetScreenRpcPromise = (params: HomeHomeGetScreenRpcParam, waitingKey?: string): Promise<HomeHomeGetScreenResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.home.homeGetScreen', params, callback: (error: RPCError, result: HomeHomeGetScreenResult) => (error ? reject(error) : resolve(result))}))
export const homeHomeMarkViewedRpcPromise = (params: HomeHomeMarkViewedRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.home.homeMarkViewed', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const homeHomeSkipTodoTypeRpcPromise = (params: HomeHomeSkipTodoTypeRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.home.homeSkipTodoType', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const identifyIdentify2RpcPromise = (params: IdentifyIdentify2RpcParam, waitingKey?: string): Promise<IdentifyIdentify2Result> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.identify.identify2', params, callback: (error: RPCError, result: IdentifyIdentify2Result) => (error ? reject(error) : resolve(result))}))
export const installFuseStatusRpcPromise = (params: InstallFuseStatusRpcParam, waitingKey?: string): Promise<InstallFuseStatusResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.install.fuseStatus', params, callback: (error: RPCError, result: InstallFuseStatusResult) => (error ? reject(error) : resolve(result))}))
export const installInstallFuseRpcPromise = (params: InstallInstallFuseRpcParam, waitingKey?: string): Promise<InstallInstallFuseResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.install.installFuse', params, callback: (error: RPCError, result: InstallInstallFuseResult) => (error ? reject(error) : resolve(result))}))
...
export const installUninstallKBFSRpcPromise = (params: InstallUninstallKBFSRpcParam, waitingKey?: string): Promise<InstallUninstallKBFSResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.install.uninstallKBFS', params, callback: (error: RPCError, result: InstallUninstallKBFSResult) => (error ? reject(error) : resolve(result))}))
export const kbfsMountGetCurrentMountDirRpcPromise = (params: KbfsMountGetCurrentMountDirRpcParam, waitingKey?: string): Promise<KbfsMountGetCurrentMountDirResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.kbfsMount.GetCurrentMountDir', params, callback: (error: RPCError, result: KbfsMountGetCurrentMountDirResult) => (error ? reject(error) : resolve(result))}))
export const loginAccountDeleteRpcPromise = (params: LoginAccountDeleteRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.login.accountDelete', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const loginDeprovisionRpcPromise = (params: LoginDeprovisionRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.login.deprovision', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const loginGetConfiguredAccountsRpcPromise = (params: LoginGetConfiguredAccountsRpcParam, waitingKey?: string): Promise<LoginGetConfiguredAccountsResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.login.getConfiguredAccounts', params, callback: (error: RPCError, result: LoginGetConfiguredAccountsResult) => (error ? reject(error) : resolve(result))}))
...
export const loginPaperKeySubmitRpcPromise = (params: LoginPaperKeySubmitRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.login.paperKeySubmit', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const notifyCtlSetNotificationsRpcPromise = (params: NotifyCtlSetNotificationsRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.notifyCtl.setNotifications', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const pgpPgpStorageDismissRpcPromise = (params: PgpPgpStorageDismissRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.pgp.pgpStorageDismiss', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const pprofLogProcessorProfileRpcPromise = (params: PprofLogProcessorProfileRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.pprof.logProcessorProfile', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const pprofLogTraceRpcPromise = (params: PprofLogTraceRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.pprof.logTrace', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const proveCheckProofRpcPromise = (params: ProveCheckProofRpcParam, waitingKey?: string): Promise<ProveCheckProofResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.prove.checkProof', params, callback: (error: RPCError, result: ProveCheckProofResult) => (error ? reject(error) : resolve(result))}))
...
export const reachabilityCheckReachabilityRpcPromise = (params: ReachabilityCheckReachabilityRpcParam, waitingKey?: string): Promise<ReachabilityCheckReachabilityResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.reachability.checkReachability', params, callback: (error: RPCError, result: ReachabilityCheckReachabilityResult) => (error ? reject(error) : resolve(result))}))
export const reachabilityStartReachabilityRpcPromise = (params: ReachabilityStartReachabilityRpcParam, waitingKey?: string): Promise<ReachabilityStartReachabilityResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.reachability.startReachability', params, callback: (error: RPCError, result: ReachabilityStartReachabilityResult) => (error ? reject(error) : resolve(result))}))
export const rekeyGetRevokeWarningRpcPromise = (params: RekeyGetRevokeWarningRpcParam, waitingKey?: string): Promise<RekeyGetRevokeWarningResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.rekey.getRevokeWarning', params, callback: (error: RPCError, result: RekeyGetRevokeWarningResult) => (error ? reject(error) : resolve(result))}))
...
export const rekeyShowPendingRekeyStatusRpcPromise = (params: RekeyShowPendingRekeyStatusRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.rekey.showPendingRekeyStatus', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const revokeRevokeDeviceRpcPromise = (params: RevokeRevokeDeviceRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.revoke.revokeDevice', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const revokeRevokeKeyRpcPromise = (params: RevokeRevokeKeyRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.revoke.revokeKey', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const revokeRevokeSigsRpcPromise = (params: RevokeRevokeSigsRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.revoke.revokeSigs', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const signupCheckInvitationCodeRpcPromise = (params: SignupCheckInvitationCodeRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.signup.checkInvitationCode', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const signupCheckUsernameAvailableRpcPromise = (params: SignupCheckUsernameAvailableRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.signup.checkUsernameAvailable', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const signupGetInvitationCodeRpcPromise = (params: SignupGetInvitationCodeRpcParam, waitingKey?: string): Promise<SignupGetInvitationCodeResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.signup.getInvitationCode', params, callback: (error: RPCError, result: SignupGetInvitationCodeResult) => (error ? reject(error) : resolve(result))}))
export const signupInviteRequestRpcPromise = (params: SignupInviteRequestRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.signup.inviteRequest', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const teamsCanUserPerformRpcPromise = (params: TeamsCanUserPerformRpcParam, waitingKey?: string): Promise<TeamsCanUserPerformResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.canUserPerform', params, callback: (error: RPCError, result: TeamsCanUserPerformResult) => (error ? reject(error) : resolve(result))}))
export const teamsGetTarsDisabledRpcPromise = (params: TeamsGetTarsDisabledRpcParam, waitingKey?: string): Promise<TeamsGetTarsDisabledResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.getTarsDisabled', params, callback: (error: RPCError, result: TeamsGetTarsDisabledResult) => (error ? reject(error) : resolve(result))}))
export const teamsGetTeamAndMemberShowcaseRpcPromise = (params: TeamsGetTeamAndMemberShowcaseRpcParam, waitingKey?: string): Promise<TeamsGetTeamAndMemberShowcaseResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.getTeamAndMemberShowcase', params, callback: (error: RPCError, result: TeamsGetTeamAndMemberShowcaseResult) => (error ? reject(error) : resolve(result))}))
export const teamsSetTarsDisabledRpcPromise = (params: TeamsSetTarsDisabledRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.setTarsDisabled', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const teamsSetTeamMemberShowcaseRpcPromise = (params: TeamsSetTeamMemberShowcaseRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.setTeamMemberShowcase', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const teamsSetTeamShowcaseRpcPromise = (params: TeamsSetTeamShowcaseRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.setTeamShowcase', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const teamsTeamAddEmailsBulkRpcPromise = (params: TeamsTeamAddEmailsBulkRpcParam, waitingKey?: string): Promise<TeamsTeamAddEmailsBulkResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamAddEmailsBulk', params, callback: (error: RPCError, result: TeamsTeamAddEmailsBulkResult) => (error ? reject(error) : resolve(result))}))
export const teamsTeamAddMemberRpcPromise = (params: TeamsTeamAddMemberRpcParam, waitingKey?: string): Promise<TeamsTeamAddMemberResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamAddMember', params, callback: (error: RPCError, result: TeamsTeamAddMemberResult) => (error ? reject(error) : resolve(result))}))
export const teamsTeamCreateRpcPromise = (params: TeamsTeamCreateRpcParam, waitingKey?: string): Promise<TeamsTeamCreateResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamCreate', params, callback: (error: RPCError, result: TeamsTeamCreateResult) => (error ? reject(error) : resolve(result))}))
export const teamsTeamCreateSeitanTokenV2RpcPromise = (params: TeamsTeamCreateSeitanTokenV2RpcParam, waitingKey?: string): Promise<TeamsTeamCreateSeitanTokenV2Result> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamCreateSeitanTokenV2', params, callback: (error: RPCError, result: TeamsTeamCreateSeitanTokenV2Result) => (error ? reject(error) : resolve(result))}))
export const teamsTeamEditMemberRpcPromise = (params: TeamsTeamEditMemberRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamEditMember', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const teamsTeamGetRpcPromise = (params: TeamsTeamGetRpcParam, waitingKey?: string): Promise<TeamsTeamGetResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamGet', params, callback: (error: RPCError, result: TeamsTeamGetResult) => (error ? reject(error) : resolve(result))}))
export const teamsTeamIgnoreRequestRpcPromise = (params: TeamsTeamIgnoreRequestRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamIgnoreRequest', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const teamsTeamLeaveRpcPromise = (params: TeamsTeamLeaveRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamLeave', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const teamsTeamReAddMemberAfterResetRpcPromise = (params: TeamsTeamReAddMemberAfterResetRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamReAddMemberAfterReset', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const teamsTeamRemoveMemberRpcPromise = (params: TeamsTeamRemoveMemberRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamRemoveMember', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const teamsTeamSetSettingsRpcPromise = (params: TeamsTeamSetSettingsRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamSetSettings', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const teamsTeamTreeRpcPromise = (params: TeamsTeamTreeRpcParam, waitingKey?: string): Promise<TeamsTeamTreeResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamTree', params, callback: (error: RPCError, result: TeamsTeamTreeResult) => (error ? reject(error) : resolve(result))}))
export const trackCheckTrackingRpcPromise = (params: TrackCheckTrackingRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.track.checkTracking', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const trackDismissWithTokenRpcPromise = (params: TrackDismissWithTokenRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.track.dismissWithToken', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const trackTrackWithTokenRpcPromise = (params: TrackTrackWithTokenRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.track.trackWithToken', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const trackUntrackRpcPromise = (params: TrackUntrackRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.track.untrack', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const userListTrackers2RpcPromise = (params: UserListTrackers2RpcParam, waitingKey?: string): Promise<UserListTrackers2Result> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.user.listTrackers2', params, callback: (error: RPCError, result: UserListTrackers2Result) => (error ? reject(error) : resolve(result))}))
export const userLoadMySettingsRpcPromise = (params: UserLoadMySettingsRpcParam, waitingKey?: string): Promise<UserLoadMySettingsResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.user.loadMySettings', params, callback: (error: RPCError, result: UserLoadMySettingsResult) => (error ? reject(error) : resolve(result))}))
export const userProfileEditRpcPromise = (params: UserProfileEditRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.user.profileEdit', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export type SimpleFSSimpleFSListRecursiveToDepthRpcParam = $ReadOnly<{opID: OpID, path: Path, filter: ListFilter, depth: Int}>
