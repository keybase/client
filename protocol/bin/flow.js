...
function engineSagaGen(methodName, name, response, requestType, responseType, justType) {
  ...
  return justType
    ...
    : `export const ${name}RpcSaga = (p, incomingCallMap, waitingKey) => call(engineSaga, {method: ${methodName}, params: p.params, incomingCallMap: p.incomingCallMap, waitingKey: p.waitingKey})`
}
...
function rpcChannelMapGen(methodName, name, response, requestType, responseType, justType) {
  ...
  return justType
    ...
    : `export const ${name}RpcChannelMap = (configKeys, request) => getEngine()._channelMapRpcHelper(configKeys, ${methodName}, request)`
}
...
function rpcPromiseGen(methodName, name, response, requestType, responseType, justType) {
  ...
  return justType
    ...
    : `export const ${name}RpcPromise = (params, waitingKey) => new Promise((resolve, reject) => getEngine()._rpcOutgoing({method: ${methodName}, params, callback: (error, result) => error ? reject(error) : resolve(${
