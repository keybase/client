...
type mdServerMemShared struct {
	...
	latestHandleDb map[tlf.ID]tlf.BareTlfHandle
...
func NewMDServerMemory(config mdServerLocalConfig) (*MDServerMemory, error) {
	...
	latestHandleDb := make(map[tlf.ID]tlf.BareTlfHandle)
...
func (md *MDServerMemory) getHandleID(ctx context.Context, handle tlf.BareTlfHandle,
...
func (md *MDServerMemory) GetForHandle(ctx context.Context, handle tlf.BareTlfHandle,
...
func (md *MDServerMemory) GetLatestHandleForTLF(_ context.Context, id tlf.ID) (
	...
	if md.latestHandleDb == nil {
		return tlf.BareTlfHandle{}, errMDServerMemoryShutdown
	}
