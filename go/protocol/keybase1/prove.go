...
func (c ProveClient) StartProof(ctx context.Context, __arg StartProofArg) (res StartProofResult, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.prove.startProof", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ProveClient) CheckProof(ctx context.Context, __arg CheckProofArg) (res CheckProofStatus, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.prove.checkProof", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ProveClient) ListProofServices(ctx context.Context) (res []string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.prove.listProofServices", []interface{}{ListProofServicesArg{}}, &res, rpc.CompressionNone)
	return
}
