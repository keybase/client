...
func (c ReachabilityClient) StartReachability(ctx context.Context) (res Reachability, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.reachability.startReachability", []interface{}{StartReachabilityArg{}}, &res, rpc.CompressionNone)
	return
}

// Performs a reachability check. This is not a cached response.
func (c ReachabilityClient) CheckReachability(ctx context.Context) (res Reachability, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.reachability.checkReachability", []interface{}{CheckReachabilityArg{}}, &res, rpc.CompressionNone)
	return
}
