...
func (c ConfigClient) GetCurrentStatus(ctx context.Context, sessionID int) (res GetCurrentStatusRes, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getCurrentStatus", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c ConfigClient) GetExtendedStatus(ctx context.Context, sessionID int) (res ExtendedStatus, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getExtendedStatus", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c ConfigClient) GetAllProvisionedUsernames(ctx context.Context, sessionID int) (res AllProvisionedUsernames, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getAllProvisionedUsernames", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c ConfigClient) GetConfig(ctx context.Context, sessionID int) (res Config, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getConfig", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c ConfigClient) SetUserConfig(ctx context.Context, __arg SetUserConfigArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.setUserConfig", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ConfigClient) SetPath(ctx context.Context, __arg SetPathArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.setPath", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ConfigClient) HelloIAm(ctx context.Context, details ClientDetails) (err error) {
	__arg := HelloIAmArg{Details: details}
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.helloIAm", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ConfigClient) SetValue(ctx context.Context, __arg SetValueArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.setValue", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ConfigClient) ClearValue(ctx context.Context, path string) (err error) {
	__arg := ClearValueArg{Path: path}
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.clearValue", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ConfigClient) GetValue(ctx context.Context, path string) (res ConfigValue, err error) {
	__arg := GetValueArg{Path: path}
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getValue", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

// Check whether the API server has told us we're out of date.
func (c ConfigClient) CheckAPIServerOutOfDateWarning(ctx context.Context) (res OutOfDateInfo, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.checkAPIServerOutOfDateWarning", []interface{}{CheckAPIServerOutOfDateWarningArg{}}, &res, rpc.CompressionNone)
	return
}

func (c ConfigClient) GetUpdateInfo(ctx context.Context) (res UpdateInfo, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getUpdateInfo", []interface{}{GetUpdateInfoArg{}}, &res, rpc.CompressionNone)
	return
}

func (c ConfigClient) StartUpdateIfNeeded(ctx context.Context) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.startUpdateIfNeeded", []interface{}{StartUpdateIfNeededArg{}}, nil, rpc.CompressionNone)
	return
}

// Wait for client type to connect to service.
func (c ConfigClient) WaitForClient(ctx context.Context, __arg WaitForClientArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.waitForClient", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c ConfigClient) GetBootstrapStatus(ctx context.Context, sessionID int) (res BootstrapStatus, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getBootstrapStatus", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c ConfigClient) GetRememberPassphrase(ctx context.Context, sessionID int) (res bool, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.getRememberPassphrase", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ConfigClient) SetRememberPassphrase(ctx context.Context, __arg SetRememberPassphraseArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.config.setRememberPassphrase", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
