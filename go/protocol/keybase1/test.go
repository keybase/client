...
func (c TestClient) Test(ctx context.Context, __arg TestArg) (res Test, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.test.test", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c TestClient) TestCallback(ctx context.Context, __arg TestCallbackArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.test.testCallback", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c TestClient) Panic(ctx context.Context, message string) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.test.panic", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
