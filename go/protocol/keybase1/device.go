...
func (c DeviceClient) DeviceList(ctx context.Context, sessionID int) (res []Device, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.device.deviceList", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c DeviceClient) DeviceHistoryList(ctx context.Context, sessionID int) (res []DeviceDetail, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.device.deviceHistoryList", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c DeviceClient) DeviceAdd(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.device.deviceAdd", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

// Checks the device name format.
func (c DeviceClient) CheckDeviceNameFormat(ctx context.Context, __arg CheckDeviceNameFormatArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.device.checkDeviceNameFormat", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c DeviceClient) DismissDeviceChangeNotifications(ctx context.Context) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.device.dismissDeviceChangeNotifications", []interface{}{DismissDeviceChangeNotificationsArg{}}, nil, rpc.CompressionNone)
	return
}
...
func (c DeviceClient) CheckDeviceNameForUser(ctx context.Context, __arg CheckDeviceNameForUserArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.device.checkDeviceNameForUser", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
