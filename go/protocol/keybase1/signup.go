...
func (c SignupClient) CheckUsernameAvailable(ctx context.Context, __arg CheckUsernameAvailableArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.signup.checkUsernameAvailable", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c SignupClient) Signup(ctx context.Context, __arg SignupArg) (res SignupRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.signup.signup", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c SignupClient) InviteRequest(ctx context.Context, __arg InviteRequestArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.signup.inviteRequest", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c SignupClient) CheckInvitationCode(ctx context.Context, __arg CheckInvitationCodeArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.signup.checkInvitationCode", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c SignupClient) GetInvitationCode(ctx context.Context, sessionID int) (res string, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.signup.getInvitationCode", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
