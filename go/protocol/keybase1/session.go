...
func (c SessionClient) CurrentSession(ctx context.Context, sessionID int) (res Session, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.session.currentSession", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c SessionClient) SessionPing(ctx context.Context) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.session.sessionPing", []interface{}{SessionPingArg{}}, nil, rpc.CompressionNone)
	return
}
