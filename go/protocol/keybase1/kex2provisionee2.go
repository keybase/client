...
func (c Kex2Provisionee2Client) Hello2(ctx context.Context, __arg Hello2Arg) (res Hello2Res, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.Kex2Provisionee2.hello2", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c Kex2Provisionee2Client) DidCounterSign2(ctx context.Context, __arg DidCounterSign2Arg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.Kex2Provisionee2.didCounterSign2", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
