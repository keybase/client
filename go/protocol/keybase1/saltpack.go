...
func (c SaltpackClient) SaltpackEncrypt(ctx context.Context, __arg SaltpackEncryptArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.saltpack.saltpackEncrypt", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c SaltpackClient) SaltpackDecrypt(ctx context.Context, __arg SaltpackDecryptArg) (res SaltpackEncryptedMessageInfo, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.saltpack.saltpackDecrypt", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c SaltpackClient) SaltpackSign(ctx context.Context, __arg SaltpackSignArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.saltpack.saltpackSign", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c SaltpackClient) SaltpackVerify(ctx context.Context, __arg SaltpackVerifyArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.saltpack.saltpackVerify", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
