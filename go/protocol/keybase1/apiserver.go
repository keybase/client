...
func (c ApiserverClient) Get(ctx context.Context, __arg GetArg) (res APIRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.apiserver.Get", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ApiserverClient) Delete(ctx context.Context, __arg DeleteArg) (res APIRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.apiserver.Delete", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ApiserverClient) GetWithSession(ctx context.Context, __arg GetWithSessionArg) (res APIRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.apiserver.GetWithSession", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ApiserverClient) Post(ctx context.Context, __arg PostArg) (res APIRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.apiserver.Post", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ApiserverClient) PostJSON(ctx context.Context, __arg PostJSONArg) (res APIRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.apiserver.PostJSON", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
