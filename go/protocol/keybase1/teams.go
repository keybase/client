...
type ImplicitTeamConflictGeneration int

func (o ImplicitTeamConflictGeneration) DeepCopy() ImplicitTeamConflictGeneration {
	return o
}

type ImplicitTeamConflictInfo struct {
	Generation ImplicitTeamConflictGeneration `codec:"generation" json:"generation"`
