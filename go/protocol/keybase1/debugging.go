...
func (c DebuggingClient) FirstStep(ctx context.Context, __arg FirstStepArg) (res FirstStepResult, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.debugging.firstStep", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c DebuggingClient) SecondStep(ctx context.Context, __arg SecondStepArg) (res int, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.debugging.secondStep", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c DebuggingClient) Increment(ctx context.Context, __arg IncrementArg) (res int, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.debugging.increment", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c DebuggingClient) Script(ctx context.Context, __arg ScriptArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.debugging.script", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
