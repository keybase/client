...
func (c KbfsMountClient) GetCurrentMountDir(ctx context.Context) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfsMount.GetCurrentMountDir", []interface{}{GetCurrentMountDirArg{}}, &res, rpc.CompressionNone)
	return
}

func (c KbfsMountClient) GetAllAvailableMountDirs(ctx context.Context) (res []string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfsMount.GetAllAvailableMountDirs", []interface{}{GetAllAvailableMountDirsArg{}}, &res, rpc.CompressionNone)
	return
}

func (c KbfsMountClient) SetCurrentMountDir(ctx context.Context, dir string) (err error) {
	__arg := SetCurrentMountDirArg{Dir: dir}
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfsMount.SetCurrentMountDir", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
