...
func (c GregorClient) GetState(ctx context.Context) (res gregor1.State, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gregor.getState", []interface{}{GetStateArg{}}, &res, rpc.CompressionNone)
	return
}

func (c GregorClient) InjectItem(ctx context.Context, __arg InjectItemArg) (res gregor1.MsgID, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gregor.injectItem", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c GregorClient) DismissCategory(ctx context.Context, category gregor1.Category) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.gregor.dismissCategory", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c GregorClient) DismissItem(ctx context.Context, id gregor1.MsgID) (err error) {
	__arg := DismissItemArg{Id: id}
	err = c.Cli.CallCompressed(ctx, "keybase.1.gregor.dismissItem", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c GregorClient) UpdateItem(ctx context.Context, __arg UpdateItemArg) (res gregor1.MsgID, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gregor.updateItem", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GregorClient) UpdateCategory(ctx context.Context, __arg UpdateCategoryArg) (res gregor1.MsgID, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gregor.updateCategory", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
