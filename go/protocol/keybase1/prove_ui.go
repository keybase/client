...
func (c ProveUiClient) PromptOverwrite(ctx context.Context, __arg PromptOverwriteArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.proveUi.promptOverwrite", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ProveUiClient) PromptUsername(ctx context.Context, __arg PromptUsernameArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.proveUi.promptUsername", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ProveUiClient) OutputPrechecks(ctx context.Context, __arg OutputPrechecksArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.proveUi.outputPrechecks", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ProveUiClient) PreProofWarning(ctx context.Context, __arg PreProofWarningArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.proveUi.preProofWarning", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ProveUiClient) OutputInstructions(ctx context.Context, __arg OutputInstructionsArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.proveUi.outputInstructions", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ProveUiClient) OkToCheck(ctx context.Context, __arg OkToCheckArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.proveUi.okToCheck", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c ProveUiClient) DisplayRecheckWarning(ctx context.Context, __arg DisplayRecheckWarningArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.proveUi.displayRecheckWarning", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
