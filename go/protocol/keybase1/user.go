...
func (c UserClient) ListTrackers(ctx context.Context, __arg ListTrackersArg) (res []Tracker, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.listTrackers", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c UserClient) ListTrackersByName(ctx context.Context, __arg ListTrackersByNameArg) (res []Tracker, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.listTrackersByName", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) ListTrackersSelf(ctx context.Context, sessionID int) (res []Tracker, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.listTrackersSelf", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) LoadUncheckedUserSummaries(ctx context.Context, __arg LoadUncheckedUserSummariesArg) (res []UserSummary, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadUncheckedUserSummaries", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

// Load a user from the server.
func (c UserClient) LoadUser(ctx context.Context, __arg LoadUserArg) (res User, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadUser", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c UserClient) LoadUserByName(ctx context.Context, __arg LoadUserByNameArg) (res User, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadUserByName", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

// Load a user + device keys from the server.
func (c UserClient) LoadUserPlusKeys(ctx context.Context, __arg LoadUserPlusKeysArg) (res UserPlusKeys, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadUserPlusKeys", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) LoadUserPlusKeysV2(ctx context.Context, __arg LoadUserPlusKeysV2Arg) (res UserPlusKeysV2AllIncarnations, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadUserPlusKeysV2", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

// Load public keys for a user.
func (c UserClient) LoadPublicKeys(ctx context.Context, __arg LoadPublicKeysArg) (res []PublicKey, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadPublicKeys", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) LoadMyPublicKeys(ctx context.Context, sessionID int) (res []PublicKey, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadMyPublicKeys", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) LoadMySettings(ctx context.Context, sessionID int) (res UserSettings, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadMySettings", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) ListTracking(ctx context.Context, __arg ListTrackingArg) (res []UserSummary, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.listTracking", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c UserClient) ListTrackingJSON(ctx context.Context, __arg ListTrackingJSONArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.listTrackingJSON", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) LoadAllPublicKeysUnverified(ctx context.Context, __arg LoadAllPublicKeysUnverifiedArg) (res []PublicKey, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.loadAllPublicKeysUnverified", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c UserClient) ListTrackers2(ctx context.Context, __arg ListTrackers2Arg) (res UserSummary2Set, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.listTrackers2", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c UserClient) ProfileEdit(ctx context.Context, __arg ProfileEditArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.profileEdit", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c UserClient) InterestingPeople(ctx context.Context, maxUsers int) (res []InterestingPerson, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.interestingPeople", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c UserClient) MeUserVersion(ctx context.Context, __arg MeUserVersionArg) (res UserVersion, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.meUserVersion", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) GetUPAK(ctx context.Context, uid UID) (res UPAKVersioned, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.getUPAK", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) GetUPAKLite(ctx context.Context, uid UID) (res UPKLiteV1AllIncarnations, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.getUPAKLite", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c UserClient) UploadUserAvatar(ctx context.Context, __arg UploadUserAvatarArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.uploadUserAvatar", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c UserClient) FindNextMerkleRootAfterRevoke(ctx context.Context, __arg FindNextMerkleRootAfterRevokeArg) (res NextMerkleRootRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.findNextMerkleRootAfterRevoke", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c UserClient) FindNextMerkleRootAfterReset(ctx context.Context, __arg FindNextMerkleRootAfterResetArg) (res NextMerkleRootRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.user.findNextMerkleRootAfterReset", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
