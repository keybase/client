...
func (c RevokeClient) RevokeKey(ctx context.Context, __arg RevokeKeyArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.revoke.revokeKey", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c RevokeClient) RevokeDevice(ctx context.Context, __arg RevokeDeviceArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.revoke.revokeDevice", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c RevokeClient) RevokeSigs(ctx context.Context, __arg RevokeSigsArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.revoke.revokeSigs", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
