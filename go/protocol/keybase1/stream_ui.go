...
func (c StreamUiClient) Close(ctx context.Context, __arg CloseArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.streamUi.close", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c StreamUiClient) Read(ctx context.Context, __arg ReadArg) (res []byte, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.streamUi.read", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c StreamUiClient) Reset(ctx context.Context, __arg ResetArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.streamUi.reset", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c StreamUiClient) Write(ctx context.Context, __arg WriteArg) (res int, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.streamUi.write", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
