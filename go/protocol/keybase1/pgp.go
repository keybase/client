...
func (c PGPClient) PGPSign(ctx context.Context, __arg PGPSignArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpSign", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c PGPClient) PGPPull(ctx context.Context, __arg PGPPullArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpPull", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPEncrypt(ctx context.Context, __arg PGPEncryptArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpEncrypt", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPDecrypt(ctx context.Context, __arg PGPDecryptArg) (res PGPSigVerification, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpDecrypt", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPVerify(ctx context.Context, __arg PGPVerifyArg) (res PGPSigVerification, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpVerify", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPImport(ctx context.Context, __arg PGPImportArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpImport", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

// Exports active PGP keys. Only allows armored export.
func (c PGPClient) PGPExport(ctx context.Context, __arg PGPExportArg) (res []KeyInfo, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpExport", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPExportByFingerprint(ctx context.Context, __arg PGPExportByFingerprintArg) (res []KeyInfo, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpExportByFingerprint", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPExportByKID(ctx context.Context, __arg PGPExportByKIDArg) (res []KeyInfo, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpExportByKID", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPKeyGen(ctx context.Context, __arg PGPKeyGenArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpKeyGen", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPKeyGenDefault(ctx context.Context, __arg PGPKeyGenDefaultArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpKeyGenDefault", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c PGPClient) PGPDeletePrimary(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpDeletePrimary", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

// Select an existing key and add to Keybase.
func (c PGPClient) PGPSelect(ctx context.Context, __arg PGPSelectArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpSelect", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

// Push updated key(s) to the server.
func (c PGPClient) PGPUpdate(ctx context.Context, __arg PGPUpdateArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpUpdate", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PGPClient) PGPPurge(ctx context.Context, __arg PGPPurgeArg) (res PGPPurgeRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpPurge", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c PGPClient) PGPStorageDismiss(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpStorageDismiss", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c PGPClient) PGPPushPrivate(ctx context.Context, __arg PGPPushPrivateArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpPushPrivate", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c PGPClient) PGPPullPrivate(ctx context.Context, __arg PGPPullPrivateArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgp.pgpPullPrivate", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
