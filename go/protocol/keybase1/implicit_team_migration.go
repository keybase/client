...
func (c ImplicitTeamMigrationClient) StartMigration(ctx context.Context, folder Folder) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.implicitTeamMigration.startMigration", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c ImplicitTeamMigrationClient) FinalizeMigration(ctx context.Context, folder Folder) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.implicitTeamMigration.finalizeMigration", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
