...
func (c RekeyUIClient) DelegateRekeyUI(ctx context.Context) (res int, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekeyUI.delegateRekeyUI", []interface{}{DelegateRekeyUIArg{}}, &res, rpc.CompressionNone)
	return
}
...
func (c RekeyUIClient) Refresh(ctx context.Context, __arg RefreshArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekeyUI.refresh", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
