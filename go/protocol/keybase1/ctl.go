...
func (c CtlClient) Stop(ctx context.Context, __arg StopArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.stop", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c CtlClient) LogRotate(ctx context.Context, sessionID int) (err error) {
	__arg := LogRotateArg{SessionID: sessionID}
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.logRotate", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c CtlClient) Reload(ctx context.Context, sessionID int) (err error) {
	__arg := ReloadArg{SessionID: sessionID}
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.reload", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c CtlClient) DbNuke(ctx context.Context, sessionID int) (err error) {
	__arg := DbNukeArg{SessionID: sessionID}
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.dbNuke", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c CtlClient) AppExit(ctx context.Context, sessionID int) (err error) {
	__arg := AppExitArg{SessionID: sessionID}
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.appExit", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c CtlClient) DbDelete(ctx context.Context, __arg DbDeleteArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.dbDelete", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c CtlClient) DbPut(ctx context.Context, __arg DbPutArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.dbPut", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c CtlClient) DbGet(ctx context.Context, __arg DbGetArg) (res *DbValue, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.ctl.dbGet", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
