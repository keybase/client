...
func (c LoginClient) GetConfiguredAccounts(ctx context.Context, sessionID int) (res []ConfiguredAccount, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.getConfiguredAccounts", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LoginClient) Login(ctx context.Context, __arg LoginArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.login", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) LoginProvisionedDevice(ctx context.Context, __arg LoginProvisionedDeviceArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.loginProvisionedDevice", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) LoginWithPaperKey(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.loginWithPaperKey", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) ClearStoredSecret(ctx context.Context, __arg ClearStoredSecretArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.clearStoredSecret", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LoginClient) Logout(ctx context.Context, sessionID int) (err error) {
	__arg := LogoutArg{SessionID: sessionID}
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.logout", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LoginClient) Deprovision(ctx context.Context, __arg DeprovisionArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.deprovision", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) RecoverAccountFromEmailAddress(ctx context.Context, email string) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.recoverAccountFromEmailAddress", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) PaperKey(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.paperKey", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) PaperKeySubmit(ctx context.Context, __arg PaperKeySubmitArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.paperKeySubmit", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) Unlock(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.unlock", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LoginClient) UnlockWithPassphrase(ctx context.Context, __arg UnlockWithPassphraseArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.unlockWithPassphrase", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) AccountDelete(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.accountDelete", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LoginClient) LoginOneshot(ctx context.Context, __arg LoginOneshotArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.login.loginOneshot", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
