...
func (c InstallClient) FuseStatus(ctx context.Context, __arg FuseStatusArg) (res FuseStatus, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.install.fuseStatus", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c InstallClient) InstallFuse(ctx context.Context) (res InstallResult, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.install.installFuse", []interface{}{InstallFuseArg{}}, &res, rpc.CompressionNone)
	return
}

func (c InstallClient) InstallKBFS(ctx context.Context) (res InstallResult, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.install.installKBFS", []interface{}{InstallKBFSArg{}}, &res, rpc.CompressionNone)
	return
}

func (c InstallClient) UninstallKBFS(ctx context.Context) (res UninstallResult, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.install.uninstallKBFS", []interface{}{UninstallKBFSArg{}}, &res, rpc.CompressionNone)
	return
}

func (c InstallClient) InstallCommandLinePrivileged(ctx context.Context) (res InstallResult, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.install.installCommandLinePrivileged", []interface{}{InstallCommandLinePrivilegedArg{}}, &res, rpc.CompressionNone)
	return
}
