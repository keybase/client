...
func (c MerkleClient) GetCurrentMerkleRoot(ctx context.Context, freshnessMsec int) (res MerkleRootAndTime, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.merkle.getCurrentMerkleRoot", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c MerkleClient) VerifyMerkleRootAndKBFS(ctx context.Context, __arg VerifyMerkleRootAndKBFSArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.merkle.verifyMerkleRootAndKBFS", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
