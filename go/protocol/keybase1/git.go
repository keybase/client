...
func (c GitClient) PutGitMetadata(ctx context.Context, __arg PutGitMetadataArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.putGitMetadata", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c GitClient) DeleteGitMetadata(ctx context.Context, __arg DeleteGitMetadataArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.deleteGitMetadata", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c GitClient) GetGitMetadata(ctx context.Context, folder Folder) (res []GitRepoResult, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.getGitMetadata", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GitClient) GetAllGitMetadata(ctx context.Context) (res []GitRepoResult, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.getAllGitMetadata", []interface{}{GetAllGitMetadataArg{}}, &res, rpc.CompressionNone)
	return
}
...
func (c GitClient) CreatePersonalRepo(ctx context.Context, repoName GitRepoName) (res RepoID, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.createPersonalRepo", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GitClient) CreateTeamRepo(ctx context.Context, __arg CreateTeamRepoArg) (res RepoID, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.createTeamRepo", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c GitClient) DeletePersonalRepo(ctx context.Context, repoName GitRepoName) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.deletePersonalRepo", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c GitClient) DeleteTeamRepo(ctx context.Context, __arg DeleteTeamRepoArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.deleteTeamRepo", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c GitClient) GcPersonalRepo(ctx context.Context, __arg GcPersonalRepoArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.gcPersonalRepo", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c GitClient) GcTeamRepo(ctx context.Context, __arg GcTeamRepoArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.gcTeamRepo", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c GitClient) GetTeamRepoSettings(ctx context.Context, __arg GetTeamRepoSettingsArg) (res GitTeamRepoSettings, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.getTeamRepoSettings", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GitClient) SetTeamRepoSettings(ctx context.Context, __arg SetTeamRepoSettingsArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.git.setTeamRepoSettings", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
