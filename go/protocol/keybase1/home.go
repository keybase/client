...
func (c HomeClient) HomeGetScreen(ctx context.Context, __arg HomeGetScreenArg) (res HomeScreen, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.home.homeGetScreen", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c HomeClient) HomeSkipTodoType(ctx context.Context, t HomeScreenTodoType) (err error) {
	__arg := HomeSkipTodoTypeArg{T: t}
	err = c.Cli.CallCompressed(ctx, "keybase.1.home.homeSkipTodoType", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c HomeClient) HomeActionTaken(ctx context.Context) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.home.homeActionTaken", []interface{}{HomeActionTakenArg{}}, nil, rpc.CompressionNone)
	return
}

func (c HomeClient) HomeMarkViewed(ctx context.Context) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.home.homeMarkViewed", []interface{}{HomeMarkViewedArg{}}, nil, rpc.CompressionNone)
	return
}
