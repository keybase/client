...
func (c RekeyClient) ShowPendingRekeyStatus(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekey.showPendingRekeyStatus", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c RekeyClient) GetPendingRekeyStatus(ctx context.Context, sessionID int) (res ProblemSetDevices, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekey.getPendingRekeyStatus", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c RekeyClient) DebugShowRekeyStatus(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekey.debugShowRekeyStatus", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c RekeyClient) RekeyStatusFinish(ctx context.Context, sessionID int) (res Outcome, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekey.rekeyStatusFinish", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c RekeyClient) RekeySync(ctx context.Context, __arg RekeySyncArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekey.rekeySync", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c RekeyClient) GetRevokeWarning(ctx context.Context, __arg GetRevokeWarningArg) (res RevokeWarning, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.rekey.getRevokeWarning", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
