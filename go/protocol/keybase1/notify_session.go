...
func (c NotifySessionClient) LoggedIn(ctx context.Context, username string) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.NotifySession.loggedIn", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c NotifySessionClient) ClientOutOfDate(ctx context.Context, __arg ClientOutOfDateArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.NotifySession.clientOutOfDate", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
