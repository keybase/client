...
func (c TeamsUiClient) ConfirmRootTeamDelete(ctx context.Context, __arg ConfirmRootTeamDeleteArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.teamsUi.confirmRootTeamDelete", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c TeamsUiClient) ConfirmSubteamDelete(ctx context.Context, __arg ConfirmSubteamDeleteArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.teamsUi.confirmSubteamDelete", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
