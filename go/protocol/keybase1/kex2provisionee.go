...
func (c Kex2ProvisioneeClient) Hello(ctx context.Context, __arg HelloArg) (res HelloRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.Kex2Provisionee.hello", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c Kex2ProvisioneeClient) DidCounterSign(ctx context.Context, sig []byte) (err error) {
	__arg := DidCounterSignArg{Sig: sig}
	err = c.Cli.CallCompressed(ctx, "keybase.1.Kex2Provisionee.didCounterSign", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
