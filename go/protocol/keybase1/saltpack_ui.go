...
func (o SaltpackPromptForDecryptArg) DeepCopy() SaltpackPromptForDecryptArg {
	return SaltpackPromptForDecryptArg{
		SessionID:      o.SessionID,
		Sender:         o.Sender.DeepCopy(),
		UsedDelegateUI: o.UsedDelegateUI,
	}
}
...
func (o SaltpackVerifySuccessArg) DeepCopy() SaltpackVerifySuccessArg {
	return SaltpackVerifySuccessArg{
		SessionID:  o.SessionID,
...
func (o SaltpackVerifyBadSenderArg) DeepCopy() SaltpackVerifyBadSenderArg {
	return SaltpackVerifyBadSenderArg{
		SessionID:  o.SessionID,
		SigningKID: o.SigningKID.DeepCopy(),
		Sender:     o.Sender.DeepCopy(),
	}
