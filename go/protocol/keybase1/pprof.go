...
func (c PprofClient) ProcessorProfile(ctx context.Context, __arg ProcessorProfileArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pprof.processorProfile", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PprofClient) LogProcessorProfile(ctx context.Context, __arg LogProcessorProfileArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pprof.logProcessorProfile", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PprofClient) Trace(ctx context.Context, __arg TraceArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pprof.trace", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PprofClient) LogTrace(ctx context.Context, __arg LogTraceArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pprof.logTrace", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
