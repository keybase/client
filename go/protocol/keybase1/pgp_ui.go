...
func (c PGPUiClient) OutputSignatureSuccess(ctx context.Context, __arg OutputSignatureSuccessArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgpUi.outputSignatureSuccess", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c PGPUiClient) OutputSignatureSuccessNonKeybase(ctx context.Context, __arg OutputSignatureSuccessNonKeybaseArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgpUi.outputSignatureSuccessNonKeybase", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c PGPUiClient) KeyGenerated(ctx context.Context, __arg KeyGeneratedArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgpUi.keyGenerated", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c PGPUiClient) ShouldPushPrivate(ctx context.Context, sessionID int) (res bool, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgpUi.shouldPushPrivate", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c PGPUiClient) Finished(ctx context.Context, sessionID int) (err error) {
	__arg := FinishedArg{SessionID: sessionID}
	err = c.Cli.CallCompressed(ctx, "keybase.1.pgpUi.finished", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
