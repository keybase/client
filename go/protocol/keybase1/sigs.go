...
func (c SigsClient) SigList(ctx context.Context, __arg SigListArg) (res []Sig, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.sigs.sigList", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c SigsClient) SigListJSON(ctx context.Context, __arg SigListJSONArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.sigs.sigListJSON", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
