...
func (c GpgUiClient) WantToAddGPGKey(ctx context.Context, sessionID int) (res bool, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.gpgUi.wantToAddGPGKey", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c GpgUiClient) ConfirmDuplicateKeyChosen(ctx context.Context, sessionID int) (res bool, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.gpgUi.confirmDuplicateKeyChosen", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c GpgUiClient) ConfirmImportSecretToExistingKey(ctx context.Context, sessionID int) (res bool, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.gpgUi.confirmImportSecretToExistingKey", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GpgUiClient) SelectKeyAndPushOption(ctx context.Context, __arg SelectKeyAndPushOptionArg) (res SelectKeyRes, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gpgUi.selectKeyAndPushOption", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GpgUiClient) SelectKey(ctx context.Context, __arg SelectKeyArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gpgUi.selectKey", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GpgUiClient) Sign(ctx context.Context, __arg SignArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gpgUi.sign", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c GpgUiClient) GetTTY(ctx context.Context) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.gpgUi.getTTY", []interface{}{GetTTYArg{}}, &res, rpc.CompressionNone)
	return
}
