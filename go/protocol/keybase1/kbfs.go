...
func (c KbfsClient) FSEvent(ctx context.Context, event FSNotification) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfs.FSEvent", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c KbfsClient) FSEditList(ctx context.Context, __arg FSEditListArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfs.FSEditList", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c KbfsClient) FSSyncStatus(ctx context.Context, __arg FSSyncStatusArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfs.FSSyncStatus", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c KbfsClient) FSSyncEvent(ctx context.Context, event FSPathSyncStatus) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfs.FSSyncEvent", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c KbfsClient) CreateTLF(ctx context.Context, __arg CreateTLFArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfs.createTLF", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c KbfsClient) GetKBFSTeamSettings(ctx context.Context, teamID TeamID) (res KBFSTeamSettings, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfs.getKBFSTeamSettings", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

// upgradeTLF upgrades a TLF to use implicit team keys
func (c KbfsClient) UpgradeTLF(ctx context.Context, __arg UpgradeTLFArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "keybase.1.kbfs.upgradeTLF", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
