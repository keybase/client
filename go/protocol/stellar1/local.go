...
func (c LocalClient) GetWalletAccountsLocal(ctx context.Context, sessionID int) (res []WalletAccountLocal, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getWalletAccountsLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetWalletAccountLocal(ctx context.Context, __arg GetWalletAccountLocalArg) (res WalletAccountLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getWalletAccountLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetAccountAssetsLocal(ctx context.Context, __arg GetAccountAssetsLocalArg) (res []AccountAssetLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getAccountAssetsLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) GetPaymentsLocal(ctx context.Context, __arg GetPaymentsLocalArg) (res PaymentsPageLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getPaymentsLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetPendingPaymentsLocal(ctx context.Context, __arg GetPendingPaymentsLocalArg) (res []PaymentOrErrorLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getPendingPaymentsLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) MarkAsReadLocal(ctx context.Context, __arg MarkAsReadLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.markAsReadLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetPaymentDetailsLocal(ctx context.Context, __arg GetPaymentDetailsLocalArg) (res PaymentDetailsLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getPaymentDetailsLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetDisplayCurrenciesLocal(ctx context.Context, sessionID int) (res []CurrencyLocal, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getDisplayCurrenciesLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) ValidateAccountIDLocal(ctx context.Context, __arg ValidateAccountIDLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.validateAccountIDLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) ValidateSecretKeyLocal(ctx context.Context, __arg ValidateSecretKeyLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.validateSecretKeyLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) ValidateAccountNameLocal(ctx context.Context, __arg ValidateAccountNameLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.validateAccountNameLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) ChangeWalletAccountNameLocal(ctx context.Context, __arg ChangeWalletAccountNameLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.changeWalletAccountNameLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) SetWalletAccountAsDefaultLocal(ctx context.Context, __arg SetWalletAccountAsDefaultLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.setWalletAccountAsDefaultLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) DeleteWalletAccountLocal(ctx context.Context, __arg DeleteWalletAccountLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.deleteWalletAccountLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LocalClient) LinkNewWalletAccountLocal(ctx context.Context, __arg LinkNewWalletAccountLocalArg) (res AccountID, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.linkNewWalletAccountLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) CreateWalletAccountLocal(ctx context.Context, __arg CreateWalletAccountLocalArg) (res AccountID, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.createWalletAccountLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) ChangeDisplayCurrencyLocal(ctx context.Context, __arg ChangeDisplayCurrencyLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.changeDisplayCurrencyLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetDisplayCurrencyLocal(ctx context.Context, __arg GetDisplayCurrencyLocalArg) (res CurrencyLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getDisplayCurrencyLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) HasAcceptedDisclaimerLocal(ctx context.Context, sessionID int) (res bool, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.hasAcceptedDisclaimerLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) AcceptDisclaimerLocal(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.acceptDisclaimerLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetWalletAccountPublicKeyLocal(ctx context.Context, __arg GetWalletAccountPublicKeyLocalArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getWalletAccountPublicKeyLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetWalletAccountSecretKeyLocal(ctx context.Context, __arg GetWalletAccountSecretKeyLocalArg) (res SecretKey, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getWalletAccountSecretKeyLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetSendAssetChoicesLocal(ctx context.Context, __arg GetSendAssetChoicesLocalArg) (res []SendAssetChoiceLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getSendAssetChoicesLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) BuildPaymentLocal(ctx context.Context, __arg BuildPaymentLocalArg) (res BuildPaymentResLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.buildPaymentLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) SendPaymentLocal(ctx context.Context, __arg SendPaymentLocalArg) (res SendPaymentResLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.sendPaymentLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) BuildRequestLocal(ctx context.Context, __arg BuildRequestLocalArg) (res BuildRequestResLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.buildRequestLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetRequestDetailsLocal(ctx context.Context, __arg GetRequestDetailsLocalArg) (res RequestDetailsLocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getRequestDetailsLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) CancelRequestLocal(ctx context.Context, __arg CancelRequestLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.cancelRequestLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) MakeRequestLocal(ctx context.Context, __arg MakeRequestLocalArg) (res KeybaseRequestID, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.makeRequestLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) SetAccountMobileOnlyLocal(ctx context.Context, __arg SetAccountMobileOnlyLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.setAccountMobileOnlyLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) IsAccountMobileOnlyLocal(ctx context.Context, __arg IsAccountMobileOnlyLocalArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.isAccountMobileOnlyLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) CancelPaymentLocal(ctx context.Context, __arg CancelPaymentLocalArg) (res RelayClaimResult, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.cancelPaymentLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) BalancesLocal(ctx context.Context, accountID AccountID) (res []Balance, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.balancesLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) SendCLILocal(ctx context.Context, __arg SendCLILocalArg) (res SendResultCLILocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.sendCLILocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) ClaimCLILocal(ctx context.Context, __arg ClaimCLILocalArg) (res RelayClaimResult, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.claimCLILocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) RecentPaymentsCLILocal(ctx context.Context, accountID *AccountID) (res []PaymentOrErrorCLILocal, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.recentPaymentsCLILocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) PaymentDetailCLILocal(ctx context.Context, txID string) (res PaymentCLILocal, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.paymentDetailCLILocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) WalletInitLocal(ctx context.Context) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.walletInitLocal", []interface{}{WalletInitLocalArg{}}, nil, rpc.CompressionNone)
	return
}

func (c LocalClient) WalletDumpLocal(ctx context.Context) (res Bundle, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.walletDumpLocal", []interface{}{WalletDumpLocalArg{}}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) WalletGetAccountsCLILocal(ctx context.Context) (res []OwnAccountCLILocal, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.walletGetAccountsCLILocal", []interface{}{WalletGetAccountsCLILocalArg{}}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) OwnAccountLocal(ctx context.Context, accountID AccountID) (res bool, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.ownAccountLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) ImportSecretKeyLocal(ctx context.Context, __arg ImportSecretKeyLocalArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.importSecretKeyLocal", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LocalClient) ExportSecretKeyLocal(ctx context.Context, accountID AccountID) (res SecretKey, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.exportSecretKeyLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) SetDisplayCurrency(ctx context.Context, __arg SetDisplayCurrencyArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.setDisplayCurrency", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c LocalClient) ExchangeRateLocal(ctx context.Context, currency OutsideCurrencyCode) (res OutsideExchangeRate, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.exchangeRateLocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) GetAvailableLocalCurrencies(ctx context.Context) (res map[OutsideCurrencyCode]OutsideCurrencyDefinition, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.getAvailableLocalCurrencies", []interface{}{GetAvailableLocalCurrenciesArg{}}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) FormatLocalCurrencyString(ctx context.Context, __arg FormatLocalCurrencyStringArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.formatLocalCurrencyString", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c LocalClient) MakeRequestCLILocal(ctx context.Context, __arg MakeRequestCLILocalArg) (res KeybaseRequestID, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.makeRequestCLILocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c LocalClient) LookupCLILocal(ctx context.Context, name string) (res LookupResultCLILocal, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.local.lookupCLILocal", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
