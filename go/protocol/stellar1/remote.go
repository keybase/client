...
func (c RemoteClient) Balances(ctx context.Context, __arg BalancesArg) (res []Balance, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.balances", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) Details(ctx context.Context, __arg DetailsArg) (res AccountDetails, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.details", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) RecentPayments(ctx context.Context, __arg RecentPaymentsArg) (res PaymentsPage, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.recentPayments", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) PendingPayments(ctx context.Context, __arg PendingPaymentsArg) (res []PaymentSummary, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.pendingPayments", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) MarkAsRead(ctx context.Context, __arg MarkAsReadArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.markAsRead", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c RemoteClient) PaymentDetails(ctx context.Context, __arg PaymentDetailsArg) (res PaymentDetails, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.paymentDetails", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) AccountSeqno(ctx context.Context, __arg AccountSeqnoArg) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.accountSeqno", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) SubmitPayment(ctx context.Context, __arg SubmitPaymentArg) (res PaymentResult, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.submitPayment", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) SubmitRelayPayment(ctx context.Context, __arg SubmitRelayPaymentArg) (res PaymentResult, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.submitRelayPayment", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) SubmitRelayClaim(ctx context.Context, __arg SubmitRelayClaimArg) (res RelayClaimResult, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.submitRelayClaim", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c RemoteClient) AcquireAutoClaimLock(ctx context.Context, caller keybase1.UserVersion) (res string, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.acquireAutoClaimLock", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) ReleaseAutoClaimLock(ctx context.Context, __arg ReleaseAutoClaimLockArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.releaseAutoClaimLock", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c RemoteClient) NextAutoClaim(ctx context.Context, caller keybase1.UserVersion) (res *AutoClaim, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.nextAutoClaim", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) IsMasterKeyActive(ctx context.Context, __arg IsMasterKeyActiveArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.isMasterKeyActive", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) SubmitRequest(ctx context.Context, __arg SubmitRequestArg) (res KeybaseRequestID, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.submitRequest", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) RequestDetails(ctx context.Context, __arg RequestDetailsArg) (res RequestDetails, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.requestDetails", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}

func (c RemoteClient) CancelRequest(ctx context.Context, __arg CancelRequestArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.cancelRequest", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c RemoteClient) Ping(ctx context.Context) (res string, err error) {
	err = c.Cli.CallCompressed(ctx, "stellar.1.remote.ping", []interface{}{PingArg{}}, &res, rpc.CompressionNone)
	return
}
