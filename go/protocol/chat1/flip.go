...
//   Input file: avdl/chat1/flip.avdl
...
func (o GameKey) DeepCopy() GameKey {
	return o
}

type UserDeviceKey string

func (o UserDeviceKey) DeepCopy() UserDeviceKey {
	return o
}

type GameIDKey string

func (o GameIDKey) DeepCopy() GameIDKey {
	return o
}
...
type FlipMessageType int

const (
	FlipMessageType_START               FlipMessageType = 1
	FlipMessageType_COMMITMENT          FlipMessageType = 2
	FlipMessageType_COMMITMENT_COMPLETE FlipMessageType = 3
	FlipMessageType_REVEAL              FlipMessageType = 4
	FlipMessageType_END                 FlipMessageType = 5
)

func (o FlipMessageType) DeepCopy() FlipMessageType { return o }

var FlipMessageTypeMap = map[string]FlipMessageType{
	"START":               1,
	"COMMITMENT":          2,
...
var FlipMessageTypeRevMap = map[FlipMessageType]string{
	1: "START",
	2: "COMMITMENT",
...
func (e FlipMessageType) String() string {
	if v, ok := FlipMessageTypeRevMap[e]; ok {
		return v
	}
	return ""
}
...
type GameMessageBody struct {
	T__                  FlipMessageType     `codec:"t" json:"t"`
...
func (o GameMessageBody) Start() (res Start) {
	if o.T__ != FlipMessageType_START {
		panic("wrong case accessed")
	}
	if o.Start__ == nil {
		return
...
func (o GameMessageBody) Commitment() (res Commitment) {
	if o.T__ != FlipMessageType_COMMITMENT {
		panic("wrong case accessed")
	}
	if o.Commitment__ == nil {
		return
...
func (o GameMessageBody) CommitmentComplete() (res CommitmentComplete) {
	if o.T__ != FlipMessageType_COMMITMENT_COMPLETE {
		panic("wrong case accessed")
	}
	if o.CommitmentComplete__ == nil {
		return
...
func (o GameMessageBody) Reveal() (res Secret) {
	if o.T__ != FlipMessageType_REVEAL {
		panic("wrong case accessed")
	}
	if o.Reveal__ == nil {
		return
...
func NewGameMessageBodyWithCommitment(v Commitment) GameMessageBody {
	return GameMessageBody{
		T__:          FlipMessageType_COMMITMENT,
		Commitment__: &v,
	}
}
...
func NewGameMessageBodyWithCommitmentComplete(v CommitmentComplete) GameMessageBody {
	return GameMessageBody{
		T__:                  FlipMessageType_COMMITMENT_COMPLETE,
