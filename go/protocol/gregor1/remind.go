...
func (c RemindClient) GetReminders(ctx context.Context, maxReminders int) (res ReminderSet, err error) {
	...
	err = c.Cli.CallCompressed(ctx, "gregor.1.remind.getReminders", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
...
func (c RemindClient) DeleteReminders(ctx context.Context, reminderIDs []ReminderID) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "gregor.1.remind.deleteReminders", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
