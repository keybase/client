...
func TestAttachmentTitle(t *testing.T) {
	...
	remote := new(chatRemoteTester)
	h := newChatLocalHandler(nil, tc.G, nil)
	h.rc = remote

	arg := chat1.PostAttachmentLocalArg{
		Attachment: {Filename: "/tmp/picture.jpg", Size: 1000},
	}
	_, err := h.PostAttachmentLocal(ctx.TODO(), arg)
	if err != nil {
		t.Fatal(err)
	}
}

type chatRemoteTester struct{}

func (c *chatRemoteTester) GetInboxRemote(context.Context, GetInboxRemoteArg) (r GetInboxRemoteRes, e error) {
	return r, e
}
func (c *chatRemoteTester) GetThreadRemote(context.Context, GetThreadRemoteArg) (r GetThreadRemoteRes, e error) {
	return r, e
}
func (c *chatRemoteTester) PostRemote(context.Context, PostRemoteArg) (r PostRemoteRes, e error) {
	return r, e
}
func (c *chatRemoteTester) NewConversationRemote(context.Context, ConversationIDTriple) (r NewConversationRemoteRes, e error) {
	return r, e
}
func (c *chatRemoteTester) NewConversationRemote2(context.Context, NewConversationRemote2Arg) (r NewConversationRemoteRes, e error) {
	return r, e
}
func (c *chatRemoteTester) GetMessagesRemote(context.Context, GetMessagesRemoteArg) (r GetMessagesRemoteRes, e error) {
	return r, e
}
func (c *chatRemoteTester) MarkAsRead(context.Context, MarkAsReadArg) (r MarkAsReadRes, e error) {
	return r, e
}
func (c *chatRemoteTester) SetConversationStatus(context.Context, SetConversationStatusArg) (r, SetConversationStatusRes, e error) {
	return r, e
}
func (c *chatRemoteTester) TlfFinalize(context.Context, TLFID) error {
	return nil
}
func (c *chatRemoteTester) GetS3Params(context.Context, ConversationID) (s S3Params, e error) {
	return s, e
}
func (c *chatRemoteTester) S3Sign(context.Context, S3SignArg) ([]byte, error) {
	return nil, nil
}
