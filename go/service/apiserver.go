...
func (a *APIServerHandler) doGet(m libkb.MetaContext, arg GenericArg, sessionRequired bool) (res keybase1.APIRes, err error) {
	defer m.CTrace("APIServerHandler::Get", func() error { return err })()
