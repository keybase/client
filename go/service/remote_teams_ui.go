...
func (r *RemoteTeamsUI) TeamListUnverifiedLoaded(ctx context.Context, arg keybase1.TeamListUnverifiedLoadedArg) error {
	arg.SessionID = r.sessionID
	return r.cli.TeamListUnverifiedLoaded(ctx, arg)
}
