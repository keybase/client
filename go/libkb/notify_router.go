...
type NotifyListener interface {
	...
	ChatParticipantsInfo(convID chat1.ConversationID, participants map[chat1.ConvIDStr][]chat1.UIParticipant)
...
func (n *NotifyRouter) HandleChatParticipantsInfo(ctx context.Context,
	convID chat1.ConversationID, participants map[chat1.ConvIDStr][]chat1.UIParticipant) {
	if n == nil {
		return
	}
	n.cm.ApplyAll(func(id ConnectionID, xp rpc.Transporter) bool {
