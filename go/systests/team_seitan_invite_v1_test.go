...
func TestTeamInviteSeitanV1Failures(t *testing.T) {
	tt := newTeamTester(t)
	defer tt.cleanup()
	...
	token, err := own.teamsClient.TeamCreateSeitanTokenV1(context.Background(), keybase1.TeamCreateSeitanTokenV1Arg{
