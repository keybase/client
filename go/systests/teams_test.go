...
func TestTeamCanUserPerform(t *testing.T) {
	...
	require.True(t, annPerms.ChangeChannelAvatar)
	...
	require.True(t, bobPerms.ChangeChannelAvatar)
	...
	require.False(t, pamPerms.ChangeChannelAvatar)
	...
	require.False(t, eddPerms.ChangeChannelAvatar)
	...
	require.False(t, annPerms.ChangeChannelAvatar)
	require.True(t, annPerms.SetTeamShowcase)
	...
	require.False(t, bobPerms.ChangeChannelAvatar)
	require.True(t, bobPerms.SetTeamShowcase)
	...
	require.False(t, donnyPerms.ChangeChannelAvatar)
