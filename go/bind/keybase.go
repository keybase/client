...
func LogSend(feedback string, mobileVersionName string, mobileVersionCode string, sendLogs bool, uiLogPath string) (string, error) {
	logSendContext.Logs.Desktop = uiLogPath
	return logSendContext.LogSend("", feedback, mobileVersionName, mobileVersionCode, sendLogs, 5*1024*1024)
}
