...
// AutoInstall installs auto start on freebsd
...
// CheckIfValidLocation is not used on freebsd
...
// RunAfterStartup is not used on freebsd
...
func updaterBinName() (string, error) {
	return "", fmt.Errorf("Updater isn't supported on freebsd")
}
