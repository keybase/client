	...
	},
	{
		...
		status: stellar1.AirdropStatus{
			...
			Rows: []stellar1.AirdropQualification{
				...
				{
					Title:    "Old enough Keybase, GitHub, or Hacker News account",
					Subtitle: "You can connect a GitHub or Hacker News account created before January 1, 2017 to qualify. Note that patrickxb@github was already used to qualify a different account for the airdrop.",
					Valid:    false,
				},
			},
		},
