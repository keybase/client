...
func (r *RemoteNet) SetAccountMobileOnly(ctx context.Context, accountID stellar1.AccountID, enabled bool) error {
	return SetAccountMobileOnly(ctx, r.G(), accountID, enabled)
}
