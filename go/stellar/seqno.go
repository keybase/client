...
func NewFastSeqnoProvider(mctx libkb.MetaContext, walletState *WalletState) *FastSeqnoProvider {
...
func (s *FastSeqnoProvider) SequenceForAccount(aid string) (xdr.SequenceNumber, error) {
	...
	*/
	...
	s.mctx.CDebugf("FastSeqnoProvider.SequenceForAccount(%s) -> %d", aid, seqno)
