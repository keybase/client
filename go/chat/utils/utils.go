...
func PresentDecoratedReactionMap(ctx context.Context, g *globals.Context, convID chat1.ConversationID,
	...
	for key, value := range reactions.Reactions {
		...
		if shouldDecorate {
			desc.Decorated = g.EmojiSource.Decorate(ctx, key, convID, msg.Emojis, false)
		}
...
func PresentDecoratedPendingTextBody(ctx context.Context, g *globals.Context, uid gregor1.UID,
	...
	body = g.EmojiSource.Decorate(ctx, body, convID, msg.Emojis, typ == chat1.MessageType_TEXT)
	return &body
}
...
func PresentDecoratedTextBody(ctx context.Context, g *globals.Context, uid gregor1.UID,
	...
	// Emojis
	body = g.EmojiSource.Decorate(ctx, body, convID, msg.Emojis, true)
