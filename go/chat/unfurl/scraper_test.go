...
func TestScraper(t *testing.T) {
	...
	*forceGiphy = chat1.UnfurlType_GIPHY
	...
	testCase("cnn0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "CNN",
		Description: new("Just weeks after visiting the White House, Kanye West appears to be a little tired of politics."),
		PublishTime: new(1540941044),
		ImageUrl:    new("https://cdn.cnn.com/cnnnext/dam/assets/181011162312-11-week-in-photos-1011-super-tease.jpg"),
		FaviconUrl:  new("http://cdn.cnn.com/cnn/.e/img/3.0/global/misc/apple-touch-icon.png"),
	}), true, nil, nil)
	testCase("wsj0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "WSJ",
		Description: new("A surge in technology shares following Facebook’s latest earnings lifted U.S. stocks, helping major indexes trim some of their October declines following a punishing period for global investors."),
		PublishTime: new(1541004540),
		ImageUrl:    new("https://images.wsj.net/im-33925/social"),
		FaviconUrl:  new("https://s.wsj.net/media/wsj_apple-touch-icon-180x180.png"),
	}), true, nil, nil)
	testCase("nytimes0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		Description: new("House Democratic leaders, for the first time, laid out an ambitious opening salvo of bills for a majority, including an overhaul of campaign and ethics laws."),
		PublishTime: new(1540990881),
		ImageUrl:    new("https://static01.nyt.com/images/2018/10/31/us/politics/31dc-dems/31dc-dems-facebookJumbo.jpg"),
		FaviconUrl:  new("http://127.0.0.1/vi-assets/static-assets/apple-touch-icon-319373aaf4524d94d38aa599c56b8655.png"),
	}), true, nil, nil)
	...
	testCase("github0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "GitHub",
		Description: new("Keybase Go Library, Client, Service, OS X, iOS, Android, Electron - keybase/client"),
		ImageUrl:    new("https://avatars1.githubusercontent.com/u/5400834?s=400&v=4"),
		FaviconUrl:  new(fmt.Sprintf("http://%s/apple-touch-icon.png", addr)),
	}), true, nil, nil)
	...
	testCase("youtube0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "YouTube",
		Description: new("https://www.twitch.tv/summoningsalt https://twitter.com/summoningsalt Music List- https://docs.google.com/document/d/1p2qV31ZhtNuP7AAXtRjGNZr2QwMSolzuz2wX6wu..."),
		ImageUrl:    new("https://i.ytimg.com/vi/mmJ_LT8bUj0/hqdefault.jpg"),
		FaviconUrl:  new("https://s.ytimg.com/yts/img/favicon-vfl8qSV2F.ico"),
	}), true, nil, nil)
	testCase("youtube1.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		Title:       "Pumped to Be Here: Brazil's Game Fans",
		Url:         "https://www.youtube.com/watch?v=mmJ_LT8bUj0",
		SiteName:    "YouTube",
		Description: new("Brazil's games, consoles, and markets may seem strange, but there's plenty that's familiar, too. SUPPORT US ON PATREON! https://patreon.com/clothmap Patrons ..."),
		ImageUrl:    new("https://i.ytimg.com/vi/6IIQFBb4exU/maxresdefault.jpg"),
		FaviconUrl:  new("https://s.ytimg.com/yts/img/favicon-vfl8qSV2F.ico"),
	}), true, nil, nil)
	testCase("twitter0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "Twitter",
		Description: new("“Nintendo recommits to “keep the business going” for 3DS https://t.co/wTIJxmGTJH by @KyleOrl”"),
		ImageUrl:    new("https://pbs.twimg.com/profile_images/2215576731/ars-logo_400x400.png"),
		FaviconUrl:  new("https://abs.twimg.com/icons/apple-touch-icon-192x192.png"),
	}), true, nil, nil)
	testCase("pinterest0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "Pinterest",
		Description: new("Dracula dentures, kitten costumes, no-carve pumpkins—find your next killer idea on Pinterest."),
		ImageUrl:    new("https://i.pinimg.com/custom_covers/200x150/424605139807203572_1414340303.jpg"),
		FaviconUrl:  new("https://s.pinimg.com/webapp/style/images/logo_trans_144x144-642179a1.png"),
	}), true, nil, nil)
	testCase("wikipedia0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		Title:       "Merkle tree - Wikipedia",
		SiteName:    "127.0.0.1",
		Description: nil,
		ImageUrl:    new("https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Hash_Tree.svg/1200px-Hash_Tree.svg.png"),
		FaviconUrl:  new("http://127.0.0.1/static/apple-touch/wikipedia.png"),
	}), true, nil, nil)
	testCase("reddit0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		Title:       "r/Stellar",
		Url:         "https://www.reddit.com/r/Stellar/",
		SiteName:    "reddit",
		Description: new("r/Stellar: Stellar is a decentralized protocol that enables you to send money to anyone in the world, for fractions of a penny, instantly, and in any currency.  \n\n/r/Stellar is for news, announcements and discussion related to Stellar.\n\nPlease focus on community-oriented content, such as news and discussions, instead of individual-oriented content, such as questions and help. Follow the [Stellar Community Guidelines](https://www.stellar.org/community-guidelines/) ."),
		ImageUrl:    new("https://b.thumbs.redditmedia.com/D857u25iiE2ORpt8yVx7fCuiMlLVP-b5fwSUjaw4lVU.png"),
		FaviconUrl:  new("https://www.redditstatic.com/desktop2x/img/favicon/apple-icon-180x180.png"),
	}), true, nil, nil)
	testCase("etsy0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "Etsy",
		Description: new("The Beatles Sgt Peppers Lonely Hearts Club Ban  Created using mixed media  Fits a 10 x 8 inch frame aperture - photograph shows item framed in a 12 x 10 inch frame  Choose from: high lustre paper - 210g which produces very vibrant colours; textured watercolour paper - 190g - which looks"),
		ImageUrl:    new("https://i.etsystatic.com/12686588/r/il/c3b4bc/1458062296/il_570xN.1458062296_rary.jpg"),
		FaviconUrl:  new("http://127.0.0.1/images/favicon.ico"),
	}), true, nil, nil)
	testCase("giphy0.html", chat1.NewUnfurlRawWithGiphy(chat1.UnfurlGiphyRaw{
		ImageUrl:   new("https://media.giphy.com/media/5C3Zrs5xUg5fHV4Kcf/giphy-downsized-large.gif"),
		FaviconUrl: new("https://giphy.com/static/img/icons/apple-touch-icon-180px.png"),
	...
	testCase("imgur0.html", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		...
		SiteName:    "Imgur",
		Description: new("2433301 views and 2489 votes on Imgur"),
		ImageUrl:    new("https://i.imgur.com/lXDyzHY.jpg?play"),
		FaviconUrl:  new(fmt.Sprintf("http://%s/favicon.ico", addr)),
		Video: &chat1.UnfurlVideo{
	...
	testCase("nytogimage.jpg", chat1.NewUnfurlRawWithGeneric(chat1.UnfurlGenericRaw{
		SiteName:   "127.0.0.1",
		FaviconUrl: new(fmt.Sprintf("http://%s/favicon.ico", addr)),
		ImageUrl:   new(fmt.Sprintf("http://%s/?name=nytogimage.jpg&content_type=image/jpeg", addr)),
	}), true, new("image/jpeg"), nil)
	srv.shouldServeAppleTouchIcon = true
