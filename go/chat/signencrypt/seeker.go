...
func NewDecodingReadSeeker(ctx context.Context, log, perfLog logger.Logger, source io.ReadSeeker, size int64,
	...
	return &decodingReadSeeker{
		DebugLabeler: utils.NewDebugLabeler(log, perfLog, "DecodingReadSeeker", true),
		source:       source,
		size:         size,
		chunks:       c,
		encKey:       encKey,
