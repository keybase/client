...
// Source: github.com/keybase/client/go/kbfs/libkbfs (interfaces: BlockCache,BlockOps,BlockServer,BlockSplitter,BlockWithPtrs,Chat,Clock,Crypto,DirtyBlockCache,KBFSOps,KBPKI,KeybaseService,KeyCache,KeyManager,MDCache,MDOps,MDServer,Node,NodeCache,NodeID,Notifier,RekeyQueue,Reporter)
...
func (m *MockBlockSplitter) ShouldEmbedBlockChanges(arg0 *BlockChanges) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ShouldEmbedBlockChanges", arg0)
	ret0, _ := ret[0].(bool)
	return ret0
}

// ShouldEmbedBlockChanges indicates an expected call of ShouldEmbedBlockChanges
func (mr *MockBlockSplitterMockRecorder) ShouldEmbedBlockChanges(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ShouldEmbedBlockChanges", reflect.TypeOf((*MockBlockSplitter)(nil).ShouldEmbedBlockChanges), arg0)
}
