...
func TestRevokeSig(t *testing.T) {
	...
	assertNumDevicesAndKeys(t, u, 3, 8)
	...
	assertNumDevicesAndKeys(t, u, 3, 8) // no change
	...
	assertNumDevicesAndKeys(t, u, 3, 7) // The first PGP key is gone.
	...
	assertNumDevicesAndKeys(t, u, 3, 7) // no change
}
