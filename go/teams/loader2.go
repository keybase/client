...
func (l *TeamLoader) verifyLink(ctx context.Context,
	...
	if fullVerify {
		signerUV, err = l.verifyLinkFullHelper(ctx, teamID, state, link, signedByKID, proofSet)
		if err != nil {
			return nil, err
		}
	} else {
...
func (l *TeamLoader) verifyLinkFullHelper(ctx context.Context, teamID keybase1.TeamID, state *keybase1.TeamData,
