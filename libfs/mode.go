...
// IsOnlyWriterInNonTeamTlf returns true if and only if the TLF described by h is a non-team
// TLF, and the currently logged-in user is the only writer for the TLF.  In
// case of any error false is returned.
