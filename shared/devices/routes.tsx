...
import {HeaderTitle, HeaderRightActions} from '@/devices/nav-header'
...
export const newRoutes = defineRouteMap({
  devicePage: C.makeScreen(
    React.lazy(async () => import('@/devices/device-page')),
    {getOptions: {title: ''}}
  ),
  deviceRevoke: C.makeScreen(
    React.lazy(async () => import('@/devices/device-revoke')),
    {
      getOptions: {
...
export const newModalRoutes = defineRouteMap({
  ...provisionNewRoutes,
  deviceAdd: C.makeScreen(React.lazy(async () => import('@/devices/add-device')), {
    getOptions: {
  ...
  devicePaperKey: {
    ...
    screen: React.lazy(async () => import('@/devices/paper-key')),
  },
})
