...
Here’s everything that makes Stellar powerful:`}
          ...
          <Kb.Text type="Body">
            ...
            smart-contracts required. You can literally buy or sell anything on Stellar. Settlement takes just
            a few seconds. That means Stellar functions as both a cross-currency transaction system and a
            global marketplace.
          </Kb.Text>
          <Kb.Box style={styles.video}>
            <Kb.Video url={starman} />
          ...
          <Kb.Text type="Body">
            ...
            different entities. No one organization controls the network, so no one can shut it off,
            monopolize its functionality, or horde its data. Not only that, but the code those computers run
            is open source, and the transactions they process are published on a shared public ledger.
            Everything about Stellar is out in the open.
          </Kb.Text>
        </Kb.Box2>
      </Kb.ScrollView>
    </Kb.MaybePopup>
