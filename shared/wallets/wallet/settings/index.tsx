      ...
      <Kb.ScrollView style={styles.scrollView} contentContainerStyle={{flexGrow: 1}}>
        ...
        >
            ...
            <Kb.Box>
              ...
              {props.mobileOnlyWaiting && (
                <Kb.Box2
                  ...
                  centerChildren={true}
                  style={Styles.collapseStyles([Styles.globalStyles.fillAbsolute, styles.mobileOnlySpinner])}
                >
          ...
          {!!props.showExternalPartners && props.externalPartners.length > 0 && (
            <Kb.Box>
              <Kb.Box2 direction="vertical" style={styles.section} fullWidth={true} gap="tiny" gapEnd={true}>
