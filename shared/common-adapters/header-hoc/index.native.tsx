...
): React.ElementType => <Box style={Styles.collapseStyles([styles.rightActions, hasTextTitle && styles.grow])}>
...
): React.ElementType => rightActions &&
...
const renderAction = (action: Action, index: number): React.ElementType => action.custom ? (
