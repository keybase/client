...
class Reload extends React.PureComponent<ReloadProps, {
  expanded: boolean
}> {
...
const mapStateToProps = (state, ownProps: OwnProps) => {
  ...
  return {
    needsReload: !!error,
    reason: // Auto generated from flowToTs. Please clean me!
    ...
    error === null || error === undefined ? undefined : error.message : '',
  };
}
