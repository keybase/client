...
const OverlayParentHOC = <T extends OverlayParentProps>(ComposedComponent: React.ComponentType<T>): React.ComponentType<Exclude<T, OverlayParentProps>> => {
  class OverlayParent extends React.Component<Exclude<T, OverlayParentProps>, OverlayParentState> {
