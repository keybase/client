...
class Icon extends Component<Props, void> {
  ...
  shouldComponentUpdate function(nextProps: Props, nextState: any): boolean {
...
const imgName = (type: IconType, ext: string, mult: number, prefix: string | null, postfix: string | null) =>
...
export function iconTypeToImgSet(
  imgMap: {
    [K in string]: string;
  },
  targetSize: number
