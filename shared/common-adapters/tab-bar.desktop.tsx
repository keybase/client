...
class SimpleTabBarButton extends React.Component<ItemProps> {
  shouldComponentUpdate function(nextProps: ItemProps, nextState: any): boolean {
...
class TabBarButton extends React.Component<TabBarButtonProps> {
  shouldComponentUpdate function(nextProps: TabBarButtonProps, nextState: any): boolean {
    return !shallowEqual(this.props, nextProps, (obj, oth, key) => {
      if (
        [
          'style',
...
class TabBar extends React.Component<Props> {
  ...
  _labels function(): Array<React.ElementType> {
