...
import {backgroundModeIsNegative} from '@/common-adapters/text.shared'
import type {TextType, Background, StylesTextCrossPlatform, AllowedColors, LineClampType, TextTypeBold} from '@/common-adapters/text.shared'
