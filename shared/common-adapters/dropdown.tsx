...
type DropdownButtonProps = {
  ...
  setAttachmentRef?: OverlayParentProps["setAttachmentRef"],
  toggleOpen: () => void
};
...
type Props<N extends React.ElementType> = {
...
class Dropdown<N extends React.ElementType> extends React.Component<Props<N> & OverlayParentProps, State> {
