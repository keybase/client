...
export function connectedPropsToProps<T>(
  ...
  return {
    ...props,
    onUsernameClicked: onUsernameClickedNew ? (onUsernameClickedNew as (username: string) => void) : undefined,
    users: userData,
  } as Props;
}
...
const userDataFromState = (stateProps, usernames) =>
  usernames.map(username => ({
    broken: // Auto generated from flowToTs. Please clean me!
    UsersConstants.getIsBroken(stateProps._userInfo, username) !== null && UsersConstants.getIsBroken(stateProps._userInfo, username) !== undefined ? UsersConstants.getIsBroken(stateProps._userInfo, username) : false,
