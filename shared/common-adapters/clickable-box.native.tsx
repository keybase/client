      ...
      if (feedback) {
        return (
          <TouchableOpacity
            ...
            activeOpacity={// Auto generated from flowToTs. Please clean me!
            this.props.activeOpacity !== null && this.props.activeOpacity !== undefined ? this.props.activeOpacity : 0.7}
          >
            {props.children}
          </TouchableOpacity>
        );
