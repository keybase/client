...
class List extends PureComponent<Props<any>, void> {
  ...
  _itemRender = index => {
    ...
    if (__DEV__ && !!this.props.itemSizeEstimator) {
      ...
      (renderedItem === null || renderedItem === undefined ? undefined : renderedItem.props) === null || (renderedItem === null || renderedItem === undefined ? undefined : renderedItem.props) === undefined ? undefined : (renderedItem === null || renderedItem === undefined ? undefined : renderedItem.props).style) {
        // $FlowIssue - Not every rendered item has props
