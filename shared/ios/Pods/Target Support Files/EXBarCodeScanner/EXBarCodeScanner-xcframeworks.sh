...
install_xcframework "${PODS_ROOT}/../../node_modules/expo-barcode-scanner/ios/EXBarCodeScanner.xcframework" "EXBarCodeScanner" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
