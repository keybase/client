...
const JoinTeam = (props: Props) => (
  <Kb.Modal
    ...
    header={{
      leftButton: Styles.isMobile && !props.success ? (
        ...
        {props.success ? (
          <Kb.Box2 alignItems="center" direction="horizontal" fullHeight={true} fullWidth={true}>
            <Kb.Box2 direction="vertical" style={styles.container}>
              <Kb.Icon style={styles.icon} type={Styles.isMobile ? 'icon-fancy-email-sent-192-x-64' : 'icon-fancy-email-sent-144-x-48'} />
              <Kb.Text center={true} type="Body">
                We sent a request to{' '}
                {props.successTeamName ? <Kb.Text type="BodySemibold">{props.successTeamName}</Kb.Text> : 'the team'}
