    ...
    <Kb.Box style={styles.container}>
      ...
      <Kb.Box style={styles.teamHeader}>
        ...
        <NameWithIconWrapper
          ...
          metaTwo={getTeamSubtitle(teamHumanCount, props.role)}
        />
...
const getTeamSubtitle = (teamHumanCount: number, role: Types.MaybeTeamRoleType): string => {
  if (teamHumanCount === -1) {
    return Constants.typeToLabel[role]
  }
  let res = `${teamHumanCount} ${pluralize('member', teamHumanCount)}`
  if (role && role !== 'none') {
