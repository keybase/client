...
const UploadIcon = (props: Props) => {
  switch (props.uploadIcon) {
    case Types.UploadIcon.AwaitingToUpload:
      return (
        <Icon
          type={Kb.Icon.makeFastType(Kb.IconType.icon_addon_file_uploading_offline)}
          style={props.style}
        />
      )
    case Types.UploadIcon.Uploading:
      return <Icon type={Kb.Icon.makeFastType(Kb.IconType.icon_addon_file_uploading)} style={props.style} />
    case Types.UploadIcon.UploadingStuck:
      return (
        <Icon type={Kb.Icon.makeFastType(Kb.IconType.icon_addon_file_uploading_error)} style={props.style} />
      )
  }
}
