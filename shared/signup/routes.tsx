export const newRoutes = {
  ...
  signupSendFeedbackLoggedOut: {getScreen: () => require('./feedback/container').default, upgraded: true},
}
...
export const newModalRoutes = {
  ...
  signupSendFeedbackLoggedIn: {getScreen: () => require('./feedback/container').default, upgraded: true},
