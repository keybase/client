...
const InviteBanner = (props: InviteVariant) => {
  return (
    <CommonHeader windowDragging={false} style={{...globalStyles.flexBoxColumn, backgroundColor: globalColors.blue}} type='Strong'>
      <Text type='Header' backgroundMode='Announcements' style={{flex: 1, ...globalStyles.flexBoxCenter, paddingTop: 6, cursor: 'default'}}>Your messages will unlock when they join Keybase. You can give them this invite link:</Text>
