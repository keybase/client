...
const Header = ({participants, onOpenFolder, onToggleSidePanel, sidePanelOpen, you, metaDataMap, followingMap}: Props) => (
  <Box style={containerStyle}>
    <Usernames colorFollowing={true} inline={false} type='BodyBig' users={usernamesToUserListItem(participantFilter(participants, you).toArray(), you, metaDataMap, followingMap)}
