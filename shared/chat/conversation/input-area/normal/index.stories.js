...
const InputContainer = (props: Props) => {
  const inputProps: InputProps = {
    ...
    suggestTeams: [{fullName: '', teamname: 'keybase', username: ''}, {fullName: '', teamname: 'got', username: ''}],
    suggestUsers: List([
    ...
    suggestAllChannels: List([
      {teamname: 'keybase', channelname: 'general'},
      {teamname: 'keybase', channelname: 'spooner'},
      {teamname: 'got', channelname: 'general'},
      {teamname: 'got', channelname: 'live'},
    ]),
