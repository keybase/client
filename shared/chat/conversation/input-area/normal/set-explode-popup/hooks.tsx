...
import {useConversationThreadExplodingMode, useConversationThreadMeta} from '../../../thread-context'
...
export default (p: Props) => {
  ...
  const _meta = useConversationThreadMeta()
  const selected = useConversationThreadExplodingMode()
