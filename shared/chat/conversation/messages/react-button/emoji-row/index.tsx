...
import {renderEmoji, RPCUserReacjiToEmojiDataForRender} from '../../../../../util/emoji'
...
> {
  ...
  render() {
    return (
      ...
      >
        {renderEmoji(RPCUserReacjiToEmojiDataForRender(this.props.emoji), this.state.hovering ? 22 : 18)}
      </Kb.ClickableBox>
    )
  }
}
