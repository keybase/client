...
class _WrapperMessage extends React.Component<Props & Kb.OverlayParentProps, State> {
  ...
  _orangeLine = () =>
    this.props.orangeLineAbove && <Kb.Box2 key="orangeLine" direction="vertical" style={Styles.collapseStyles([styles.orangeLine, !this._isExploding() && styles.orangeLineCompensation])} />
...
const styles = Styles.styleSheetCreate(
  () =>
    ({
      ...
      orangeLineCompensation: Styles.platformStyles({
        isMobile: {
