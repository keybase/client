...
const _Contents = ({conversationIDKey, onBack, participants, onBlock, onBlockAndReport}: Props) => (
  <Box style={{...globalStyles.flexBoxColumn, alignItems: 'center', flex: 1, justifyContent: 'flex-start', width: '100%', paddingTop: 5}}>
...
const RenderBlockConversationWarning = (props: Props) => (
  <PopupDialog onClose={props.onBack} styleCover={{paddingLeft: 0, paddingRight: 0, paddingTop: 0, paddingBottom: 0}} styleContainer={{borderRadius: 0}}>
    <Contents {...props} />
  </PopupDialog>
)
