...
function SimpleTopLine(props: SimpleTopLineProps) {
  const {hasUnread, participants, showBold, subColor, timestamp, usernameColor} = props
...
function FilteredTopLine(props: FilteredTopLineProps) {
