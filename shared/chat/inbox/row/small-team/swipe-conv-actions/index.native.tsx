  ...
  return (
    <Kb.NativeView style={styles.container}>
      {renderRightAction(
        ...
        <Kb.Icon type={Kb.Icon.makeFastType(Kb.IconType.iconfont_shh)} color={Styles.globalColors.white} />,
        128,
      ...
      {renderRightAction(
        ...
        <Kb.Icon type={Kb.Icon.makeFastType(Kb.IconType.iconfont_hide)} color={Styles.globalColors.white} />,
        64,
