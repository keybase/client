...
const Avatars = ({participants, youNeedToRekey, participantNeedToRekey, isMuted, hasUnread, isSelected, backgroundColor}) => {
  ...
  return (
    <Box style={{...globalStyles.flexBoxRow, alignItems: 'flex-end', flex: 1, justifyContent: 'flex-start', minWidth: 55, maxWidth: 55, paddingLeft: 4, backgroundColor}}>
      <MultiAvatar singleSize={40} multiSize={32} avatarProps={avatarProps} style={{backgroundColor, alignSelf: 'center'}} />
      {icon}
    </Box>
  )
}
