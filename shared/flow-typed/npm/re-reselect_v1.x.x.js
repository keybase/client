...
declare module 're-reselect' {
  declare type Selector<-TState, TProps, TResult> = (state: TState, props: TProps, ...rest: any[]) => TResult

  declare type SelectorCreator<TState, TProps, TResult> = (
    (state: TState, props: TProps) => string | number
  ...
  declare type CreateCachedSelector = {
    ...
    <TState, TProps, TResult, T1, T2, T3>(
      selectors: [Selector<TState, TProps, T1>, Selector<TState, TProps, T2>, Selector<TState, TProps, T3>],
      resultFunc: (arg1: T1, arg2: T2, arg3: T3) => TResult
    ): SelectorCreator<TState, TProps, TResult>,
    ...
    <TState, TProps, TResult, T1, T2, T3, T4, T5, T6, T7, T8>(
      ...
      resultFunc: (arg1: T1, arg2: T2, arg3: T3, arg4: T4, arg5: T5, arg6: T6, arg7: T7, arg8: T8) => TResult
    ): SelectorCreator<TState, TProps, TResult>,
    <TState, TProps, TResult, T1, T2, T3, T4, T5, T6, T7, T8>(
      selectors: [
        Selector<TState, TProps, T1>,
