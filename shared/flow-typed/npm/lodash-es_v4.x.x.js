...
declare module 'lodash-es' {
  ...
  declare export function difference<T>(
  ...
  declare export function findIndex<T>(array: void | null, predicate?: ?Predicate<T>, fromIndex?: ?number): -1
  ...
  declare export function pullAllWith<T: void | null>(
    array: T,
    values?: ?Array<any>,
    comparator?: ?Function
  ): T
  ...
  declare export function unionBy<T>(a1?: ?Array<T>, a2: Array<T>, iteratee?: ValueOnlyIteratee<T>): Array<T>
  ...
  declare export function unionWith<T>(a1: Array<T>, a2: Array<T>, comparator?: Comparator<T>): Array<T>
  ...
  declare export function xorBy<T>(a1: Array<T>, a2: Array<T>, iteratee?: ValueOnlyIteratee<T>): Array<T>
  ...
  declare export function xorWith<T>(a1: Array<T>, a2: Array<T>, comparator?: Comparator<T>): Array<T>
  ...
  declare export function zipWith<T, A, B>(a1: Array<A>, a2: Array<B>, iteratee: (A, B) => T): Array<T>

  declare export function zipWith<A, B, C>(a1: Array<A>, a2: Array<B>, a3: Array<C>): Array<[A, B, C]>
  ...
  declare export function filter<A, T: {[id: string]: A}>(object: T, predicate?: OPredicate<A, T>): Array<A>
  declare export function find<T>(
    array: $ReadOnlyArray<T>,
    predicate?: ?Predicate<T>,
    fromIndex?: ?number
  ): T | void
  declare export function find<T>(array: void | null, predicate?: ?Predicate<T>, fromIndex?: ?number): void
  ...
  declare export function findLast<V, A, T: {[id: string]: A}>(object: T, predicate?: ?OPredicate<A, T>): V
  declare export function flatMap<T, U>(
    array?: ?$ReadOnlyArray<T>,
    iteratee?: ?FlatMapIteratee<T, U>
  ): Array<U>
  declare export function flatMap<T: Object, U>(object: T, iteratee?: OFlatMapIteratee<T, U>): Array<U>
  declare export function flatMapDeep<T, U>(
    array?: ?$ReadOnlyArray<T>,
    iteratee?: ?FlatMapIteratee<T, U>
  ): Array<U>
  declare export function flatMapDeep<T: Object, U>(object: T, iteratee?: ?OFlatMapIteratee<T, U>): Array<U>
  ...
  declare export function groupBy(array: void | null, iteratee?: ?ValueOnlyIteratee<any>): {}
  ...
  declare export function keyBy(array: void | null, iteratee?: ?ValueOnlyIteratee<*>): {}
  ...
  declare export function map<T, U>(array: ?$ReadOnlyArray<T>, iteratee?: ReadOnlyMapIterator<T, U>): Array<U>
  declare export function map<V, T: Object, U>(object: ?T, iteratee?: OMapIterator<V, T, U>): Array<U>
  ...
  declare export function partition<T>(array?: ?Array<T>, predicate?: ?Predicate<T>): [Array<T>, Array<T>]
  ...
  declare export function some<A, T: {[id: string]: A}>(object?: ?T, predicate?: OPredicate<A, T>): boolean
  ...
  declare export function sortBy<V, T: Object>(object: T, iteratees?: $ReadOnlyArray<OIteratee<T>>): Array<V>
  ...
  declare export function throttle(func: Function, wait?: number, options?: ThrottleOptions): Function
  ...
  declare export function invoke(object?: ?Object, path?: ?Array<string> | string, ...args?: Array<any>): any
  ...
  declare export function omit(object?: ?Object, props: Array<string>): Object
  declare export function omitBy<A, T: {[id: string]: A}>(object: T, predicate?: ?OPredicate<A, T>): Object
  declare export function omitBy<A, T>(object: void | null, predicate?: ?OPredicate<A, T>): {}
  declare export function pick(object?: ?Object, ...props: Array<string>): Object
  declare export function pick(object?: ?Object, props: Array<string>): Object
  declare export function pickBy<A, T: {[id: string]: A}>(object: T, predicate?: ?OPredicate<A, T>): Object
  declare export function pickBy<A, T>(object: void | null, predicate?: ?OPredicate<A, T>): {}
  declare export function result(object?: ?Object, path?: ?Array<string> | string, defaultValue?: any): any
  declare export function set(object: Object, path?: ?Array<string> | string, value: any): Object
  declare export function set<T: void | null>(object: T, path?: ?Array<string> | string, value?: ?any): T
  ...
  declare export function transform(collection: void | null, iteratee?: ?OIteratee<*>, accumulator?: ?any): {}
  ...
  declare export function defaultTo<T1: string | boolean | Object, T2>(value: T1, defaultValue: T2): T1
