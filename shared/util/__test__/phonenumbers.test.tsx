...
describe('validateNumber', () => {
  it('valid US number format but invalid area code', () => {
    expect(validateNumber('+15552802005', null)).toEqual({e164: '+15552802005', valid: false})
    expect(validateNumber('+15552802005', 'US')).toEqual({e164: '+15552802005', valid: false})
  })
  ...
  it('valid US number', () => {
    ...
    expect(validateNumber('201 555 1113', 'US')).toEqual({e164: '+12015551113', valid: true})
    expect(validateNumber('+1 201 555 1113', 'US')).toEqual({e164: '+12015551113', valid: true})
  })
  ...
  it('valid PL number', () => {
    ...
    expect(validateNumber('784 123 123', 'PL')).toEqual({e164: '+48784123123', valid: true})
  })
