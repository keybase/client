...
export opaque type SharedTimerID: number = number

// Global ID for refs to timers
let id: SharedTimerID = 0

// Outside reference to a timer
type Ref = {
  fn: () => void,
  id: SharedTimerID,
}

// Map of keys to outside references that should be triggered
type RefMap = {
  [key: string]: Array<Ref>,
}

// Package TimeoutIDs and keys together
type Timer = {
  key: string,
  timeoutID: TimeoutID,
}
