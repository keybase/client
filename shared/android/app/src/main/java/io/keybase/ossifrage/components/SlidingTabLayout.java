 ...
 * alternative is via the {@link SlidingTabStrip.TabColorizer} interface which provides you complete
 * control over which color is used for any individual position.
 *
