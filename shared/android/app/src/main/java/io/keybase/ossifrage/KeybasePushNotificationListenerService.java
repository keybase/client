...
public class KeybasePushNotificationListenerService extends FirebaseMessagingService {
    ...
    private HashMap<String, SmallMsgRingBuffer> msgCache =
            new HashMap<String, SmallMsgRingBuffer>();
    ...
    public void onCreate() {
        try {
            Keybase.setGlobalExternalKeyStore(
                    new KeyStore(
                            ...
                            getSharedPreferences("KeyStore", MODE_PRIVATE)));
        } catch (KeyStoreException
                | CertificateException
                | IOException
                | NoSuchAlgorithmException e) {
            NativeLogger.error(
                    "Exception in KeybasePushNotificationListenerService.onCreate while trying to link the Android KeyStore to go bind",
                    e);
        }
        ...
        initOnce(
                ...
                "",
                getApplicationContext().getFileStreamPath("service.log").getAbsolutePath(),
                "prod",
                false,
                new DNSNSFetcher(),
                new VideoHelper(),
                mobileOsVersion);
        NativeLogger.info(
                "KeybasePushNotificationListenerService created. path: "
                        + getApplicationContext().getFilesDir().getPath());
    ...
    public static void createNotificationChannel(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // Chat Notifications
            {
                ...
                NotificationChannel chat_channel =
                        new NotificationChannel(CHAT_CHANNEL_ID, name, importance);
            ...
            // Follow Notifications
            {
                ...
                NotificationChannel follow_channel =
                        new NotificationChannel(FOLLOW_CHANNEL_ID, follow_name, follow_importance);
            ...
            // Device Notifications
            {
                ...
                NotificationChannel device_channel =
                        new NotificationChannel(DEVICE_CHANNEL_ID, device_name, device_importance);
            ...
            // The rest of the notifications
            {
                ...
                String general_description =
                        context.getString(R.string.general_channel_description);
                int general_importance = NotificationManager.IMPORTANCE_LOW;
                NotificationChannel general_channel =
                        new NotificationChannel(
                                GENERAL_CHANNEL_ID, general_name, general_importance);
    ...
    public void onMessageReceived(RemoteMessage message) {
        ...
        try {
            ...
            switch (type) {
                case "chat.newmessageSilent_2":
                    {
                        ...
                        Keybase.handleBackgroundNotification(
                                convID,
                                payload,
                                membersType,
                                displayPlaintext,
                ...
                case "follow":
                    {
                        notifier.followNotification(
                                bundle.getString("username"), bundle.getString("message"));
                    }
                    break;
                case "device.revoked":
                case "device.new":
