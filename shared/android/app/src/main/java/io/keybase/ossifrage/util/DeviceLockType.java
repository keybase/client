...
public class DeviceLockType {
    ...
    /**
     * Android using "Face Unlock" with "Pattern" as additional unlock method. Android don't allow
     * you to select "Face Unlock" without additional unlock method.
     */
    public static final int FACE_WITH_PATTERN = 3;

    /**
     * Android using "Face Unlock" with "PIN" as additional unlock method. Android don't allow you
     * to select "Face Unlock" without additional unlock method.
     */
    public static final int FACE_WITH_PIN = 4;

    /**
     * Android using "Face Unlock" with some additional unlock method not described here. Possible
     * new methods would be added in the future releases. Values from 5 to 8 reserved for this
     * situation.
     */
