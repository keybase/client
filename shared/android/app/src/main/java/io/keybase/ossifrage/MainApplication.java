                    ...
                    ImagePipelineConfig frescoConfig =
                            ImagePipelineConfig.newBuilder(context)
                                    .setBitmapMemoryCacheParamsSupplier(
                                            new CustomBitmapMemoryCacheParamsSupplier(context))
                                    .build();

                    MainPackageConfig appConfig =
                            new MainPackageConfig.Builder().setFrescoConfig(frescoConfig).build();
                            ...
                            new KBReactPackage() {
                                ...
                                public List<NativeModule> createNativeModules(
                                    ...
                                    if (BuildConfig.BUILD_TYPE == "storyBook") {
                                        ...
                                        modules.add(
                                                new StorybookConstants(reactApplicationContext));
                                        return modules;
                                    } else {
