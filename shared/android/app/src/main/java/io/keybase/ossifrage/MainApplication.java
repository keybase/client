  ...
  private final ReactNativeHost mReactNativeHost =
      new ReactNativeHost(this) {
        ...
        protected List<ReactPackage> getPackages() {
          ...
          //                    .newBuilder(context)
          //                    .setBitmapMemoryCacheParamsSupplier(new
          // CustomBitmapMemoryCacheParamsSupplier(context))
          //                    .build();
          //
          //            MainPackageConfig appConfig = new
          // MainPackageConfig.Builder().setFrescoConfig(frescoConfig).build();

          @SuppressWarnings("UnnecessaryLocalVariable")
          List<ReactPackage> packages = new PackageList(this).getPackages();
          // new MainReactPackage(appConfig),// removed from rn-diff but maybe we need it for fresco
          // config?
          packages.add(
              new KBReactPackage() {
                @Override
