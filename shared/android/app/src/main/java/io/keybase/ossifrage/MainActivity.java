    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            Keybase.setGlobalExternalKeyStore(
                    new KeyStore(this, getSharedPreferences("KeyStore", MODE_PRIVATE)));
        ...
        initOnce(
                ...
                "",
                this.getFileStreamPath("service.log").getAbsolutePath(),
                "prod",
                false,
                new DNSNSFetcher(),
                new VideoHelper(),
            ...
            public void run() {
                ...
                if (bundleFromNotification != null) {
                    emitter.emit(
                            ...
                            Arguments.fromBundle(bundleFromNotification));
                }
