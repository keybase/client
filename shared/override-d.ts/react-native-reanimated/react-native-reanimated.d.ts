...
declare module 'react-native-reanimated' {
  ...
  import {GestureHandlerGestureEvent, PanGestureHandlerGestureEvent} from 'react-native-gesture-handler'

  export const Animation: any
  export const TimingAnimation: any
  export const SpringAnimation: any
  export const DecayAnimation: any
  export const DelayAnimation: any
  ...
  namespace Animated {
    ...
    type BinaryOperator<T = number> = (left: Adaptable<number>, right: Adaptable<number>) => AnimatedNode<T>
    ...
    export type TransformStyleTypes = TransformsStyle['transform'] extends readonly (infer T)[] | undefined
      ? T
      : never
    ...
    export type AnimateProps<P extends object> = {
      [K in keyof P]: K extends 'style' ? StyleProp<AnimateStyle<P[K]>> : P[K] | AnimatedNode<P[K]>
    } & {
    ...
    // classes
    export {AnimatedClock as Clock, AnimatedNode as Node, AnimatedValue as Value}
    ...
    export function concat(...args: Array<Adaptable<string> | Adaptable<number>>): AnimatedNode<string>
    ...
    export function debug<T>(message: string, value: AnimatedNode<T>): AnimatedNode<T>
    export function onChange(value: Adaptable<number>, action: Adaptable<number>): AnimatedNode<number>
    ...
    // animations
    export function decay(clock: AnimatedClock, state: DecayState, config: DecayConfig): AnimatedNode<number>
    ...
    export function spring(node: AnimatedNode<number>, config: SpringConfig): BackwardCompatibleWrapper
    export function timing(node: AnimatedNode<number>, config: TimingConfig): BackwardCompatibleWrapper
    export function decay(node: AnimatedNode<number>, config: DecayConfig): BackwardCompatibleWrapper
    ...
    export function useValue<T extends Value>(initialValue: T): AnimatedValue<T>
  ...
  export function withDecay(userConfig: WithDecayConfig, callback?: AnimationCallback): number
  ...
  export function runOnJS<A extends any[], R>(fn: (...args: A) => R): (...args: Parameters<typeof fn>) => void
  ...
  export function useDerivedValue<T>(processor: () => T, deps?: DependencyList): DerivedValue<T>
  ...
  export function useAnimatedStyle<T extends AnimatedStyleProp<ViewStyle | ImageStyle | TextStyle>>(
    updater: () => T,
  ...
  >(handlers: GestureHandlers<T['nativeEvent'], TContext>, deps?: DependencyList): OnGestureEvent<T>
  ...
  export function scrollTo(
    ref: RefObject<ReactNativeScrollView | any /*ScrollView*/>,
    x: number,
    y: number,
    animated: boolean
  ): void
  ...
  export class ComplexAnimationBuilder extends BaseAnimationBuilder {
    ...
    static withCallback(callback: (finished: boolean) => void): ComplexAnimationBuilder

    withCallback(callback: (finished: boolean) => void): ComplexAnimationBuilder
    ...
    static overshootClamping(overshootClampingFactor: number): ComplexAnimationBuilder

    overshootClamping(overshootClampingFactor: number): ComplexAnimationBuilder

    static restDisplacementThreshold(restDisplacementThresholdFactor: number): ComplexAnimationBuilder

    restDisplacementThreshold(restDisplacementThresholdFactor: number): ComplexAnimationBuilder

    static restSpeedThreshold(restSpeedThresholdFactor: number): ComplexAnimationBuilder

    restSpeedThreshold(restSpeedThresholdFactor: number): ComplexAnimationBuilder
  }
  ...
  interface EasingNodeStatic {
    ...
    bezier(x1: number, y1: number, x2: number, y2: number): Animated.EasingNodeFunction
  ...
  interface EasingStatic {
    ...
    bezier(x1: number, y1: number, x2: number, y2: number): Animated.EasingFunction
  ...
  export const ReverseAnimation: any // typeof Animated.ReverseAnimation
