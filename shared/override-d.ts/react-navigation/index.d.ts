...
declare module 'react-navigation' {
  ...
  export type NavigationStateRoute<NavigationLeafRouteParams> = NavigationLeafRoute<
  ...
  export interface NavigationStackScreenOptions {
    ...
    headerTitle?:
      ...
      | ((p: {children: React.ReactNode}) => React.ReactElement<any>)
  ...
  interface NavigationTabScreenOptionsBase {
    title?: string
    tabBarIcon?: React.ReactElement<any> | ((options: TabBarIconProps) => React.ReactElement<any> | null)
    tabBarLabel?:
      | string
      | React.ReactElement<any>
  ...
  export interface NavigationDrawerScreenOptions {
    title?: string
    drawerIcon?: React.ReactElement<any> | ((options: DrawerIconProps) => React.ReactElement<any> | null)
    drawerLabel?:
      | string
      | React.ReactElement<any>
  ...
  export interface NavigationScreenProp<S, P = NavigationParams> {
    getChildNavigation: (childKey: string) => NavigationScreenProp<NavigationRoute<P>, P>
    state: S & {params?: P}
    dispatch: NavigationDispatch
  ...
  export function getNavigation(...a: Array<any>): any // TODO better types

  export type NavigationViewProps<O> = {
    descriptors: {[key: string]: NavigationDescriptor}
    navigationConfig: O
    screenProps?: ScreenProps
  } & NavigationInjectedProps
