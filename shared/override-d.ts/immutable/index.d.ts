// eslint-disable
// Lifted from immutable def with extensions
/**
...
export interface List<T> extends Collection.Indexed<T> {
   ...
   * ```
   */
  zipWith<U, Z>(zipper: (value: T, otherValue: U) => Z, otherCollection: Collection<any, U>): List<Z>
  zipWith<U, V, Z>(
...
export interface Map<K, V> extends Collection.Keyed<K, V> {
   ...
   */
  flatMap<KM, VM>(mapper: (value: V, key: K, iter: this) => Iterable<[KM, VM]>, context?: any): Map<KM, VM>
...
export interface Set<T> extends Collection.Set<T> {
   ...
   * not filtering out any values.
   */
  filter<F extends T>(predicate: (value: T, key: T, iter: this) => value is F, context?: any): Set<F>
...
export interface OrderedSet<T> extends Set<T> {
   ...
   * not filtering out any values.
   */
  filter<F extends T>(predicate: (value: T, key: T, iter: this) => value is F, context?: any): OrderedSet<F>
  filter(predicate: (value: T, key: T, iter: this) => any, context?: any): this
...
export interface Stack<T> extends Collection.Indexed<T> {
   ...
   * ```
   */
  zipWith<U, Z>(zipper: (value: T, otherValue: U) => Z, otherCollection: Collection<any, U>): Stack<Z>
  zipWith<U, V, Z>(
    zipper: (value: T, otherValue: U, thirdValue: V) => Z,
    otherCollection: Collection<any, U>,
    thirdCollection: Collection<any, V>
  ): Stack<Z>
  zipWith<Z>(zipper: (...any: Array<any>) => Z, ...collections: Array<Collection<any, any>>): Stack<Z>
}
...
function genHelper(count) {
  arr = new Array(count).fill(0)
  arr = arr.map((_, i) => i + 1)
  propAccess = arr.map(i => `[K${i}]`)
  key_generics = arr.map((i, ind) => `K${i} extends keyof TProps${propAccess.slice(0, ind).join('')}`).join(", ")
  generics = key_generics + `, V extends TProps${propAccess.join('')}`
  args = `[${arr.map(i => "K" + i).join(',')}]`

  const tmpl = (generics, args, partial) => `mergeIn<${generics}>(keyPath: ${args}, ...collections: Array<Partial<V>>): this;`
  return tmpl(generics, args, `TProps${propAccess.join('')}`)
}
*/
  ...
  mergeIn<
    ...
    K6 extends keyof TProps[K1][K2][K3][K4][K5],
    K7 extends keyof TProps[K1][K2][K3][K4][K5][K6],
    K8 extends keyof TProps[K1][K2][K3][K4][K5][K6][K7],
  ...
  // mergeIn<K1 extends keyof TProps, K2 extends keyof TProps[K1], K3 extends keyof TProps[K1][K2], K4 extends keyof TProps[K1][K2][K3]>(keyPath: [K1,K2,K3,K4], ...collections: Array<Partial<TProps[K1][K2][K3][K4]>>): this;
  // mergeIn<K1 extends keyof TProps, K2 extends keyof TProps[K1], K3 extends keyof TProps[K1][K2], K4 extends keyof TProps[K1][K2][K3], K5 extends keyof TProps[K1][K2][K3][K4]>(keyPath: [K1,K2,K3,K4,K5], ...collections: Array<Partial<TProps[K1][K2][K3][K4][K5]>>): this;
  // mergeIn<K1 extends keyof TProps, K2 extends keyof TProps[K1], K3 extends keyof TProps[K1][K2], K4 extends keyof TProps[K1][K2][K3], K5 extends keyof TProps[K1][K2][K3][K4], K6 extends keyof TProps[K1][K2][K3][K4][K5]>(keyPath: [K1,K2,K3,K4,K5,K6], ...collections: Array<Partial<TProps[K1][K2][K3][K4][K5][K6]>>): this;
  // mergeIn<K1 extends keyof TProps, K2 extends keyof TProps[K1], K3 extends keyof TProps[K1][K2], K4 extends keyof TProps[K1][K2][K3], K5 extends keyof TProps[K1][K2][K3][K4], K6 extends keyof TProps[K1][K2][K3][K4][K5], K7 extends keyof TProps[K1][K2][K3][K4][K5][K6]>(keyPath: [K1,K2,K3,K4,K5,K6,K7], ...collections: Array<Partial<TProps[K1][K2][K3][K4][K5][K6][K7]>>): this;
...
export module Seq {
  ...
  export interface Indexed<T> extends Seq<number, T>, Collection.Indexed<T> {
     ...
     * ```
     */
    zipWith<U, Z>(zipper: (value: T, otherValue: U) => Z, otherCollection: Collection<any, U>): Seq.Indexed<Z>
    zipWith<U, V, Z>(
      zipper: (value: T, otherValue: U, thirdValue: V) => Z,
      otherCollection: Collection<any, U>,
      thirdCollection: Collection<any, V>
    ): Seq.Indexed<Z>
    zipWith<Z>(zipper: (...any: Array<any>) => Z, ...collections: Array<Collection<any, any>>): Seq.Indexed<Z>
  }
  ...
  export interface Set<T> extends Seq<T, T>, Collection.Set<T> {
     ...
     * not filtering out any values.
     */
    filter<F extends T>(predicate: (value: T, key: T, iter: this) => value is F, context?: any): Seq.Set<F>
    filter(predicate: (value: T, key: T, iter: this) => any, context?: any): this
  }
}
...
export module Collection {
  ...
  export interface Set<T> extends Collection<T, T> {
     ...
     * Similar to `collection.map(...).flatten(true)`.
     */
    flatMap<M>(mapper: (value: T, key: T, iter: this) => Iterable<M>, context?: any): Collection.Set<M>
