  ...
  render2 () {
    ...
    return (
      <div>
        ...
        <div style={{...styles2.container, textAlign: 'center', padding: 5, paddingLeft: 30, paddingRight: 30}}>
        ...
        <div style={{...styles2.container, alignItems: 'flex-end', paddingRight: 30, paddingBottom: 30}}>
