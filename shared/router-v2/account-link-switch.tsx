...
// a real notification tap held by react-native-kb reaches it, so no link another app opens can
// switch accounts.
//
// Both drops below go through dispatch.acknowledge, which also acks the tap natively -- there is
// no navigation coming for it, so this is where it is given up on for good.
