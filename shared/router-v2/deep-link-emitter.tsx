...
// Only for a tap react-native-kb held for a notification this app posted (see
// constants/init/shared's listenForPushTaps), so a targetUid here can only have come from a real
// notification tap, and no link another app opens can switch accounts.
//
// id is native's tap id: carried on the intent so whoever consumes it (or drops it for good) acks
// it there, since here the tap isn't acted on yet.
