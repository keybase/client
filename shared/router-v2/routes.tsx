...
import {newRoutes as signupNewRoutes, loggedInRoutes as signupLoggedInRoutes} from '../signup/routes'
...
const _newRoutes = [
  ...
  {route: {...peopleNewRoutes, ...signupLoggedInRoutes}, tab: Tabs.peopleTab},
