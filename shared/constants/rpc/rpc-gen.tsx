...
export type MessageTypes = {
  ...
  'keybase.1.appState.ackPushTapRoute': {
    inParam: {readonly id: number},
    outParam: void,
  },
  'keybase.1.appState.peekPushTapRoute': {
    inParam: undefined,
    outParam: PushTapRoute | null,
  },
  ...
  'keybase.1.git.getTeamRepoSettings': {
    inParam: {readonly folder: FolderHandle,readonly repoID: RepoID},
    outParam: GitTeamRepoSettings,
  },
...
export type PushTapRoute = {readonly url: string,readonly targetUID: string,readonly id: number,}
...
export const appStateAckPushTapRouteRpcPromise = createRpc('keybase.1.appState.ackPushTapRoute')
export const appStatePeekPushTapRouteRpcPromise = createRpc('keybase.1.appState.peekPushTapRoute')
...
export const gitGetTeamRepoSettingsRpcPromise = createRpc('keybase.1.git.getTeamRepoSettings')
