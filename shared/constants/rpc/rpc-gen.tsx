...
export type MessageTypes = {
  ...
  'keybase.1.appState.takePushTapRoute': {
    inParam: undefined,
...
export type PushTapRoute = {readonly url: string,readonly targetUID: string,}
...
export const appStateTakePushTapRouteRpcPromise = createRpc('keybase.1.appState.takePushTapRoute')
