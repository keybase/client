...
import * as RPCTypes from './types/rpc-stellar-types'
...
import {getPath, RouteStateNode} from '../route-tree'

export const balanceDeltaToString: {
  [K in RPCTypes.BalanceDelta]: keyof typeof RPCTypes.localBalanceDelta
} = invert(RPCTypes.localBalanceDelta)
export const statusSimplifiedToString: {
  [K in RPCTypes.PaymentStatus]: keyof typeof RPCTypes.localPaymentStatus
} = invert(RPCTypes.localPaymentStatus)
const partyTypeToString: {
  [K in RPCTypes.ParticipantType]: keyof typeof RPCTypes.localParticipantType
...
export const makeBuilding: I.Record.Factory<Types._Building> = I.Record({
  ...
  recipientType: 'keybaseUser' as Types.CounterpartyType,
...
export const makePaymentResult: I.Record.Factory<Types._PaymentResult> = I.Record(
  _defaultPaymentResult as Types._PaymentResult
)

export const makePaymentDetail: I.Record.Factory<Types._PaymentDetail> = I.Record(
  _defaultPaymentDetail as Types._PaymentDetail
)

export const makePayment: I.Record.Factory<Types._Payment> = I.Record(_defaultPayment as Types._Payment)
...
export const isLookingAtWallet = (routeState: RouteStateNode | null) => {
