...
export const todoTypeToIcon: {[K in Types.TodoType]: IconType} = {
  addEmail: Kb.IconType.icon_onboarding_email_add_48,
  addPhoneNumber: Kb.IconType.icon_onboarding_number_new_48,
  annoncementPlaceholder: Kb.IconType.iconfont_close,
  avatarTeam: Kb.IconType.icon_onboarding_team_avatar_48,
  ...
  legacyEmailVisibility: Kb.IconType.icon_onboarding_email_searchable_48,
  none: Kb.IconType.iconfont_close,
  paperkey: Kb.IconType.icon_onboarding_paper_key_48,
  proof: Kb.IconType.icon_onboarding_proofs_48,
  team: Kb.IconType.icon_onboarding_team_48,
  teamShowcase: Kb.IconType.icon_onboarding_team_publicity_48,
  verifyAllEmail: Kb.IconType.icon_onboarding_email_verify_48,
  verifyAllPhoneNumber: Kb.IconType.icon_onboarding_number_verify_48,
} as const
