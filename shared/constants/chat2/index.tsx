...
export const makeStaticConfig: I.Record.Factory<Types._StaticConfig> = I.Record<Types._StaticConfig>({
  builtinCommands: {},
...
export const isUserActivelyLookingAtThisThread = (
  ...
  if (flags.useNewRouter) {
    ...
    chatThreadSelected =
      ...
      (routePath[routePath.length - 1] === null || routePath[routePath.length - 1] === undefined
        ? undefined
        : routePath[routePath.length - 1].routeName) === isMobile
        ? 'chatConversation'
        : 'tabs.chatTab'
  } else {
