...
>
export type BadgeAppForChat = NoErrorTypedAction<
  'chat:badgeAppForChat',
  List<ConversationBadgeState>
>
...
>
export type ClearMessages = NoErrorTypedAction<
  'chat:clearMessages',
  {conversationIDKey: ConversationIDKey}
>
export type ClearRekey = NoErrorTypedAction<
  'chat:clearRekey',
  {conversationIDKey: ConversationIDKey}
>
...
>
export type RemovePendingFailure = NoErrorTypedAction<
  'chat:removePendingFailure',
  {outboxID: OutboxIDKey}
>
...
>
export type UpdateBadging = NoErrorTypedAction<
  'chat:updateBadging',
  {conversationIDKey: ConversationIDKey}
>
...
export type UpdateSupersedesState = NoErrorTypedAction<
  ...
  {supersedesState: SupersedesState}
>
export type UpdatedMetadata = NoErrorTypedAction<
  'chat:updatedMetadata',
  {updated: {[key: string]: MetaData}}
>
...
function makeSnippet(messageBody: ?MessageBody): ?string {
  ...
  switch (messageBody.messageType) {
    ...
    case ChatTypes.CommonMessageType.attachment:
      return messageBody.attachment
        ? textSnippet(messageBody.attachment.object.title, 100)
        : 'Attachment'
    default:
      return null
  }
...
const getMessageFromMessageKey = (
  state: TypedState,
  messageKey: MessageKey
  // $FlowIssue getIn
...
const getSupersedes = (state: TypedState): ?SupersedeInfo => {
  ...
  return selectedConversationIDKey
    ? convSupersedesInfo(selectedConversationIDKey, state.chat)
    : null
}
