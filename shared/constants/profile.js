...
export const outputInstructionsActionLink =
  'profile:outputInstructionsActionLink'
...
export type AddProof = NoErrorTypedAction<
  'profile:addProof',
  {platform: PlatformsExpandedType}
>
...
>
export type FinishRevokeProof = TypedAction<
  'profile:revoke:finish',
  void,
  {error: string}
>
...
export type OnClickFollowing = NoErrorTypedAction<
  ...
  {username: string, openWebsite: ?boolean}
>
export type OnUserClick = NoErrorTypedAction<
  'profile:onUserClick',
  {username: string}
>
export type OutputInstructionsActionLink = NoErrorTypedAction<
  'profile:outputInstructionsActionLink',
  void
>
export type SubmitZcashAddress = NoErrorTypedAction<
  'profile:submitZcashAddress',
  void
>
export type SubmitBTCAddress = NoErrorTypedAction<
  'profile:submitBTCAddress',
  void
>
export type SubmitRevokeProof = NoErrorTypedAction<
  'profile:submitRevokeProof',
  {proofId: string}
>
...
export type UpdateErrorText = TypedAction<
  ...
  void
>
export type UpdatePgpInfo = TypedAction<
  'profile:updatePgpInfo',
  $Shape<PgpInfo>,
  PgpInfoError
> // $Shape is meant here instead of exact, because you can supply only the parts you want to update
export type UpdatePgpPublicKey = TypedAction<
  'profile:updatePgpPublicKey',
  {publicKey: string},
  {}
>
export type UpdatePlatform = TypedAction<
  'profile:updatePlatform',
  {platform: PlatformsExpandedType},
  void
>
export type UpdateProofStatus = TypedAction<
  ...
  void
>
export type UpdateProofText = TypedAction<
  'profile:updateProofText',
  {proof: string},
  void
>
export type UpdateSigID = TypedAction<
  'profile:updateSigID',
  {sigID: ?SigID},
  void
>
export type UpdateUsername = TypedAction<
  'profile:updateUsername',
  {username: string},
  void
>
export type Waiting = TypedAction<'profile:waiting', {waiting: boolean}, void>
export type WaitingRevokeProof = TypedAction<
  'profile:revoke:waiting',
  {waiting: boolean},
  void
>
