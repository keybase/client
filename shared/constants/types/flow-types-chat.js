...
export type IncomingCallMapType = {|
  ...
  'keybase.1.chatUi.chatAttachmentUploadDone'?: (params: {|sessionID: Int|}, response: CommonResponseHandler) => void,
  ...
  'keybase.1.chatUi.chatAttachmentPreviewUploadDone'?: (params: {|sessionID: Int|}, response: CommonResponseHandler) => void,
  'keybase.1.chatUi.chatAttachmentDownloadStart'?: (params: {|sessionID: Int|}, response: CommonResponseHandler) => void,
  ...
  'keybase.1.chatUi.chatAttachmentDownloadDone'?: (params: {|sessionID: Int|}, response: CommonResponseHandler) => void,
  ...
  'keybase.1.NotifyChat.ChatIdentifyUpdate'?: (params: {|update: Keybase1.CanonicalTLFNameAndIDWithBreaks|} /* , response: {} // Notify call
    */) => void,
  ...
  'keybase.1.NotifyChat.ChatInboxStale'?: (params: {|uid: Keybase1.UID|} /* , response: {} // Notify call
    */) => void,
  ...
  'keybase.1.NotifyChat.ChatTypingUpdate'?: (params: {|typingUpdates?: ?Array<ConvTypingUpdate>|} /* , response: {} // Notify call
    */) => void,
  ...
  'keybase.1.NotifyChat.ChatInboxSyncStarted'?: (params: {|uid: Keybase1.UID|} /* , response: {} // Notify call
    */) => void,
