...
export type ConnectedUser = {
  readonly uid: UID
  readonly devices?: Array<ConnectedDevice> | null
}
export type DeviceID = Bytes
export type Dismissal = {
  readonly msgIDs?: Array<MsgID> | null
  readonly ranges?: Array<MsgRange> | null
}
export type DurationMsec = Int64
export type DurationSec = Int64
export type InBandMessage = {
  readonly stateUpdate?: StateUpdateMessage | null
  readonly stateSync?: StateSyncMessage | null
}
export type Item = {
  readonly category: Category
  readonly dtime: TimeOrOffset
  readonly remindTimes?: Array<TimeOrOffset> | null
  readonly body: Body
}
export type ItemAndMetadata = {
  readonly md?: Metadata | null
  readonly item?: Item | null
}
export type Message = {
  readonly oobm?: OutOfBandMessage | null
  readonly ibm?: InBandMessage | null
}
export type Metadata = {
  ...
  readonly ctime: Time
  readonly deviceID: DeviceID
  readonly inBandMsgType: Int
}
export type MsgID = Bytes
export type MsgRange = {
  readonly endTime: TimeOrOffset
  readonly category: Category
  readonly skipMsgIDs?: Array<MsgID> | null
}
...
export type Reminder = {
  readonly item: ItemAndMetadata
  readonly seqno: Int
  readonly remindTime: Time
}
...
export type ReminderSet = {
  readonly reminders?: Array<Reminder> | null
  readonly moreRemindersReady: Boolean
}
export type SessionID = String
export type SessionToken = String
export type State = {
  readonly items?: Array<ItemAndMetadata> | null
}
export type StateSyncMessage = {
  readonly md: Metadata
}
export type StateUpdateMessage = {
  readonly md: Metadata
  readonly creation?: Item | null
  readonly dismissal?: Dismissal | null
}
export type SyncResult = {
  readonly msgs?: Array<InBandMessage> | null
  readonly hash: Bytes
}
