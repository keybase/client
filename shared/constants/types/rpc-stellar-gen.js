...
export const localGetPaymentsLocalRpcPromise = (params: LocalGetPaymentsLocalRpcParam, waitingKey?: string): Promise<LocalGetPaymentsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.getPaymentsLocal', params, callback: (error: RPCError, result: LocalGetPaymentsLocalResult) => (error ? reject(error) : resolve(result))}))
...
export const localLinkNewWalletAccountLocalRpcPromise = (params: LocalLinkNewWalletAccountLocalRpcParam, waitingKey?: string): Promise<LocalLinkNewWalletAccountLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.linkNewWalletAccountLocal', params, callback: (error: RPCError, result: LocalLinkNewWalletAccountLocalResult) => (error ? reject(error) : resolve(result))}))
export const localValidateAccountNameLocalRpcPromise = (params: LocalValidateAccountNameLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.validateAccountNameLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const localValidateSecretKeyLocalRpcPromise = (params: LocalValidateSecretKeyLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.validateSecretKeyLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export type AccountAssetLocal = $ReadOnly<{name: String, balanceTotal: String, balanceAvailableToSend: String, assetCode: String, issuerName: String, issuerAccountID: String, worth: String, worthCurrency: String}>
