...
export const localExportSecretKeyLocalRpcPromise = (params: LocalExportSecretKeyLocalRpcParam, waitingKey?: string): Promise<LocalExportSecretKeyLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.exportSecretKeyLocal', params, callback: (error: RPCError, result: LocalExportSecretKeyLocalResult) => (error ? reject(error) : resolve(result))}))
