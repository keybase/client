...
export type PaymentDetailsLocal = $ReadOnly<{id: PaymentID, txID: TransactionID, time: TimeMs, statusSimplified: PaymentStatus, statusDescription: String, statusDetail: String, showCancel: Boolean, amountDescription: String, delta: BalanceDelta, worth: String, worthCurrency: String, fromType: ParticipantType, toType: ParticipantType, fromAccountID: AccountID, fromAccountName: String, fromUsername: String, toAccountID?: ?AccountID, toAccountName: String, toUsername: String, toAssertion: String, note: String, noteErr: String, publicNote: String, publicNoteType: String}>
...
export type PaymentLocal = $ReadOnly<{id: PaymentID, time: TimeMs, statusSimplified: PaymentStatus, statusDescription: String, statusDetail: String, showCancel: Boolean, amountDescription: String, delta: BalanceDelta, worth: String, worthCurrency: String, fromType: ParticipantType, toType: ParticipantType, fromAccountID: AccountID, fromAccountName: String, fromUsername: String, toAccountID?: ?AccountID, toAccountName: String, toUsername: String, toAssertion: String, note: String, noteErr: String}>
