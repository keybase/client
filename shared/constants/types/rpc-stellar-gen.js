...
export const localBuildPaymentLocalRpcPromise = (params: LocalBuildPaymentLocalRpcParam, waitingKey?: string): Promise<LocalBuildPaymentLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.buildPaymentLocal', params, callback: (error: RPCError, result: LocalBuildPaymentLocalResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export const localSendPaymentLocalRpcPromise = (params: LocalSendPaymentLocalRpcParam, waitingKey?: string): Promise<LocalSendPaymentLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.sendPaymentLocal', params, callback: (error: RPCError, result: LocalSendPaymentLocalResult) => (error ? reject(error) : resolve(result)), waitingKey}))
