...
export const localChangeDisplayCurrencyLocalRpcPromise = (params: LocalChangeDisplayCurrencyLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.changeDisplayCurrencyLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
export const localChangeWalletAccountNameLocalRpcPromise = (params: LocalChangeWalletAccountNameLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.changeWalletAccountNameLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
export const localDeleteWalletAccountLocalRpcPromise = (params: LocalDeleteWalletAccountLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.deleteWalletAccountLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
...
export const localGetDisplayCurrenciesLocalRpcPromise = (params: LocalGetDisplayCurrenciesLocalRpcParam, waitingKey?: string): Promise<LocalGetDisplayCurrenciesLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.getDisplayCurrenciesLocal', params, callback: (error: RPCError, result: LocalGetDisplayCurrenciesLocalResult) => (error ? reject(error) : resolve(result)), waitingKey}))
export const localGetDisplayCurrencyLocalRpcPromise = (params: LocalGetDisplayCurrencyLocalRpcParam, waitingKey?: string): Promise<LocalGetDisplayCurrencyLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.getDisplayCurrencyLocal', params, callback: (error: RPCError, result: LocalGetDisplayCurrencyLocalResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export const localSetWalletAccountAsDefaultLocalRpcPromise = (params: LocalSetWalletAccountAsDefaultLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.setWalletAccountAsDefaultLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
