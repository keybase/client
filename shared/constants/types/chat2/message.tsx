...
export type _MessageAttachment = {
  ...
  previewWidth: number,
  previewTransferState: "downloading" | null,
  reactions: Reactions,
...
export type _MessageRequestPayment = {
  ...
  requestInfo: ChatRequestInfo | null,
  timestamp: number,
  type: "requestPayment"
};
...
export type _MessageSendPayment = {
  ...
  outboxID: OutboxID | null,
  reactions: Reactions,
  paymentInfo: ChatPaymentInfo | null,
  timestamp: number,
  type: "sendPayment"
};
...
export type Message = MessageAttachment | MessageDeleted | MessageRequestPayment | MessageSendPayment | MessageSetChannelname | MessageSetDescription | MessageSystemAddedToTeam | MessageSystemChangeRetention | MessageSystemGitPush | MessageSystemInviteAccepted | MessageSystemJoined | MessageSystemLeft | MessageSystemSimpleToComplex | MessageSystemText | MessageSystemUsersAddedToConversation | MessageText | MessagePlaceholder;
export type MessageType = "attachment" | "deleted" | "requestPayment" | "sendPayment" | "setChannelname" | "setDescription" | "systemAddedToTeam" | "systemChangeRetention" | "systemGitPush" | "systemInviteAccepted" | "systemJoined" | "systemLeft" | "systemSimpleToComplex" | "systemText" | "systemUsersAddedToConversation" | "text" | "placeholder";
