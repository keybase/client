...
export const userUploadUserAvatarRpcPromise = (params: UserUploadUserAvatarRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.user.uploadUserAvatar', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
