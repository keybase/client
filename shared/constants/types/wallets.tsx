...
export type State = {
  ...
  readonly airdropDetails: AirdropDetails
  readonly airdropQualifications: Array<AirdropQualification>
  readonly airdropShowBanner: boolean
  readonly airdropState: AirdropState
