...
export function gitGcPersonalRepoRpcChannelMap (configKeys: Array<string>, request: requestCommon & requestErrorCallback & {param: gitGcPersonalRepoRpcParam}): EngineChannel {
  return engine()._channelMapRpcHelper(configKeys, 'keybase.1.git.gcPersonalRepo', request)
}

export function gitGcPersonalRepoRpcPromise (request: (requestCommon & requestErrorCallback & {param: gitGcPersonalRepoRpcParam})): Promise<void> {
  return new Promise((resolve, reject) => engineRpcOutgoing('keybase.1.git.gcPersonalRepo', request, (error, result) => error ? reject(error) : resolve(result)))
}

export function gitGcTeamRepoRpcChannelMap (configKeys: Array<string>, request: requestCommon & requestErrorCallback & {param: gitGcTeamRepoRpcParam}): EngineChannel {
  return engine()._channelMapRpcHelper(configKeys, 'keybase.1.git.gcTeamRepo', request)
}

export function gitGcTeamRepoRpcPromise (request: (requestCommon & requestErrorCallback & {param: gitGcTeamRepoRpcParam})): Promise<void> {
  return new Promise((resolve, reject) => engineRpcOutgoing('keybase.1.git.gcTeamRepo', request, (error, result) => error ? reject(error) : resolve(result)))
}
...
=======
export type KBFSGitGcRpcParam = Exact<{
  folder: Folder,
  name: GitRepoName,
  options: GcOptions
}>
...
=======
export type gitGcPersonalRepoRpcParam = Exact<{
  repoName: GitRepoName,
  force: boolean
}>

export type gitGcTeamRepoRpcParam = Exact<{
  repoName: GitRepoName,
  teamName: TeamName,
  force: boolean
}>
...
export type IncomingCallMapType = {|
  ...
  'keybase.1.gpgUi.selectKeyAndPushOption'?: (
    params: {|
      ...
      keys?: ?Array<GPGKey>,
    |},
    response: {error: RPCErrorHandler, result: (result: GpgUiSelectKeyAndPushOptionResult) => void}
  ) => void,
  'keybase.1.gpgUi.selectKey'?: (
    params: {|
      ...
      keys?: ?Array<GPGKey>,
    |},
    response: {error: RPCErrorHandler, result: (result: GpgUiSelectKeyResult) => void}
  ) => void,
  'keybase.1.gpgUi.sign'?: (
    params: {|
      ...
      fingerprint: Bytes,
    |},
    response: {error: RPCErrorHandler, result: (result: GpgUiSignResult) => void}
  ) => void,
  'keybase.1.gpgUi.getTTY'?: (params: void, response: {error: RPCErrorHandler, result: (result: GpgUiGetTTYResult) => void}) => void,
  ...
  'keybase.1.homeUi.homeUIRefresh'?: (params: void, response: CommonResponseHandler) => void,
  ...
  'keybase.1.identifyUi.delegateIdentifyUI'?: (params: void, response: {error: RPCErrorHandler, result: (result: IdentifyUiDelegateIdentifyUIResult) => void}) => void,
  ...
  'keybase.1.identifyUi.confirm'?: (
    ...
    |},
    response: {error: RPCErrorHandler, result: (result: IdentifyUiConfirmResult) => void}
  ) => void,
  ...
  'keybase.1.loginUi.promptRevokePaperKeys'?: (
    params: {|
      ...
      index: Int,
    |},
    response: {error: RPCErrorHandler, result: (result: LoginUiPromptRevokePaperKeysResult) => void}
  ) => void,
  ...
  'keybase.1.logsend.prepareLogsend'?: (params: void, response: CommonResponseHandler) => void,
  'keybase.1.NotifyApp.exit'?: (params: void, response: CommonResponseHandler) => void,
  'keybase.1.NotifyBadges.badgeState'?: (params: {|badgeState: BadgeState|} /* , response: {} // Notify call
    */) => void,
  'keybase.1.NotifyFavorites.favoritesChanged'?: (params: {|uid: UID|} /* , response: {} // Notify call
    */) => void,
  'keybase.1.NotifyFS.FSActivity'?: (params: {|notification: FSNotification|} /* , response: {} // Notify call
    */) => void,
  ...
  'keybase.1.NotifyPGP.pgpKeyInSecretStoreFile'?: (params: void, response: CommonResponseHandler) => void,
  'keybase.1.NotifyService.shutdown'?: (params: void, response: CommonResponseHandler) => void,
  'keybase.1.NotifySession.loggedOut'?: (params: void /* , response: {} // Notify call
    */) => void,
  ...
  'keybase.1.NotifyUsers.userChanged'?: (params: {|uid: UID|} /* , response: {} // Notify call
    */) => void,
  ...
  'keybase.1.proveUi.promptOverwrite'?: (
    params: {|
      ...
      typ: PromptOverwriteType,
    |},
    response: {error: RPCErrorHandler, result: (result: ProveUiPromptOverwriteResult) => void}
  ) => void,
  'keybase.1.proveUi.promptUsername'?: (
    params: {|
      ...
      prevError?: ?Status,
    |},
    response: {error: RPCErrorHandler, result: (result: ProveUiPromptUsernameResult) => void}
  ) => void,
  ...
  'keybase.1.proveUi.preProofWarning'?: (
    params: {|
      ...
      text: Text,
    |},
    response: {error: RPCErrorHandler, result: (result: ProveUiPreProofWarningResult) => void}
  ) => void,
  ...
  'keybase.1.proveUi.okToCheck'?: (
    params: {|
      ...
      attempt: Int,
    |},
    response: {error: RPCErrorHandler, result: (result: ProveUiOkToCheckResult) => void}
  ) => void,
  ...
  'keybase.1.provisionUi.chooseProvisioningMethod'?: (
    params: {|
      ...
      gpgOption: Boolean,
    |},
    response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseProvisioningMethodResult) => void}
  ) => void,
  'keybase.1.provisionUi.chooseGPGMethod'?: (
    params: {|
      ...
      keys?: ?Array<GPGKey>,
    |},
    response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseGPGMethodResult) => void}
  ) => void,
  'keybase.1.provisionUi.switchToGPGSignOK'?: (
    params: {|
      ...
      importError: String,
    |},
    response: {error: RPCErrorHandler, result: (result: ProvisionUiSwitchToGPGSignOKResult) => void}
  ) => void,
  'keybase.1.provisionUi.chooseDevice'?: (
    params: {|
      ...
      canSelectNoDevice: Boolean,
    |},
    response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseDeviceResult) => void}
  ) => void,
  'keybase.1.provisionUi.chooseDeviceType'?: (
    params: {|
      ...
      kind: ChooseType,
    |},
    response: {error: RPCErrorHandler, result: (result: ProvisionUiChooseDeviceTypeResult) => void}
  ) => void,
  'keybase.1.provisionUi.DisplayAndPromptSecret'?: (
    params: {|
      ...
      previousErr: String,
    |},
    response: {error: RPCErrorHandler, result: (result: ProvisionUiDisplayAndPromptSecretResult) => void}
  ) => void,
  ...
  'keybase.1.provisionUi.PromptNewDeviceName'?: (
    params: {|
      ...
      errorMessage: String,
    |},
    response: {error: RPCErrorHandler, result: (result: ProvisionUiPromptNewDeviceNameResult) => void}
  ) => void,
  ...
  'keybase.1.rekeyUI.delegateRekeyUI'?: (params: void, response: {error: RPCErrorHandler, result: (result: RekeyUIDelegateRekeyUIResult) => void}) => void,
  ...
  'keybase.1.secretUi.getPassphrase'?: (
    params: {|
      ...
      terminal?: ?SecretEntryArg,
    |},
    response: {error: RPCErrorHandler, result: (result: SecretUiGetPassphraseResult) => void}
  ) => void,
  ...
  'keybase.1.streamUi.read'?: (
    params: {|
      ...
      sz: Int,
    |},
    response: {error: RPCErrorHandler, result: (result: StreamUiReadResult) => void}
  ) => void,
  ...
  'keybase.1.streamUi.write'?: (
    params: {|
      ...
      buf: Bytes,
    |},
    response: {error: RPCErrorHandler, result: (result: StreamUiWriteResult) => void}
  ) => void,
  'keybase.1.teamsUi.confirmRootTeamDelete'?: (
    params: {|
      ...
      teamName: String,
    |},
    response: {error: RPCErrorHandler, result: (result: TeamsUiConfirmRootTeamDeleteResult) => void}
  ) => void,
  'keybase.1.teamsUi.confirmSubteamDelete'?: (
    params: {|
      ...
      teamName: String,
    |},
    response: {error: RPCErrorHandler, result: (result: TeamsUiConfirmSubteamDeleteResult) => void}
  ) => void,
  'keybase.1.ui.promptYesNo'?: (
    params: {|
      ...
      promptDefault: PromptDefault,
    |},
    response: {error: RPCErrorHandler, result: (result: UiPromptYesNoResult) => void}
  ) => void,
|}
