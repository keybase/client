...
export declare function localAcceptDisclaimerLocalRpcPromise(
  params: MessageTypes['stellar.1.local.acceptDisclaimerLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.acceptDisclaimerLocal']['outParam']>

export declare function localAirdropDetailsLocalRpcPromise(
  params: MessageTypes['stellar.1.local.airdropDetailsLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.airdropDetailsLocal']['outParam']>

export declare function localAirdropRegisterLocalRpcPromise(
  params: MessageTypes['stellar.1.local.airdropRegisterLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.airdropRegisterLocal']['outParam']>

export declare function localAirdropStatusLocalRpcPromise(
  params: MessageTypes['stellar.1.local.airdropStatusLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.airdropStatusLocal']['outParam']>

export declare function localBuildPaymentLocalRpcPromise(
  params: MessageTypes['stellar.1.local.buildPaymentLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.buildPaymentLocal']['outParam']>

export declare function localBuildRequestLocalRpcPromise(
  params: MessageTypes['stellar.1.local.buildRequestLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.buildRequestLocal']['outParam']>

export declare function localCancelPaymentLocalRpcPromise(
  params: MessageTypes['stellar.1.local.cancelPaymentLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.cancelPaymentLocal']['outParam']>

export declare function localCancelRequestLocalRpcPromise(
  params: MessageTypes['stellar.1.local.cancelRequestLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.cancelRequestLocal']['outParam']>

export declare function localChangeDisplayCurrencyLocalRpcPromise(
  params: MessageTypes['stellar.1.local.changeDisplayCurrencyLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.changeDisplayCurrencyLocal']['outParam']>

export declare function localChangeWalletAccountNameLocalRpcPromise(
  params: MessageTypes['stellar.1.local.changeWalletAccountNameLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.changeWalletAccountNameLocal']['outParam']>

export declare function localCreateWalletAccountLocalRpcPromise(
  params: MessageTypes['stellar.1.local.createWalletAccountLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.createWalletAccountLocal']['outParam']>

export declare function localDeleteWalletAccountLocalRpcPromise(
  params: MessageTypes['stellar.1.local.deleteWalletAccountLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.deleteWalletAccountLocal']['outParam']>

export declare function localGetAccountAssetsLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getAccountAssetsLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getAccountAssetsLocal']['outParam']>

export declare function localGetDisplayCurrenciesLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getDisplayCurrenciesLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getDisplayCurrenciesLocal']['outParam']>

export declare function localGetDisplayCurrencyLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getDisplayCurrencyLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getDisplayCurrencyLocal']['outParam']>

export declare function localGetInflationDestinationLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getInflationDestinationLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getInflationDestinationLocal']['outParam']>

export declare function localGetPaymentDetailsLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getPaymentDetailsLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getPaymentDetailsLocal']['outParam']>

export declare function localGetPaymentsLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getPaymentsLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getPaymentsLocal']['outParam']>

export declare function localGetPendingPaymentsLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getPendingPaymentsLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getPendingPaymentsLocal']['outParam']>

export declare function localGetPredefinedInflationDestinationsLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getPredefinedInflationDestinationsLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getPredefinedInflationDestinationsLocal']['outParam']>

export declare function localGetSendAssetChoicesLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getSendAssetChoicesLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getSendAssetChoicesLocal']['outParam']>

export declare function localGetWalletAccountLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getWalletAccountLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getWalletAccountLocal']['outParam']>

export declare function localGetWalletAccountSecretKeyLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getWalletAccountSecretKeyLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getWalletAccountSecretKeyLocal']['outParam']>

export declare function localGetWalletAccountsLocalRpcPromise(
  params: MessageTypes['stellar.1.local.getWalletAccountsLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.getWalletAccountsLocal']['outParam']>

export declare function localHasAcceptedDisclaimerLocalRpcPromise(
  params: MessageTypes['stellar.1.local.hasAcceptedDisclaimerLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.hasAcceptedDisclaimerLocal']['outParam']>

export declare function localIsAccountMobileOnlyLocalRpcPromise(
  params: MessageTypes['stellar.1.local.isAccountMobileOnlyLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.isAccountMobileOnlyLocal']['outParam']>

export declare function localLinkNewWalletAccountLocalRpcPromise(
  params: MessageTypes['stellar.1.local.linkNewWalletAccountLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.linkNewWalletAccountLocal']['outParam']>

export declare function localMakeRequestLocalRpcPromise(
  params: MessageTypes['stellar.1.local.makeRequestLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.makeRequestLocal']['outParam']>

export declare function localMarkAsReadLocalRpcPromise(
  params: MessageTypes['stellar.1.local.markAsReadLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.markAsReadLocal']['outParam']>

export declare function localReviewPaymentLocalRpcPromise(
  params: MessageTypes['stellar.1.local.reviewPaymentLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.reviewPaymentLocal']['outParam']>

export declare function localSendPaymentLocalRpcPromise(
  params: MessageTypes['stellar.1.local.sendPaymentLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.sendPaymentLocal']['outParam']>

export declare function localSetAccountAllDevicesLocalRpcPromise(
  params: MessageTypes['stellar.1.local.setAccountAllDevicesLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.setAccountAllDevicesLocal']['outParam']>

export declare function localSetAccountMobileOnlyLocalRpcPromise(
  params: MessageTypes['stellar.1.local.setAccountMobileOnlyLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.setAccountMobileOnlyLocal']['outParam']>

export declare function localSetInflationDestinationLocalRpcPromise(
  params: MessageTypes['stellar.1.local.setInflationDestinationLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.setInflationDestinationLocal']['outParam']>

export declare function localSetWalletAccountAsDefaultLocalRpcPromise(
  params: MessageTypes['stellar.1.local.setWalletAccountAsDefaultLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.setWalletAccountAsDefaultLocal']['outParam']>

export declare function localStartBuildPaymentLocalRpcPromise(
  params: MessageTypes['stellar.1.local.startBuildPaymentLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.startBuildPaymentLocal']['outParam']>

export declare function localStopBuildPaymentLocalRpcPromise(
  params: MessageTypes['stellar.1.local.stopBuildPaymentLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.stopBuildPaymentLocal']['outParam']>

export declare function localValidateAccountNameLocalRpcPromise(
  params: MessageTypes['stellar.1.local.validateAccountNameLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.validateAccountNameLocal']['outParam']>

export declare function localValidateSecretKeyLocalRpcPromise(
  params: MessageTypes['stellar.1.local.validateSecretKeyLocal']['inParam'],
  waitingKey?: WaitingKey
): Promise<MessageTypes['stellar.1.local.validateSecretKeyLocal']['outParam']>
