...
export type Unfurl = {unfurlType: UnfurlType.generic; generic: UnfurlGeneric} | {unfurlType: UnfurlType.youtube; youtube: UnfurlYoutube} | {unfurlType: UnfurlType.giphy; giphy: UnfurlGiphy} | {unfurlType: UnfurlType.maps} | {unfurlType: UnfurlType.mapsEnded}
export type UnfurlDisplay = {unfurlType: UnfurlType.generic; generic: UnfurlGenericDisplay} | {unfurlType: UnfurlType.youtube; youtube: UnfurlYoutubeDisplay} | {unfurlType: UnfurlType.giphy; giphy: UnfurlGiphyDisplay} | {unfurlType: UnfurlType.maps} | {unfurlType: UnfurlType.mapsEnded}
export type UnfurlGeneric = {readonly title: String; readonly url: String; readonly siteName: String; readonly favicon?: Asset | null; readonly image?: Asset | null; readonly publishTime?: Int | null; readonly description?: String | null; readonly mapInfo?: UnfurlGenericMapInfo | null; readonly endedMapInfo?: UnfurlGenericMapEndedInfo | null}
export type UnfurlGenericDisplay = {readonly title: String; readonly url: String; readonly siteName: String; readonly favicon?: UnfurlImageDisplay | null; readonly media?: UnfurlImageDisplay | null; readonly publishTime?: Int | null; readonly description?: String | null; readonly mapInfo?: UnfurlGenericMapInfo | null; readonly endedMapInfo?: UnfurlGenericMapEndedInfo | null}
export type UnfurlGenericMapEndedInfo = {readonly endedTime: Gregor1.Time}
...
export type UnfurlMapsEndedRaw = {readonly endedTime: Gregor1.Time}
...
export type UnfurlRaw = {unfurlType: UnfurlType.generic; generic: UnfurlGenericRaw} | {unfurlType: UnfurlType.youtube; youtube: UnfurlYoutubeRaw} | {unfurlType: UnfurlType.giphy; giphy: UnfurlGiphyRaw} | {unfurlType: UnfurlType.maps; maps: UnfurlMapsRaw} | {unfurlType: UnfurlType.mapsEnded; mapsEnded: UnfurlMapsEndedRaw}
