...
export type MessageTypes = {
  ...
  'chat.1.local.getLocationPreview': {
    inParam: {readonly lat: Double; readonly lon: Double}
    outParam: String
  }
...
export const localGetLocationPreviewRpcPromise = (params: MessageTypes['chat.1.local.getLocationPreview']['inParam'], waitingKey?: WaitingKey) => new Promise<MessageTypes['chat.1.local.getLocationPreview']['outParam']>((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.getLocationPreview', params, callback: (error, result) => (error ? reject(error) : resolve(result)), waitingKey}))
