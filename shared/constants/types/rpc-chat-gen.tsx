...
export type HarvestedEmoji = {readonly alias: String; readonly isCrossTeam: Boolean; readonly source: EmojiRemoteSource}
...
export type UIEmojiDecoration = {status: UIEmojiDecorationStatus.resolving; resolving: UIEmojiResolvingInfo} | {status: UIEmojiDecorationStatus.emoji; emoji: Emoji}
export type UIEmojiResolvingInfo = {readonly key: String; readonly alias: String}
