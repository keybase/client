...
export type MessageTypes = {
  ...
  'chat.1.local.getSharedConversationsLocal': {
    inParam: {readonly username: String}
    outParam: GetSharedConversationsLocalRes
  }
...
export type GetSharedConversationsLocalRes = {readonly conversations?: ReadonlyArray<UnverifiedInboxUIItem> | null; readonly offline: Boolean}
...
export const localGetSharedConversationsLocalRpcPromise = (params: MessageTypes['chat.1.local.getSharedConversationsLocal']['inParam'], waitingKey?: WaitingKey) => new Promise<MessageTypes['chat.1.local.getSharedConversationsLocal']['outParam']>((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.getSharedConversationsLocal', params, callback: (error: SimpleError, result: MessageTypes['chat.1.local.getSharedConversationsLocal']['outParam']) => (error ? reject(error) : resolve(result)), waitingKey}))
