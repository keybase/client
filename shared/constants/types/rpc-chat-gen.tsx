...
export type MessageTypes = {
  ...
  'chat.1.local.archiveChat': {
    inParam: {readonly jobID: ArchiveJobID; readonly outputPath: String; readonly query?: GetInboxLocalQuery | null; readonly compress: Boolean; readonly identifyBehavior: Keybase1.TLFIdentifyBehavior}
