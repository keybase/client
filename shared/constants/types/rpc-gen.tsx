...
export type MessageTypes = {
  ...
  'keybase.1.contacts.saveContactsList': {
...
export const contactsSaveContactsListRpcPromise = (params: MessageTypes['keybase.1.contacts.saveContactsList']['inParam'], waitingKey?: WaitingKey) => new Promise<MessageTypes['keybase.1.contacts.saveContactsList']['outParam']>((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.contacts.saveContactsList', params, callback: (error, result) => (error ? reject(error) : resolve(result)), waitingKey}))
