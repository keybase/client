...
export type MessageTypes = {
  ...
  'keybase.1.kbfsMount.WaitForDirectMount': {
    inParam: void
    outParam: Boolean
  }
  'keybase.1.logUi.log': {
...
export const kbfsMountWaitForDirectMountRpcPromise = (params: MessageTypes['keybase.1.kbfsMount.WaitForDirectMount']['inParam'], waitingKey?: WaitingKey) => new Promise<MessageTypes['keybase.1.kbfsMount.WaitForDirectMount']['outParam']>((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.kbfsMount.WaitForDirectMount', params, callback: (error, result) => (error ? reject(error) : resolve(result)), waitingKey}))
