...
export type RuntimeStats = {readonly cpu: String; readonly resident: String; readonly virt: String; readonly goheap: String; readonly goheapsys: String; readonly gostack: String}
