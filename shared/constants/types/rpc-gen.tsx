...
export type TeamBotSettings = {readonly cmds: Boolean; readonly mentions: Boolean; readonly joins: Boolean; readonly triggers?: Array<String> | null; readonly convs?: Array<String> | null}
