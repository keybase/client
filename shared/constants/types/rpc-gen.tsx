...
import {getEngine as engine, getEngineSaga, getEngineListener, type ListenerApi} from '../../engine/require'
import {type Effect, call} from 'redux-saga/effects'
...
export const teamsTeamAcceptInviteOrRequestAccessRpcPromise = (params: MessageTypes['keybase.1.teams.teamAcceptInviteOrRequestAccess']['inParam'], waitingKey?: WaitingKey) => new Promise<MessageTypes['keybase.1.teams.teamAcceptInviteOrRequestAccess']['outParam']>((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamAcceptInviteOrRequestAccess', params, callback: (error: SimpleError, result: MessageTypes['keybase.1.teams.teamAcceptInviteOrRequestAccess']['outParam']) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export const teamsTeamDeleteRpcPromise = (params: MessageTypes['keybase.1.teams.teamDelete']['inParam'], waitingKey?: WaitingKey) => new Promise<MessageTypes['keybase.1.teams.teamDelete']['outParam']>((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.teams.teamDelete', params, callback: (error: SimpleError, result: MessageTypes['keybase.1.teams.teamDelete']['outParam']) => (error ? reject(error) : resolve(result)), waitingKey}))
