...
export type MessageTypes = {
  ...
  'keybase.1.userSearch.userSearch': {
    ...
    outParam: Array<UserSearchResult> | null
  }
}
...
export enum UserSearchSourceType {
  keybase = 0,
  social = 1,
  contacts = 2,
  tofu = 3,
