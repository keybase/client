...
export const accountEnterResetPipelineRpcPromise = (params: MessageTypes['keybase.1.account.enterResetPipeline']['inParam'], waitingKey?: WaitingKey) => new Promise<MessageTypes['keybase.1.account.enterResetPipeline']['outParam']>((resolve, reject) => engine()._rpcOutgoing({method: 'keybase.1.account.enterResetPipeline', params, callback: (error, result) => (error ? reject(error) : resolve(result)), waitingKey}))
