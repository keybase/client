...
export enum PaymentFeatureVersion {
  none = 0,
  chatid = 1,
}
...
export type ChatOutboxID = String
...
export type PathPaymentPost = {readonly fromDeviceID: Keybase1.DeviceID; readonly to?: Keybase1.UserVersion | null; readonly noteB64: String; readonly signedTransaction: String; readonly quickReturn: Boolean; readonly chatConversationID?: ChatConversationID | null; readonly chatOutboxID?: ChatOutboxID | null; readonly featureVersion: PaymentFeatureVersion}
