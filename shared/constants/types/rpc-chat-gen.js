...
export type IncomingCallMapType = {|'chat.1.chatUi.chatAttachmentUploadOutboxID'?: (params: $ReadOnly<{sessionID: Int, outboxID: OutboxID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentUploadStart'?: (params: $ReadOnly<{sessionID: Int, metadata: AssetMetadata, placeholderMsgID: MessageID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentUploadProgress'?: (params: $ReadOnly<{sessionID: Int, bytesComplete: Long, bytesTotal: Long}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentUploadDone'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentPreviewUploadStart'?: (params: $ReadOnly<{sessionID: Int, metadata: AssetMetadata}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentPreviewUploadDone'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentDownloadStart'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentDownloadProgress'?: (params: $ReadOnly<{sessionID: Int, bytesComplete: Long, bytesTotal: Long}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatAttachmentDownloadDone'?: (params: $ReadOnly<{sessionID: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatInboxUnverified'?: (params: $ReadOnly<{sessionID: Int, inbox: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatInboxConversation'?: (params: $ReadOnly<{sessionID: Int, conv: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatInboxFailed'?: (params: $ReadOnly<{sessionID: Int, convID: ConversationID, error: InboxUIItemError}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatThreadCached'?: (params: $ReadOnly<{sessionID: Int, thread?: ?String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatThreadFull'?: (params: $ReadOnly<{sessionID: Int, thread: String}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatSearchHit'?: (params: $ReadOnly<{sessionID: Int, searchHit: ChatSearchHit}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatSearchDone'?: (params: $ReadOnly<{sessionID: Int, numHits: Int}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.chatUi.chatConfirmChannelDelete'?: (params: $ReadOnly<{sessionID: Int, channel: String}>, response: {error: RPCErrorHandler, result: (result: ChatUiChatConfirmChannelDeleteResult) => void}, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.NewChatActivity'?: (params: $ReadOnly<{uid: Keybase1.UID, activity: ChatActivity}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatIdentifyUpdate'?: (params: $ReadOnly<{update: Keybase1.CanonicalTLFNameAndIDWithBreaks}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatTLFFinalize'?: (params: $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, finalizeInfo: ConversationFinalizeInfo, conv?: ?InboxUIItem}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatTLFResolve'?: (params: $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, resolveInfo: ConversationResolveInfo}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatInboxStale'?: (params: $ReadOnly<{uid: Keybase1.UID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatThreadsStale'?: (params: $ReadOnly<{uid: Keybase1.UID, updates?: ?Array<ConversationStaleUpdate>}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatTypingUpdate'?: (params: $ReadOnly<{typingUpdates?: ?Array<ConvTypingUpdate>}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatJoinedConversation'?: (params: $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, conv?: ?InboxUIItem}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatLeftConversation'?: (params: $ReadOnly<{uid: Keybase1.UID, convID: ConversationID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatResetConversation'?: (params: $ReadOnly<{uid: Keybase1.UID, convID: ConversationID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatInboxSyncStarted'?: (params: $ReadOnly<{uid: Keybase1.UID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatInboxSynced'?: (params: $ReadOnly<{uid: Keybase1.UID, syncRes: ChatSyncResult}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatSetConvRetention'?: (params: $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, conv?: ?InboxUIItem}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatSetTeamRetention'?: (params: $ReadOnly<{uid: Keybase1.UID, teamID: Keybase1.TeamID, convs?: ?Array<InboxUIItem>}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>, 'chat.1.NotifyChat.ChatKBFSToImpteamUpgrade'?: (params: $ReadOnly<{uid: Keybase1.UID, convID: ConversationID}>, state: TypedState) => ?Saga.Effect | Generator<any, any, any>|}
