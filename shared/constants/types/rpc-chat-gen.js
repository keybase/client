...
export const localAddTeamMemberAfterResetRpcPromise = (params: LocalAddTeamMemberAfterResetRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.addTeamMemberAfterReset', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const localCancelPostRpcPromise = (params: LocalCancelPostRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.CancelPost', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const localDeleteConversationLocalRpcPromise = (params: LocalDeleteConversationLocalRpcParam, waitingKey?: string): Promise<LocalDeleteConversationLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.deleteConversationLocal', params, callback: (error: RPCError, result: LocalDeleteConversationLocalResult) => (error ? reject(error) : resolve(result))}))
...
export const localLeaveConversationLocalRpcPromise = (params: LocalLeaveConversationLocalRpcParam, waitingKey?: string): Promise<LocalLeaveConversationLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.leaveConversationLocal', params, callback: (error: RPCError, result: LocalLeaveConversationLocalResult) => (error ? reject(error) : resolve(result))}))
export const localMakePreviewRpcPromise = (params: LocalMakePreviewRpcParam, waitingKey?: string): Promise<LocalMakePreviewResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.makePreview', params, callback: (error: RPCError, result: LocalMakePreviewResult) => (error ? reject(error) : resolve(result))}))
export const localMarkAsReadLocalRpcPromise = (params: LocalMarkAsReadLocalRpcParam, waitingKey?: string): Promise<LocalMarkAsReadLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.markAsReadLocal', params, callback: (error: RPCError, result: LocalMarkAsReadLocalResult) => (error ? reject(error) : resolve(result))}))
export const localNewConversationLocalRpcPromise = (params: LocalNewConversationLocalRpcParam, waitingKey?: string): Promise<LocalNewConversationLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.newConversationLocal', params, callback: (error: RPCError, result: LocalNewConversationLocalResult) => (error ? reject(error) : resolve(result))}))
...
export const localPostHeadlineRpcPromise = (params: LocalPostHeadlineRpcParam, waitingKey?: string): Promise<LocalPostHeadlineResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postHeadline', params, callback: (error: RPCError, result: LocalPostHeadlineResult) => (error ? reject(error) : resolve(result))}))
export const localPostMetadataRpcPromise = (params: LocalPostMetadataRpcParam, waitingKey?: string): Promise<LocalPostMetadataResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postMetadata', params, callback: (error: RPCError, result: LocalPostMetadataResult) => (error ? reject(error) : resolve(result))}))
export const localPostTextNonblockRpcPromise = (params: LocalPostTextNonblockRpcParam, waitingKey?: string): Promise<LocalPostTextNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postTextNonblock', params, callback: (error: RPCError, result: LocalPostTextNonblockResult) => (error ? reject(error) : resolve(result))}))
export const localPreviewConversationByIDLocalRpcPromise = (params: LocalPreviewConversationByIDLocalRpcParam, waitingKey?: string): Promise<LocalPreviewConversationByIDLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.previewConversationByIDLocal', params, callback: (error: RPCError, result: LocalPreviewConversationByIDLocalResult) => (error ? reject(error) : resolve(result))}))
export const localRetryPostRpcPromise = (params: LocalRetryPostRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.RetryPost', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const localSetAppNotificationSettingsLocalRpcPromise = (params: LocalSetAppNotificationSettingsLocalRpcParam, waitingKey?: string): Promise<LocalSetAppNotificationSettingsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.setAppNotificationSettingsLocal', params, callback: (error: RPCError, result: LocalSetAppNotificationSettingsLocalResult) => (error ? reject(error) : resolve(result))}))
export const localSetConvRetentionLocalRpcPromise = (params: LocalSetConvRetentionLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.setConvRetentionLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const localSetConversationStatusLocalRpcPromise = (params: LocalSetConversationStatusLocalRpcParam, waitingKey?: string): Promise<LocalSetConversationStatusLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.SetConversationStatusLocal', params, callback: (error: RPCError, result: LocalSetConversationStatusLocalResult) => (error ? reject(error) : resolve(result))}))
export const localSetGlobalAppNotificationSettingsLocalRpcPromise = (params: LocalSetGlobalAppNotificationSettingsLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.setGlobalAppNotificationSettingsLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
export const localSetTeamRetentionLocalRpcPromise = (params: LocalSetTeamRetentionLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.setTeamRetentionLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
...
export const localUpdateTypingRpcPromise = (params: LocalUpdateTypingRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.updateTyping', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve())}))
