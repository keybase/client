...
export type DeserializeProps = {
  ...
  tracker: {usernameToDetails: Map<string, T.Tracker.Details>}
  trackerUsername: string
...
const initialState: DeserializeProps = {
  ...
  tracker: {usernameToDetails: new Map()},
  trackerUsername: '',
  username: '',
...
export const deserialize = (
  ...
  return produce(state, s => {
    ...
    const details = s.tracker.usernameToDetails.get(trackerUsername) ?? T.castDraft({} as T.Tracker.Details)
    ...
    s.tracker.usernameToDetails.set(trackerUsername, T.castDraft(details))
  })
}
