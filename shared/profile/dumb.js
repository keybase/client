...
export const proofsTracked = proofsDefault.map(proof => ({
  ...proof,
  isTracked: true,
}))
...
const dumbProveEnterUsername: DumbComponentMap<ProveEnterUsername> = {
  ...
  mocks: {
    ...
    'Coinbase with Error': {
      ...proveEnterUsernameBase,
      platform: 'coinbase',
      errorText: 'Coinbase specific error',
      errorCode: ConstantsStatusCode.scprofilenotpublic,
    },
