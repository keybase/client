...
const UserEntry = ({onClick, username, uid, followsYou, following, thumbnail}: UserEntryProps) => (
  <Box style={userEntryContainerStyle} onClick={() => { onClick && onClick(username, uid) }}>
    <Avatar style={userEntryAvatarStyle} size={64} url={thumbnail} followsYou={followsYou} following={following} />
