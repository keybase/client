  ...
  <Kb.Box2 direction="horizontal" gap="tiny" fullWidth={true}>
    <Kb.ClickableBox onClick={p.onEdit}>
      <Kb.Box2 direction="horizontal" gap="tiny">
        <Kb.Icon
          type={Kb.Icon.makeFastType(Kb.IconType.icon_team_placeholder_avatar_32)}
          style={styles.placeholderTeam}
        />
  ...
  p.onEdit || p.teamShowcase.length > 0 ? (
    <Kb.Box2 direction="vertical" gap="tiny" fullWidth={true} style={styles.showcases}>
      <Kb.Box2 direction="horizontal" gap="tiny" fullWidth={true}>
        ...
        {!!p.onEdit && <Kb.Icon type={Kb.Icon.makeFastType(Kb.IconType.iconfont_edit)} onClick={p.onEdit} />}
      </Kb.Box2>
