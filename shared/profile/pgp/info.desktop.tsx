...
const Info = () => {
  ...
  const email1 = profile.pgpEmail1
  const email2 = profile.pgpEmail2
  const email3 = profile.pgpEmail3
  const errorEmail1 = profile.pgpErrorEmail1
  const errorEmail2 = profile.pgpErrorEmail2
  const errorEmail3 = profile.pgpErrorEmail3
  const errorText = profile.pgpErrorText
  const fullName = profile.pgpFullName
  ...
  return (
    <Modal closeType="onBack" skipButton={true}>
