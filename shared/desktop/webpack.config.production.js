...
const rules = [mockRule, ...updatedBaseRules]

const uglifyPlugin = SKIP_OPTIMIZE
  ? []
  : [
...
const config = {
  ...
  plugins: [...baseConfig.plugins, new webpack.DefinePlugin(defines), ...uglifyPlugin].filter(Boolean),
