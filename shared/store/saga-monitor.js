      ...
      toLog = {
        ...
        effect: {
          FORK: {
            ...
            argsType: obj.effect.FORK.args &&
              obj.effect.FORK.args[0] &&
              obj.effect.FORK.args[0].type,
          },
        },
      }
      ...
      toLog = {
        ...
        effect: {
          CALL: {
            ...
            argsType: obj.effect.CALL.args &&
              obj.effect.CALL.args[0] &&
              obj.effect.CALL.args[0].type,
          },
        },
      }
