...
adb push $GOPATH0/src/github.com/keybase/client/shared/react-native/android/app/build/outputs/apk/debug/app-debug.apk /data/local/tmp/io.keybase.ossifrage.debug
