...
class FlatList<ItemT> extends React.PureComponent<DefaultProps, Props<ItemT>, void> {
  ...
  _checkProps(props: Props<ItemT>) {
    const {getItem, getItemCount, horizontal, legacyImplementation, numColumns, columnWrapperStyle} = props
    ...
    if (legacyImplementation) {
      ...
      if (!this._hasWarnedLegacy) {
        console.warn(
          'FlatList: Using legacyImplementation - some features not supported and performance ' + 'may suffer'
        )
