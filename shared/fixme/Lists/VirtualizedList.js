  ...
  render() {
    ...
    if (ListHeaderComponent) {
      const element = React.isValidElement(ListHeaderComponent)
        ...
        : <ListHeaderComponent />
      cells.push(
        <View key="$header" onLayout={this._onLayoutHeader} style={inversionStyle}>
          {element}
        </View>
      )
    }
    ...
    if (itemCount > 0) {
      ...
      const element = React.isValidElement(ListEmptyComponent)
        ...
        : <ListEmptyComponent />
      cells.push(
        <View key="$empty" onLayout={this._onLayoutEmpty} style={inversionStyle}>
          {element}
        </View>
      )
    }
    if (ListFooterComponent) {
      const element = React.isValidElement(ListFooterComponent)
        ...
        : <ListFooterComponent />
      cells.push(
        <View key="$footer" onLayout={this._onLayoutFooter} style={inversionStyle}>
          {element}
        </View>
      )
    }
...
class CellRenderer extends React.Component {
  ...
  render() {
    const {ItemSeparatorComponent, fillRateHelper, item, index, inversionStyle, parentProps} = this.props
