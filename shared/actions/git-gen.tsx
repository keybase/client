...
type _BadgeAppForGitPayload = {
 readonly ids: Array<string>
};

type _ClearBadgesPayload = void;

type _CreatePersonalRepoPayload = {
 readonly name: string
};

type _CreateTeamRepoPayload = {
 readonly name: string,
 readonly teamname: string,
 readonly notifyTeam: boolean
};

type _DeletePersonalRepoPayload = {
 readonly name: string
};

type _DeleteTeamRepoPayload = {
 readonly name: string,
 readonly teamname: string,
 readonly notifyTeam: boolean
};
...
type _NavigateToTeamRepoPayload = {
...
export type LoadGitPayload = {
 readonly payload: _LoadGitPayload,
 readonly type: "git:loadGit"
};
export type LoadedPayload = {
 readonly payload: _LoadedPayload,
 readonly type: "git:loaded"
};
export type NavToGitPayload = {
 readonly payload: _NavToGitPayload,
 readonly type: "git:navToGit"
};
export type NavigateToTeamRepoPayload = {
 readonly payload: _NavigateToTeamRepoPayload,
 readonly type: "git:navigateToTeamRepo"
};
export type RepoCreatedPayload = {
 readonly payload: _RepoCreatedPayload,
 readonly type: "git:repoCreated"
};
export type RepoDeletedPayload = {
 readonly payload: _RepoDeletedPayload,
 readonly type: "git:repoDeleted"
};
export type SetErrorPayload = {
 readonly payload: _SetErrorPayload,
 readonly type: "git:setError"
};
...
// All Actions
// prettier-ignore
export type Actions = BadgeAppForGitPayload | ClearBadgesPayload | CreatePersonalRepoPayload | CreateTeamRepoPayload | DeletePersonalRepoPayload | DeleteTeamRepoPayload | LoadGitPayload | LoadedPayload | NavToGitPayload | NavigateToTeamRepoPayload | RepoCreatedPayload | RepoDeletedPayload | SetErrorPayload | SetTeamRepoSettingsPayload | {
