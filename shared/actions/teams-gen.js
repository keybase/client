...
export const addParticipant = typePrefix + 'addParticipant'
export const addPeopleToTeam = typePrefix + 'addPeopleToTeam'
export const addTeamWithChosenChannels = typePrefix + 'addTeamWithChosenChannels'
export const addToTeam = typePrefix + 'addToTeam'
export const addUserToTeams = typePrefix + 'addUserToTeams'
export const badgeAppForTeams = typePrefix + 'badgeAppForTeams'
export const checkRequestedAccess = typePrefix + 'checkRequestedAccess'
export const clearTeamRequests = typePrefix + 'clearTeamRequests'
export const createChannel = typePrefix + 'createChannel'
export const createNewTeam = typePrefix + 'createNewTeam'
export const createNewTeamFromConversation = typePrefix + 'createNewTeamFromConversation'
export const deleteChannelConfirmed = typePrefix + 'deleteChannelConfirmed'
export const deleteChannelInfo = typePrefix + 'deleteChannelInfo'
export const editMembership = typePrefix + 'editMembership'
export const editTeamDescription = typePrefix + 'editTeamDescription'
export const getChannelInfo = typePrefix + 'getChannelInfo'
export const getChannels = typePrefix + 'getChannels'
export const getDetails = typePrefix + 'getDetails'
export const getDetailsForAllTeams = typePrefix + 'getDetailsForAllTeams'
export const getTeamOperations = typePrefix + 'getTeamOperations'
export const getTeamPublicity = typePrefix + 'getTeamPublicity'
export const getTeamRetentionPolicy = typePrefix + 'getTeamRetentionPolicy'
export const getTeams = typePrefix + 'getTeams'
export const ignoreRequest = typePrefix + 'ignoreRequest'
export const inviteToTeamByEmail = typePrefix + 'inviteToTeamByEmail'
export const inviteToTeamByPhone = typePrefix + 'inviteToTeamByPhone'
export const joinTeam = typePrefix + 'joinTeam'
export const leaveTeam = typePrefix + 'leaveTeam'
export const removeMemberOrPendingInvite = typePrefix + 'removeMemberOrPendingInvite'
export const removeParticipant = typePrefix + 'removeParticipant'
export const saveChannelMembership = typePrefix + 'saveChannelMembership'
export const saveTeamRetentionPolicy = typePrefix + 'saveTeamRetentionPolicy'
export const setAddUserToTeamsResults = typePrefix + 'setAddUserToTeamsResults'
export const setChannelCreationError = typePrefix + 'setChannelCreationError'
export const setEmailInviteError = typePrefix + 'setEmailInviteError'
export const setLoaded = typePrefix + 'setLoaded'
export const setMemberPublicity = typePrefix + 'setMemberPublicity'
export const setNewTeamInfo = typePrefix + 'setNewTeamInfo'
export const setPublicity = typePrefix + 'setPublicity'
export const setTeamAccessRequestsPending = typePrefix + 'setTeamAccessRequestsPending'
export const setTeamCanPerform = typePrefix + 'setTeamCanPerform'
export const setTeamChannelInfo = typePrefix + 'setTeamChannelInfo'
export const setTeamChannels = typePrefix + 'setTeamChannels'
export const setTeamCreationError = typePrefix + 'setTeamCreationError'
export const setTeamCreationPending = typePrefix + 'setTeamCreationPending'
export const setTeamDetails = typePrefix + 'setTeamDetails'
export const setTeamInfo = typePrefix + 'setTeamInfo'
export const setTeamInviteError = typePrefix + 'setTeamInviteError'
export const setTeamJoinError = typePrefix + 'setTeamJoinError'
export const setTeamJoinSuccess = typePrefix + 'setTeamJoinSuccess'
export const setTeamLoadingInvites = typePrefix + 'setTeamLoadingInvites'
export const setTeamPublicitySettings = typePrefix + 'setTeamPublicitySettings'
export const setTeamRetentionPolicy = typePrefix + 'setTeamRetentionPolicy'
export const setTeamSawChatBanner = typePrefix + 'setTeamSawChatBanner'
export const setTeamSawSubteamsBanner = typePrefix + 'setTeamSawSubteamsBanner'
export const setTeamsWithChosenChannels = typePrefix + 'setTeamsWithChosenChannels'
export const setUpdatedChannelName = typePrefix + 'setUpdatedChannelName'
export const setUpdatedTopic = typePrefix + 'setUpdatedTopic'
export const updateChannelName = typePrefix + 'updateChannelName'
export const updateTopic = typePrefix + 'updateTopic'
export const uploadTeamAvatar = typePrefix + 'uploadTeamAvatar'
