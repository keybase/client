...
// Action Creators
export const createActionUpdateForgotPasswordEmailAddress = (payload: {|email: string|}) => ({error: false, payload, type: actionUpdateForgotPasswordEmailAddress})
...
export const createQrScanned = (payload: {|phrase: string|}) => ({error: false, payload, type: qrScanned})
...
// Action Payloads
export type ActionUpdateForgotPasswordEmailAddressPayload = ReturnType<typeof createActionUpdateForgotPasswordEmailAddress>
...
// prettier-ignore
export type Actions =
  | ReturnType<typeof createActionUpdateForgotPasswordEmailAddress>
