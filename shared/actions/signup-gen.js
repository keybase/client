...
export const checkDevicename = typePrefix + 'checkDevicename'
export const checkInviteCode = typePrefix + 'checkInviteCode'
export const checkPassphrase = typePrefix + 'checkPassphrase'
export const checkUsernameEmail = typePrefix + 'checkUsernameEmail'
export const checkedDevicename = typePrefix + 'checkedDevicename'
export const checkedInviteCode = typePrefix + 'checkedInviteCode'
export const checkedUsernameEmail = typePrefix + 'checkedUsernameEmail'
export const goBackAndClearErrors = typePrefix + 'goBackAndClearErrors'
export const requestAutoInvite = typePrefix + 'requestAutoInvite'
export const requestInvite = typePrefix + 'requestInvite'
export const requestedAutoInvite = typePrefix + 'requestedAutoInvite'
export const requestedInvite = typePrefix + 'requestedInvite'
export const restartSignup = typePrefix + 'restartSignup'
export const signedup = typePrefix + 'signedup'
