...
export const cacheIdentify = typePrefix + 'cacheIdentify'
export const follow = typePrefix + 'follow'
export const getMyProfile = typePrefix + 'getMyProfile'
export const getProfile = typePrefix + 'getProfile'
export const identifyFinished = typePrefix + 'identifyFinished'
export const identifyStarted = typePrefix + 'identifyStarted'
export const ignore = typePrefix + 'ignore'
export const markActiveIdentifyUi = typePrefix + 'markActiveIdentifyUi'
export const onClose = typePrefix + 'onClose'
export const onError = typePrefix + 'onError'
export const openProofUrl = typePrefix + 'openProofUrl'
export const parseFriendship = typePrefix + 'parseFriendship'
export const pendingIdentify = typePrefix + 'pendingIdentify'
export const refollow = typePrefix + 'refollow'
export const remoteDismiss = typePrefix + 'remoteDismiss'
export const reportLastTrack = typePrefix + 'reportLastTrack'
export const resetProofs = typePrefix + 'resetProofs'
export const setNeedTrackTokenDismiss = typePrefix + 'setNeedTrackTokenDismiss'
export const setOnFollow = typePrefix + 'setOnFollow'
export const setOnRefollow = typePrefix + 'setOnRefollow'
export const setOnUnfollow = typePrefix + 'setOnUnfollow'
export const setProofs = typePrefix + 'setProofs'
export const setRegisterIdentifyUi = typePrefix + 'setRegisterIdentifyUi'
export const setUpdateTrackers = typePrefix + 'setUpdateTrackers'
export const showNonUser = typePrefix + 'showNonUser'
export const showTracker = typePrefix + 'showTracker'
export const unfollow = typePrefix + 'unfollow'
export const updateBTC = typePrefix + 'updateBTC'
export const updateEldestKidChanged = typePrefix + 'updateEldestKidChanged'
export const updateFolders = typePrefix + 'updateFolders'
export const updatePGPKey = typePrefix + 'updatePGPKey'
export const updateProof = typePrefix + 'updateProof'
export const updateProofState = typePrefix + 'updateProofState'
export const updateReason = typePrefix + 'updateReason'
export const updateSelectedTeam = typePrefix + 'updateSelectedTeam'
export const updateTrackToken = typePrefix + 'updateTrackToken'
export const updateTrackers = typePrefix + 'updateTrackers'
export const updateUserInfo = typePrefix + 'updateUserInfo'
export const updateUsername = typePrefix + 'updateUsername'
export const updateZcash = typePrefix + 'updateZcash'
