...
export const addNewDevice = typePrefix + 'addNewDevice'
export const provisionError = typePrefix + 'provisionError'
export const showCodePage = typePrefix + 'showCodePage'
export const showDeviceListPage = typePrefix + 'showDeviceListPage'
export const showFinalErrorPage = typePrefix + 'showFinalErrorPage'
export const showGPGPage = typePrefix + 'showGPGPage'
export const showNewDeviceNamePage = typePrefix + 'showNewDeviceNamePage'
export const showPaperkeyPage = typePrefix + 'showPaperkeyPage'
export const showPassphrasePage = typePrefix + 'showPassphrasePage'
export const startProvision = typePrefix + 'startProvision'
export const submitDeviceName = typePrefix + 'submitDeviceName'
export const submitDeviceSelect = typePrefix + 'submitDeviceSelect'
export const submitGPGMethod = typePrefix + 'submitGPGMethod'
export const submitPaperkey = typePrefix + 'submitPaperkey'
export const submitPassphrase = typePrefix + 'submitPassphrase'
export const submitTextCode = typePrefix + 'submitTextCode'
export const submitUsernameOrEmail = typePrefix + 'submitUsernameOrEmail'
