...
type _TouchIDEnabledPayload = $ReadOnly<{|enabled: boolean, writeToConfig: boolean|}>
...
export const createTouchIDAllowedBySystem = (payload: _TouchIDAllowedBySystemPayload) => ({payload, type: touchIDAllowedBySystem})
export const createTouchIDEnabled = (payload: _TouchIDEnabledPayload) => ({payload, type: touchIDEnabled})
export const createTouchIDState = (payload: _TouchIDStatePayload) => ({payload, type: touchIDState})
...
export type TouchIDAllowedBySystemPayload = {|+payload: _TouchIDAllowedBySystemPayload, +type: 'config:touchIDAllowedBySystem'|}
export type TouchIDEnabledPayload = {|+payload: _TouchIDEnabledPayload, +type: 'config:touchIDEnabled'|}
export type TouchIDStatePayload = {|+payload: _TouchIDStatePayload, +type: 'config:touchIDState'|}
