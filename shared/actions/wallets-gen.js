...
type _ReviewedPaymentReceivedPayload = $ReadOnly<{|sessionID: number, bid: string, seqno: number, nextButton: string, banners?: ?Array<StellarRPCTypes.SendBannerLocal>|}>
