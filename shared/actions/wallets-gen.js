...
export const accountsReceived = typePrefix + 'accountsReceived'
export const assetsReceived = typePrefix + 'assetsReceived'
export const clearErrors = typePrefix + 'clearErrors'
export const exportSecretKey = typePrefix + 'exportSecretKey'
export const linkExistingAccount = typePrefix + 'linkExistingAccount'
export const linkedExistingAccount = typePrefix + 'linkedExistingAccount'
export const loadAccounts = typePrefix + 'loadAccounts'
export const loadAssets = typePrefix + 'loadAssets'
export const loadPaymentDetail = typePrefix + 'loadPaymentDetail'
export const loadPayments = typePrefix + 'loadPayments'
export const paymentDetailReceived = typePrefix + 'paymentDetailReceived'
export const paymentsReceived = typePrefix + 'paymentsReceived'
export const secretKeyReceived = typePrefix + 'secretKeyReceived'
export const secretKeySeen = typePrefix + 'secretKeySeen'
export const selectAccount = typePrefix + 'selectAccount'
export const validateAccountName = typePrefix + 'validateAccountName'
export const validateSecretKey = typePrefix + 'validateSecretKey'
export const validatedAccountName = typePrefix + 'validatedAccountName'
export const validatedSecretKey = typePrefix + 'validatedSecretKey'
