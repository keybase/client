...
type _CheckDevicenamePayload = {
  readonly devicename: string
};

type _CheckInviteCodePayload = {
...
type _CheckUsernameEmailPayload = {
  readonly username: string,
  readonly email: string
};

type _CheckedDevicenamePayload = {
  readonly devicename: string
};

type _CheckedDevicenamePayloadError = {
  readonly devicename: string,
  readonly error: string
};

type _CheckedInviteCodePayload = {
  readonly inviteCode: string
};

type _CheckedInviteCodePayloadError = {
  readonly inviteCode: string,
  readonly error: string
};

type _CheckedUsernameEmailPayload = {
  readonly username: string,
  readonly email: string
};
...
type _RequestInvitePayload = {
  readonly email: string,
  readonly name: string
};

type _RequestedAutoInvitePayload = {
  readonly inviteCode: string
};
...
export type SignedupPayload = {
  readonly payload: _SignedupPayload,
...
// All Actions
// prettier-ignore
export type Actions = CheckDevicenamePayload | CheckInviteCodePayload | CheckPasswordPayload | CheckUsernameEmailPayload | CheckedDevicenamePayload | CheckedDevicenamePayloadError | CheckedInviteCodePayload | CheckedInviteCodePayloadError | CheckedUsernameEmailPayload | CheckedUsernameEmailPayloadError | GoBackAndClearErrorsPayload | RequestAutoInvitePayload | RequestInvitePayload | RequestedAutoInvitePayload | RequestedAutoInvitePayloadError | RequestedInvitePayload | RequestedInvitePayloadError | RestartSignupPayload | SignedupPayload | SignedupPayloadError | {
