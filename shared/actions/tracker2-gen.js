...
type _UpdateAssertionPayload = $ReadOnly<{|guiID: string, type: string, value: string, sigID: string, siteURL: string, siteIcon: Array<Types.SiteIcon>, proofURL: string, state: Types.AssertionState, metas: Array<Types._AssertionMeta>, color: Types.AssertionColor|}>
