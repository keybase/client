...
type _CheckPaperKeyDonePayloadError = {
  readonly error: string
};

type _CheckPaperKeyPayload = {
...
export type FinishPayload = {
  readonly payload: _FinishPayload,
  readonly type: "unlock-folders:finish"
};
...
export type WaitingPayload = {
  readonly payload: _WaitingPayload,
  readonly type: "unlock-folders:waiting"
};

// All Actions
// prettier-ignore
export type Actions = CheckPaperKeyDonePayload | CheckPaperKeyDonePayloadError | CheckPaperKeyPayload | CloseDonePayload | ClosePopupPayload | FinishPayload | NewRekeyPopupPayload | OnBackFromPaperKeyPayload | OpenPopupPayload | ToPaperKeyInputPayload | WaitingPayload | {
