...
export const createDumpLogs = (payload: $ReadOnly<{|reason: 'quitting through menu'|}>) => ({error: false, payload, type: dumpLogs})
...
export type DumpLogsPayload = More.ReturnType<typeof createDumpLogs>
...
export type Actions =
  ...
  | More.ReturnType<typeof createDumpLogs>
