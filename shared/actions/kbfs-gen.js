...
export const clearFuseInstall = typePrefix + 'clearFuseInstall'
export const fuseStatus = typePrefix + 'fuseStatus'
export const fuseStatusUpdate = typePrefix + 'fuseStatusUpdate'
export const installFuse = typePrefix + 'installFuse'
export const installFuseFinished = typePrefix + 'installFuseFinished'
export const installFuseResult = typePrefix + 'installFuseResult'
export const installKBFS = typePrefix + 'installKBFS'
export const installKBFSFinished = typePrefix + 'installKBFSFinished'
export const installKBFSResult = typePrefix + 'installKBFSResult'
export const list = typePrefix + 'list'
export const listed = typePrefix + 'listed'
export const open = typePrefix + 'open'
export const openDefaultPath = typePrefix + 'openDefaultPath'
export const openInFileUI = typePrefix + 'openInFileUI'
export const uninstallKBFS = typePrefix + 'uninstallKBFS'
export const uninstallKBFSResult = typePrefix + 'uninstallKBFSResult'
