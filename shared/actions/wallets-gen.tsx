...
type _AccountUpdateReceivedPayload = {
 readonly account: Types.Account
};

type _AccountsReceivedPayload = {
 readonly accounts: Array<Types.Account>
};

type _AddNewPaymentPayload = {
 readonly accountID: Types.AccountID,
 readonly paymentID: Types.PaymentID
};

type _AssetsReceivedPayload = {
 readonly accountID: Types.AccountID,
 readonly assets: Array<Types.Assets>
};

type _BadgesUpdatedPayload = {
 readonly accounts: Array<RPCTypes.WalletAccountInfo>
};

type _BuildPaymentPayload = void;

type _BuildingPaymentIDReceivedPayload = {
 readonly bid: string
};

type _BuiltPaymentReceivedPayload = {
 readonly build: Types.BuiltPayment,
 readonly forBuildCounter: number
};

type _BuiltRequestReceivedPayload = {
 readonly build: Types.BuiltRequest,
 readonly forBuildCounter: number
};

type _CancelPaymentPayload = {
...
type _ChangeAirdropPayload = {
 readonly accept: boolean
};

type _ChangeDisplayCurrencyPayload = {
 readonly accountID: Types.AccountID,
 readonly code: Types.CurrencyCode
};

type _ChangeMobileOnlyModePayload = {
 readonly accountID: Types.AccountID,
...
type _CheckDisclaimerPayload = {
 readonly nextScreen: Types.NextScreenAfterAcceptance
};
...
type _CreatedNewAccountPayloadError = {
 readonly name: string,
 readonly error: string
};

type _DeleteAccountPayload = {
 readonly accountID: Types.AccountID
};

type _DeletedAccountPayload = void;

type _DidSetAccountAsDefaultPayload = {
 readonly accountID: Types.AccountID
};

type _DisplayCurrenciesReceivedPayload = {
 readonly currencies: Array<Types.Currency>
};
...
type _InflationDestinationReceivedPayloadError = {
 readonly error: string
};
...
type _LoadAccountsPayload = {
 readonly reason: "initial-load" | "open-send-req-form"
};

type _LoadAssetsPayload = {
 readonly accountID: Types.AccountID
};
...
type _LoadInflationDestinationPayload = {
 readonly accountID: Types.AccountID
};

type _LoadMobileOnlyModePayload = {
 readonly accountID: Types.AccountID
};

type _LoadMorePaymentsPayload = {
 readonly accountID: Types.AccountID
};

type _LoadPaymentDetailPayload = {
 readonly accountID: Types.AccountID,
 readonly paymentID: Types.PaymentID
};

type _LoadPaymentsPayload = {
 readonly accountID: Types.AccountID
};

type _LoadSendAssetChoicesPayload = {
...
type _LoadedMobileOnlyModePayload = {
 readonly accountID: Types.AccountID,
 readonly enabled: boolean
};

type _MarkAsReadPayload = {
 readonly accountID: Types.AccountID,
...
type _SecretKeyReceivedPayload = {
 readonly accountID: Types.AccountID,
 readonly secretKey: HiddenString
};

type _SecretKeySeenPayload = {
 readonly accountID: Types.AccountID
};
...
type _SetAccountAsDefaultPayload = {
 readonly accountID: Types.AccountID
};

type _SetBuildingAmountPayload = {
 readonly amount: string
};

type _SetBuildingCurrencyPayload = {
 readonly currency: string
};

type _SetBuildingFromPayload = {
 readonly from: Types.AccountID
};

type _SetBuildingIsRequestPayload = {
 readonly isRequest: boolean
};

type _SetBuildingPublicMemoPayload = {
 readonly publicMemo: HiddenString
};

type _SetBuildingRecipientTypePayload = {
 readonly recipientType: Types.CounterpartyType
};

type _SetBuildingSecretNotePayload = {
 readonly secretNote: HiddenString
};

type _SetBuildingToPayload = {
 readonly to: string
};
...
type _SetLastSentXLMPayload = {
 readonly lastSentXLM: boolean,
 readonly writeFile: boolean
};

type _SetReadyToReviewPayload = {
 readonly readyToReview: boolean
};

type _ShowTransactionPayload = {
 readonly accountID: Types.AccountID,
 readonly paymentID: Types.PaymentID
};

type _UpdateAirdropBannerStatePayload = {
 readonly show: boolean
};
...
type _UpdatedAirdropDetailsPayload = {
 readonly details: Types.AirdropDetails
};
...
type _ValidateAccountNamePayload = {
 readonly name: string
};

type _ValidateSecretKeyPayload = {
 readonly secretKey: HiddenString
};

type _ValidatedAccountNamePayload = {
 readonly name: string
};

type _ValidatedAccountNamePayloadError = {
 readonly name: string,
 readonly error: string
};

type _ValidatedSecretKeyPayload = {
 readonly secretKey: HiddenString
};

type _ValidatedSecretKeyPayloadError = {
 readonly secretKey: HiddenString,
 readonly error: string
};

type _WalletDisclaimerReceivedPayload = {
...
export type ClearErrorsPayload = {
 readonly payload: _ClearErrorsPayload,
 readonly type: "wallets:clearErrors"
};
...
export type LoadAssetsPayload = {
 readonly payload: _LoadAssetsPayload,
 readonly type: "wallets:loadAssets"
};
...
export type MarkAsReadPayload = {
 readonly payload: _MarkAsReadPayload,
 readonly type: "wallets:markAsRead"
};
...
export type SendPaymentPayload = {
 readonly payload: _SendPaymentPayload,
 readonly type: "wallets:sendPayment"
};
export type SentPaymentErrorPayload = {
 readonly payload: _SentPaymentErrorPayload,
 readonly type: "wallets:sentPaymentError"
};
export type SentPaymentPayload = {
 readonly payload: _SentPaymentPayload,
 readonly type: "wallets:sentPayment"
};
...
// All Actions
// prettier-ignore
export type Actions = AbandonPaymentPayload | AcceptDisclaimerPayload | AccountUpdateReceivedPayload | AccountsReceivedPayload | AddNewPaymentPayload | AssetsReceivedPayload | BadgesUpdatedPayload | BuildPaymentPayload | BuildingPaymentIDReceivedPayload | BuiltPaymentReceivedPayload | BuiltRequestReceivedPayload | CancelPaymentPayload | CancelRequestPayload | ChangeAccountNamePayload | ChangeAirdropPayload | ChangeDisplayCurrencyPayload | ChangeMobileOnlyModePayload | ChangedAccountNamePayload | ChangedAccountNamePayloadError | CheckDisclaimerPayload | ClearBuildingPayload | ClearBuiltPaymentPayload | ClearBuiltRequestPayload | ClearErrorsPayload | ClearNewPaymentsPayload | CreateNewAccountPayload | CreatedNewAccountPayload | CreatedNewAccountPayloadError | DeleteAccountPayload | DeletedAccountPayload | DidSetAccountAsDefaultPayload | DisplayCurrenciesReceivedPayload | DisplayCurrencyReceivedPayload | ExitFailedPaymentPayload | ExportSecretKeyPayload | HideAirdropBannerPayload | InflationDestinationReceivedPayload | InflationDestinationReceivedPayloadError | LinkExistingAccountPayload | LinkedExistingAccountPayload | LinkedExistingAccountPayloadError | LoadAccountsPayload | LoadAssetsPayload | LoadDisplayCurrenciesPayload | LoadDisplayCurrencyPayload | LoadInflationDestinationPayload | LoadMobileOnlyModePayload | LoadMorePaymentsPayload | LoadPaymentDetailPayload | LoadPaymentsPayload | LoadSendAssetChoicesPayload | LoadWalletDisclaimerPayload | LoadedMobileOnlyModePayload | MarkAsReadPayload | OpenSendRequestFormPayload | PaymentDetailReceivedPayload | PaymentsReceivedPayload | PendingPaymentsReceivedPayload | RecentPaymentsReceivedPayload | RejectDisclaimerPayload | RequestPaymentPayload | RequestedPaymentPayload | ResetAcceptingDisclaimerPayload | ReviewPaymentPayload | ReviewedPaymentReceivedPayload | SecretKeyReceivedPayload | SecretKeySeenPayload | SelectAccountPayload | SendAssetChoicesReceivedPayload | SendPaymentPayload | SentPaymentErrorPayload | SentPaymentPayload | SetAccountAsDefaultPayload | SetBuildingAmountPayload | SetBuildingCurrencyPayload | SetBuildingFromPayload | SetBuildingIsRequestPayload | SetBuildingPublicMemoPayload | SetBuildingRecipientTypePayload | SetBuildingSecretNotePayload | SetBuildingToPayload | SetInflationDestinationPayload | SetLastSentXLMPayload | SetReadyToReviewPayload | ShowTransactionPayload | UpdateAirdropBannerStatePayload | UpdateAirdropDetailsPayload | UpdateAirdropStatePayload | UpdatedAirdropDetailsPayload | UpdatedAirdropStatePayload | ValidateAccountNamePayload | ValidateSecretKeyPayload | ValidatedAccountNamePayload | ValidatedAccountNamePayloadError | ValidatedSecretKeyPayload | ValidatedSecretKeyPayloadError | WalletDisclaimerReceivedPayload | {
