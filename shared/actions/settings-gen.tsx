...
type _FeedbackSentPayload = {
 readonly error: Error | null
};

type _InvitesClearErrorPayload = void;

type _InvitesReclaimPayload = {
 readonly inviteId: string
};

type _InvitesReclaimedPayload = void;

type _InvitesReclaimedPayloadError = {
 readonly errorText: string
};

type _InvitesRefreshPayload = void;

type _InvitesRefreshedPayload = {
 readonly invites: Types._InvitesState
};

type _InvitesSendPayload = {
...
type _LoadedCheckPasswordPayload = {
 readonly checkPasswordIsCorrect: boolean | null
};

type _LoadedHasRandomPwPayload = {
 readonly randomPW: boolean
};

type _LoadedLockdownModePayload = {
 readonly status: boolean | null
};

type _LoadedRememberPasswordPayload = {
 readonly remember: boolean
};

type _LoadedSettingsPayload = {
 readonly emails: I.List<Types.EmailRow> | null
};

type _NotificationsRefreshPayload = void;

type _NotificationsRefreshedPayload = {
 readonly notifications: I.Map<string, Types.NotificationsGroupState>
};

type _NotificationsSavedPayload = void;

type _NotificationsTogglePayload = {
 readonly group: string,
 readonly name?: string | null
};

type _OnChangeLockdownModePayload = {
 readonly enabled: boolean
};

type _OnChangeNewEmailPayload = {
 readonly email: string
};

type _OnChangeNewPasswordConfirmPayload = {
 readonly password: HiddenString
};

type _OnChangeNewPasswordPayload = {
 readonly password: HiddenString
};

type _OnChangeRememberPasswordPayload = {
 readonly remember: boolean
};

type _OnChangeShowPasswordPayload = void;

type _OnChangeUseNativeFramePayload = {
 readonly enabled: boolean
};

type _OnSubmitNewEmailPayload = void;

type _OnSubmitNewPasswordPayload = {
 readonly thenSignOut: boolean
};

type _OnUpdateEmailErrorPayload = {
 readonly error: Error
};

type _OnUpdatePGPSettingsPayload = void;

type _OnUpdatePasswordErrorPayload = {
 readonly error: Error
};

type _OnUpdatedPGPSettingsPayload = {
 readonly hasKeys: boolean
};

type _ProcessorProfilePayload = {
...
type _SetAllowDeleteAccountPayload = {
 readonly allow: boolean
};

type _StopPayload = {
 readonly exitCode: RPCTypes.ExitCode
};
...
type _UnfurlSettingsErrorPayload = {
...
type _WaitingForResponsePayload = {
...
export type DbNukePayload = {
 readonly payload: _DbNukePayload,
 readonly type: "settings:dbNuke"
};
...
export type StopPayload = {
 readonly payload: _StopPayload,
 readonly type: "settings:stop"
};
export type TracePayload = {
 readonly payload: _TracePayload,
 readonly type: "settings:trace"
};
...
// All Actions
// prettier-ignore
export type Actions = CheckPasswordPayload | DbNukePayload | DeleteAccountForeverPayload | FeedbackSentPayload | InvitesClearErrorPayload | InvitesReclaimPayload | InvitesReclaimedPayload | InvitesReclaimedPayloadError | InvitesRefreshPayload | InvitesRefreshedPayload | InvitesSendPayload | InvitesSentPayload | InvitesSentPayloadError | LoadHasRandomPwPayload | LoadLockdownModePayload | LoadRememberPasswordPayload | LoadSettingsPayload | LoadedCheckPasswordPayload | LoadedHasRandomPwPayload | LoadedLockdownModePayload | LoadedRememberPasswordPayload | LoadedSettingsPayload | NotificationsRefreshPayload | NotificationsRefreshedPayload | NotificationsSavedPayload | NotificationsTogglePayload | OnChangeLockdownModePayload | OnChangeNewEmailPayload | OnChangeNewPasswordConfirmPayload | OnChangeNewPasswordPayload | OnChangeRememberPasswordPayload | OnChangeShowPasswordPayload | OnChangeUseNativeFramePayload | OnSubmitNewEmailPayload | OnSubmitNewPasswordPayload | OnUpdateEmailErrorPayload | OnUpdatePGPSettingsPayload | OnUpdatePasswordErrorPayload | OnUpdatedPGPSettingsPayload | ProcessorProfilePayload | SendFeedbackPayload | SetAllowDeleteAccountPayload | StopPayload | TracePayload | UnfurlSettingsErrorPayload | UnfurlSettingsRefreshPayload | UnfurlSettingsRefreshedPayload | UnfurlSettingsSavedPayload | WaitingForResponsePayload | {
