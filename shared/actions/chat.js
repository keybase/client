...
import {safeTakeEvery, safeTakeLatest, safeTakeSerially, singleFixedChannelConfig, closeChannelMap, takeFromChannelMap, effectOnChannelMap} from '../util/saga'
...
function * chatSaga (): SagaGenerator<any, any> {
  ...
  yield [
    safeTakeSerially(Constants.loadInbox, _loadInbox),
