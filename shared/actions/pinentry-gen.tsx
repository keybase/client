...
type _OnCancelPayload = {
  readonly sessionID: number
};

type _OnSubmitPayload = {
  readonly sessionID: number,
...
export type OnCancelPayload = {
  readonly payload: _OnCancelPayload,
  readonly type: "pinentry:onCancel"
};
export type OnSubmitPayload = {
  readonly payload: _OnSubmitPayload,
  readonly type: "pinentry:onSubmit"
};
...
// All Actions
// prettier-ignore
export type Actions = DeleteEntityPayload | MergeEntityPayload | NewPinentryPayload | OnCancelPayload | OnSubmitPayload | ReplaceEntityPayload | SubtractEntityPayload | {
