...
export const addProof = typePrefix + 'addProof'
export const backToProfile = typePrefix + 'backToProfile'
export const cancelAddProof = typePrefix + 'cancelAddProof'
export const cancelPgpGen = typePrefix + 'cancelPgpGen'
export const checkProof = typePrefix + 'checkProof'
export const cleanupUsername = typePrefix + 'cleanupUsername'
export const dropPgp = typePrefix + 'dropPgp'
export const editProfile = typePrefix + 'editProfile'
export const finishRevoking = typePrefix + 'finishRevoking'
export const finishedWithKeyGen = typePrefix + 'finishedWithKeyGen'
export const generatePgp = typePrefix + 'generatePgp'
export const onClickAvatar = typePrefix + 'onClickAvatar'
export const onClickFollowers = typePrefix + 'onClickFollowers'
export const onClickFollowing = typePrefix + 'onClickFollowing'
export const outputInstructionsActionLink = typePrefix + 'outputInstructionsActionLink'
export const revokeFinish = typePrefix + 'revokeFinish'
export const revokeWaiting = typePrefix + 'revokeWaiting'
export const showUserProfile = typePrefix + 'showUserProfile'
export const submitBTCAddress = typePrefix + 'submitBTCAddress'
export const submitRevokeProof = typePrefix + 'submitRevokeProof'
export const submitUsername = typePrefix + 'submitUsername'
export const submitZcashAddress = typePrefix + 'submitZcashAddress'
export const updateErrorText = typePrefix + 'updateErrorText'
export const updatePgpInfo = typePrefix + 'updatePgpInfo'
export const updatePgpPublicKey = typePrefix + 'updatePgpPublicKey'
export const updatePlatform = typePrefix + 'updatePlatform'
export const updateProofStatus = typePrefix + 'updateProofStatus'
export const updateProofText = typePrefix + 'updateProofText'
export const updateSigID = typePrefix + 'updateSigID'
export const updateUsername = typePrefix + 'updateUsername'
export const uploadAvatar = typePrefix + 'uploadAvatar'
