...
type _NotificationPayload = {
  readonly notification: Types.PushNotification
};
...
type _UpdateHasPermissionsPayload = {
  readonly hasPermissions: boolean
};

type _UpdatePushTokenPayload = {
...
export type NotificationPayload = {
  readonly payload: _NotificationPayload,
  readonly type: "push:notification"
};
...
// All Actions
// prettier-ignore
export type Actions = NotificationPayload | RejectPermissionsPayload | RequestPermissionsPayload | ShowPermissionsPromptPayload | UpdateHasPermissionsPayload | UpdatePushTokenPayload | {
