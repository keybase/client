...
import {Box, Button, Checkbox, Icon, Text, Input, NativeScrollView, NativeKeyboard} from '../common-adapters/index.native'
...
class Feedback extends Component<void, Props, void> {
  ...
  render () {
    ...
    return <NativeScrollView style={{...globalStyles.flexBoxColumn, flex: 1}} ref={this._setScrollRef}>
      {showSuccessBanner &&
