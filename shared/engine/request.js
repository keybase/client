...
class IncomingRequest extends Request {
  ...
  constructor (method: MethodKey, param: ?Object, response: ?ResponseType, waitingHandler: SimpleWaiting, handler: Function) {
...
class OutgoingRequest extends Request {
  ...
  constructor (method: MethodKey, param: ?Object, callback: () => void, waitingHandler: SimpleWaiting, invoke: invokeType) {
    super(method, param, waitingHandler)
    this._invoke = invoke
