...
helpers.rootLinuxNode(env, {
  ...
  ws("client") {
    ...
    // See https://github.com/moovweb/gvm/issues/188
    sh "[[ -s "$GVM_ROOT/scripts/gvm" ]] && source "$GVM_ROOT/scripts/gvm" && gvm update && gvm install go1.17.3 -B && gvm use go1.17.3 --default"
