                  ...
                  dir('go') {
                    ...
                    dir('kbfs') {
                      ...
                      withCredentials([string(credentialsId: 'kbfs-docker-cert-b64-new', variable: 'KBFS_DOCKER_CERT_B64')]) { // TODO update the var in CI
                        def kbfsCert = sh(returnStdout: true, script: "echo  | sed 's/ //g' | base64 -d")
