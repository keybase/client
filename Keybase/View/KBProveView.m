...
- (void)viewInit {
  ...
  [_proofLabel setBorderWithColor:GHNSColorFromRGB(0xDDDDDD) width:1.0];
  ...
  self.viewLayout = [YOLayout layoutWithLayoutBlock:^(id<YOLayout> layout, CGSize size) {
    ...
    y += [layout setFrame:CGRectMake(40, y, size.width - 80, size.height - y - 130) view:yself.scrollView].size.height + 10;
