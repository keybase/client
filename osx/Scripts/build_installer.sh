...
echo "Archiving..."
set -o pipefail && xcodebuild archive -scheme Installer -workspace $dir/../Keybase.xcworkspace -configuration $xcode_configuration -archivePath $archive_path | xcpretty -c
