...
//  [buttonsView addSubview:_includeSelfButton];
  ...
  buttonsView.viewLayout = [YOLayout layoutWithLayoutBlock:^CGSize(id<YOLayout> layout, CGSize size) {
    CGFloat y = 10;
    CGSize buttonSize = [yself.encryptButton sizeThatFits:size];
    [layout setFrame:CGRectMake(size.width - 100 - 20, y, 100, buttonSize.height) view:yself.encryptButton];

    [layout setFrame:CGRectMake(size.width - 230, y, 100, buttonSize.height) view:yself.cancelButton];
