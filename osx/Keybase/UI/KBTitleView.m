...
- (void)setTitle:(NSString *)title {
  _title = title;
  [_label setText:title style:KBLabelStyleDefault appearance:KBAppearance.currentAppearance alignment:NSCenterTextAlignment lineBreakMode:NSLineBreakByTruncatingTail];
  [self setNeedsLayout];
}
